...
def test_read_write():
    ...
    # CHECK:              # SRD for Value(%0 = stream.binding.subspan %arg0[%c0] : !stream.binding -> memref<16x16xf16, strided<[16, 1], offset: ?>>) (arg0)
    ...
    # CHECK:              # load 32B from Value(%0 = stream.binding.subspan %arg0[%c0] : !stream.binding -> memref<16x16xf16, strided<[16, 1], offset: ?>>)
    ...
    # CHECK:              s_waitcnt vmcnt(0)
    # CHECK:              # SRD for Value(%3 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<16x16xf16, strided<[16, 1], offset: ?>>) (arg1)
    # CHECK:              s_mov_b32 s12, s4
    # CHECK:              s_mov_b32 s13, s5
    # CHECK:              s_mov_b32 s14, 2048
    # CHECK:              s_mov_b32 s15, Srd127_96
    # CHECK:              v_lshlrev_b32 v2, 5, v0
    # CHECK:              # store 32B to Value(%3 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<16x16xf16, strided<[16, 1], offset: ?>>)
