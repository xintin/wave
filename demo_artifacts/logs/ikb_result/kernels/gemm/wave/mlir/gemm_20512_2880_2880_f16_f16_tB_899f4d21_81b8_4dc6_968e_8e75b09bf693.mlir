...
#map2 = affine_map<()[s0, s1, s2, s3] -> (s1 * 128 + s2 * 601529784 + s3 * 469212 + s0 floordiv 2 - ((s1 * 128 + s0 floordiv 2) floordiv 732) * 732 - ((s2 * 1282 + s3) floordiv 8) * 3752964 - ((s2 * 821762 + s3 * 641 - ((s2 * 1282 + s3) floordiv 8) * 5127) floordiv 4) * 2928)>
#map3 = affine_map<()[s0] -> (s0 * 8 - (s0 floordiv 2) * 16)>
#map4 = affine_map<()[s0, s1, s2, s3] -> (s1 * 128 + s2 * 601529784 + s3 * 469212 + s0 floordiv 2 - ((s1 * 128 + s0 floordiv 2 + 256) floordiv 732) * 732 - ((s2 * 1282 + s3) floordiv 8) * 3752964 - ((s2 * 821762 + s3 * 641 - ((s2 * 1282 + s3) floordiv 8) * 5127) floordiv 4) * 2928 + 256)>
#map5 = affine_map<()[s0, s1, s2, s3] -> (s1 * 128 + s2 * 601529784 + s3 * 469212 + s0 floordiv 2 - ((s1 * 128 + s0 floordiv 2 + 512) floordiv 732) * 732 - ((s2 * 1282 + s3) floordiv 8) * 3752964 - ((s2 * 821762 + s3 * 641 - ((s2 * 1282 + s3) floordiv 8) * 5127) floordiv 4) * 2928 + 512)>
...
#map31 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 32) * 32 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928)>
#map32 = affine_map<()[s0, s1] -> (s0 * 16 + (s1 floordiv 64) * 4 + 4)>
#map33 = affine_map<()[s0] -> (s0 * 16 + 16)>
#map34 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4)>
#map35 = affine_map<()[s0, s1] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16)>
#map36 = affine_map<()[s0, s1] -> (s0 * 601529784 + s1 * 469212 - ((s0 * 1282 + s1) floordiv 8) * 3752964 - ((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 2928)>
#map37 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4)>
#map38 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 1)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map40 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 2)>
#map41 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map42 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 3)>
#map43 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map44 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 8)>
#map45 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map46 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 9)>
#map47 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map48 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 10)>
#map49 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map50 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 11)>
#map51 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map52 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 16)>
#map53 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map54 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 17)>
#map55 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map56 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 18)>
#map57 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map58 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 19)>
#map59 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map60 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 24)>
#map61 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map62 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 25)>
#map63 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map64 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 26)>
#map65 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map66 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 27)>
#map67 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 27)>
#map68 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 32) * 32 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 32)>
#map69 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 32) * 32 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 64)>
#map70 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 32) * 32 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 96)>
#map71 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 32) * 32 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 128)>
#map72 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 32) * 32 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 160)>
#map73 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 32) * 32 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 192)>
#map74 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 32) * 32 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 224)>
#map75 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 32) * 32 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 256)>
#map76 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 32) * 32 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 288)>
#map77 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 32) * 32 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 320)>
#map78 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 32) * 32 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 352)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %52 = arith.minsi %51, %c732 : index
        %53 = affine.apply #map9()[%thread_id_x, %thread_id_y]
        %54 = arith.cmpi slt, %53, %52 : index
        %55 = vector.broadcast %54 : i1 to vector<8xi1>
        vector.maskedstore %view[%53, %11], %55, %21 : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        %56 = affine.apply #map10()[%thread_id_x, %thread_id_y]
        %57 = arith.cmpi slt, %56, %52 : index
        %58 = vector.broadcast %57 : i1 to vector<8xi1>
        vector.maskedstore %view[%56, %11], %58, %33 : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        %59 = affine.apply #map11()[%thread_id_x, %thread_id_y]
        %60 = arith.cmpi slt, %59, %52 : index
        %61 = vector.broadcast %60 : i1 to vector<8xi1>
        vector.maskedstore %view[%59, %11], %61, %45 : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        ...
        %103:12 = scf.for %arg3 = %c0 to %c179 step %c1 iter_args(%arg4 = %cst_2, %arg5 = %cst_2, %arg6 = %cst_2, %arg7 = %cst_2, %arg8 = %cst_2, %arg9 = %cst_2, %arg10 = %cst_2, %arg11 = %cst_2, %arg12 = %cst_2, %arg13 = %cst_2, %arg14 = %cst_2, %arg15 = %cst_2) -> (vector<16xf32>, vector<16xf32>, vector<16xf32>, vector<16xf32>, vector<16xf32>, vector<16xf32>, vector<16xf32>, vector<16xf32>, vector<16xf32>, vector<16xf32>, vector<16xf32>, vector<16xf32>) {
          amdgpu.lds_barrier
          %1065 = vector.maskedload %view[%62, %65], %64, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1066 = vector.maskedload %view[%62, %66], %64, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1067 = vector.maskedload %view[%67, %65], %69, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1068 = vector.maskedload %view[%67, %66], %69, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1069 = vector.maskedload %view[%70, %65], %72, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1070 = vector.maskedload %view[%70, %66], %72, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1071 = vector.maskedload %view[%73, %65], %75, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1072 = vector.maskedload %view[%73, %66], %75, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1073 = vector.maskedload %view[%76, %65], %78, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1074 = vector.maskedload %view[%76, %66], %78, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1075 = vector.maskedload %view[%79, %65], %81, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1076 = vector.maskedload %view[%79, %66], %81, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1077 = vector.maskedload %view[%82, %65], %84, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1078 = vector.maskedload %view[%82, %66], %84, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1079 = vector.maskedload %view[%85, %65], %87, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1080 = vector.maskedload %view[%85, %66], %87, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1081 = vector.maskedload %view[%88, %65], %90, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1082 = vector.maskedload %view[%88, %66], %90, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1083 = vector.maskedload %view[%91, %65], %93, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1084 = vector.maskedload %view[%91, %66], %93, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1085 = vector.maskedload %view[%94, %65], %96, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1086 = vector.maskedload %view[%94, %66], %96, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1087 = vector.maskedload %view[%97, %65], %99, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %1088 = vector.maskedload %view[%97, %66], %99, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          ...
          vector.maskedstore %view[%53, %11], %55, %1102 : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
          vector.maskedstore %view[%56, %11], %58, %1110 : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
          vector.maskedstore %view[%59, %11], %61, %1118 : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        ...
        %108 = vector.maskedload %view[%104, %107], %106, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %109 = affine.apply #map14()[%thread_id_x]
        %110 = vector.maskedload %view[%104, %109], %106, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %111 = affine.apply #map15()[%thread_id_x, %thread_id_y]
        %112 = arith.cmpi slt, %111, %52 : index
        %113 = vector.broadcast %112 : i1 to vector<4xi1>
        %114 = vector.maskedload %view[%111, %107], %113, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %115 = vector.maskedload %view[%111, %109], %113, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %116 = affine.apply #map16()[%thread_id_x, %thread_id_y]
        %117 = arith.cmpi slt, %116, %52 : index
        %118 = vector.broadcast %117 : i1 to vector<4xi1>
        %119 = vector.maskedload %view[%116, %107], %118, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %120 = vector.maskedload %view[%116, %109], %118, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %121 = affine.apply #map17()[%thread_id_x, %thread_id_y]
        %122 = arith.cmpi slt, %121, %52 : index
        %123 = vector.broadcast %122 : i1 to vector<4xi1>
        %124 = vector.maskedload %view[%121, %107], %123, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %125 = vector.maskedload %view[%121, %109], %123, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %126 = affine.apply #map18()[%thread_id_x, %thread_id_y]
        %127 = arith.cmpi slt, %126, %52 : index
        %128 = vector.broadcast %127 : i1 to vector<4xi1>
        %129 = vector.maskedload %view[%126, %107], %128, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %130 = vector.maskedload %view[%126, %109], %128, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %131 = affine.apply #map19()[%thread_id_x, %thread_id_y]
        %132 = arith.cmpi slt, %131, %52 : index
        %133 = vector.broadcast %132 : i1 to vector<4xi1>
        %134 = vector.maskedload %view[%131, %107], %133, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %135 = vector.maskedload %view[%131, %109], %133, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %136 = affine.apply #map20()[%thread_id_x, %thread_id_y]
        %137 = arith.cmpi slt, %136, %52 : index
        %138 = vector.broadcast %137 : i1 to vector<4xi1>
        %139 = vector.maskedload %view[%136, %107], %138, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %140 = vector.maskedload %view[%136, %109], %138, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %141 = affine.apply #map21()[%thread_id_x, %thread_id_y]
        %142 = arith.cmpi slt, %141, %52 : index
        %143 = vector.broadcast %142 : i1 to vector<4xi1>
        %144 = vector.maskedload %view[%141, %107], %143, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %145 = vector.maskedload %view[%141, %109], %143, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %146 = affine.apply #map22()[%thread_id_x, %thread_id_y]
        %147 = arith.cmpi slt, %146, %52 : index
        %148 = vector.broadcast %147 : i1 to vector<4xi1>
        %149 = vector.maskedload %view[%146, %107], %148, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %150 = vector.maskedload %view[%146, %109], %148, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %151 = affine.apply #map23()[%thread_id_x, %thread_id_y]
        %152 = arith.cmpi slt, %151, %52 : index
        %153 = vector.broadcast %152 : i1 to vector<4xi1>
        %154 = vector.maskedload %view[%151, %107], %153, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %155 = vector.maskedload %view[%151, %109], %153, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %156 = affine.apply #map24()[%thread_id_x, %thread_id_y]
        %157 = arith.cmpi slt, %156, %52 : index
        %158 = vector.broadcast %157 : i1 to vector<4xi1>
        %159 = vector.maskedload %view[%156, %107], %158, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %160 = vector.maskedload %view[%156, %109], %158, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %161 = affine.apply #map25()[%thread_id_x, %thread_id_y]
        %162 = arith.cmpi slt, %161, %52 : index
        %163 = vector.broadcast %162 : i1 to vector<4xi1>
        %164 = vector.maskedload %view[%161, %107], %163, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %165 = vector.maskedload %view[%161, %109], %163, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        ...
        %196 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<20512x2880xf32, strided<[2880, 1], offset: ?>>
        %197 = affine.apply #map29()[%block_id_y, %thread_id_y]
        %198 = affine.apply #map30()[%block_id_y]
        %199 = arith.minsi %197, %198 : index
        %200 = arith.minsi %199, %c2880 : index
        ...
        %212 = arith.muli %209, %c2880 overflow<nsw> : index
        %213 = arith.muli %211, %c2880 overflow<nsw> : index
        %214 = arith.addi %212, %210 overflow<nsw> : index
        %215 = arith.addi %213, %104 overflow<nsw> : index
        %base_buffer_9, %offset_10, %sizes_11:2, %strides_12:2 = memref.extract_strided_metadata %196 : memref<20512x2880xf32, strided<[2880, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %216 = arith.addi %214, %offset_10 overflow<nsw> : index
        %reinterpret_cast_13 = memref.reinterpret_cast %196 to offset: [%216], sizes: [%c536870910], strides: [1] : memref<20512x2880xf32, strided<[2880, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %217 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_13 validBytes(%c2147483643_i32) cacheSwizzleStride(%c2880_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %296 = arith.muli %295, %c2880 overflow<nsw> : index
        ...
        %304 = arith.muli %303, %c2880 overflow<nsw> : index
        ...
        %312 = arith.muli %311, %c2880 overflow<nsw> : index
        ...
        %320 = arith.muli %319, %c2880 overflow<nsw> : index
        ...
        %328 = arith.muli %327, %c2880 overflow<nsw> : index
        ...
        %336 = arith.muli %335, %c2880 overflow<nsw> : index
