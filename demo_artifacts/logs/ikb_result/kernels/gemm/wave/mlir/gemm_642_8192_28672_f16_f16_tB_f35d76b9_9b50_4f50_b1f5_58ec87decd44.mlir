...
#map57 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304)>
#map58 = affine_map<()[s0, s1] -> (s0 * 172 + (s1 floordiv 64) * 43 + 43)>
#map59 = affine_map<()[s0] -> (s0 * 172 + 172)>
#map60 = affine_map<()[s0, s1, s2] -> (((s0 * 4 + s1 * 16 - ((s0 + s1 * 4) floordiv 8) * 31) floordiv 8) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4)>
#map61 = affine_map<()[s0, s1] -> (((s0 * 4 + s1 * 16 - ((s0 + s1 * 4) floordiv 8) * 31) floordiv 8) * 172)>
#map62 = affine_map<()[s0, s1] -> (s0 * 4152 + s1 * 16608 - ((s0 + s1 * 4) floordiv 8) * 32178 - ((s0 * 4 + s1 * 16 - ((s0 + s1 * 4) floordiv 8) * 31) floordiv 8) * 8304)>
#map63 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4)>
#map64 = affine_map<()[s0, s1, s2] -> (((s0 * 4 + s1 * 16 - ((s0 + s1 * 4) floordiv 8) * 31) floordiv 8) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 1)>
#map65 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map66 = affine_map<()[s0, s1, s2] -> (((s0 * 4 + s1 * 16 - ((s0 + s1 * 4) floordiv 8) * 31) floordiv 8) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 2)>
#map67 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map68 = affine_map<()[s0, s1, s2] -> (((s0 * 4 + s1 * 16 - ((s0 + s1 * 4) floordiv 8) * 31) floordiv 8) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 3)>
#map69 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map70 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 16)>
#map71 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 32)>
#map72 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 48)>
#map73 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 64)>
#map74 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 80)>
#map75 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 96)>
#map76 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 112)>
#map77 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 128)>
#map78 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 144)>
#map79 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 160)>
#map80 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 176)>
#map81 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 192)>
#map82 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 208)>
#map83 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 224)>
#map84 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 240)>
#map85 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 256)>
#map86 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 272)>
#map87 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 288)>
#map88 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 304)>
#map89 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 320)>
#map90 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 336)>
#map91 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 352)>
#map92 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 368)>
#map93 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 384)>
#map94 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 400)>
#map95 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 416)>
#map96 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 432)>
#map97 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 448)>
#map98 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 464)>
#map99 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 480)>
#map100 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 496)>
#map101 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4152 + s2 * 16608 + s3 * 519 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32178 - ((s1 * 4 + s2 * 16 - ((s1 + s2 * 4) floordiv 8) * 31) floordiv 8) * 8304 + 512)>
#map102 = affine_map<()[s0, s1, s2] -> (((s0 * 4 + s1 * 16 - ((s0 + s1 * 4) floordiv 8) * 31) floordiv 8) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 16)>
#map103 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 16)>
#map104 = affine_map<()[s0, s1, s2] -> (((s0 * 4 + s1 * 16 - ((s0 + s1 * 4) floordiv 8) * 31) floordiv 8) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 17)>
#map105 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 17)>
#map106 = affine_map<()[s0, s1, s2] -> (((s0 * 4 + s1 * 16 - ((s0 + s1 * 4) floordiv 8) * 31) floordiv 8) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 18)>
#map107 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 18)>
#map108 = affine_map<()[s0, s1, s2] -> (((s0 * 4 + s1 * 16 - ((s0 + s1 * 4) floordiv 8) * 31) floordiv 8) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 19)>
#map109 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 19)>
#map110 = affine_map<()[s0, s1, s2] -> (((s0 * 4 + s1 * 16 - ((s0 + s1 * 4) floordiv 8) * 31) floordiv 8) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 32)>
#map111 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 32)>
#map112 = affine_map<()[s0, s1, s2] -> (((s0 * 4 + s1 * 16 - ((s0 + s1 * 4) floordiv 8) * 31) floordiv 8) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 33)>
#map113 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 33)>
#map114 = affine_map<()[s0, s1, s2] -> (((s0 * 4 + s1 * 16 - ((s0 + s1 * 4) floordiv 8) * 31) floordiv 8) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 34)>
#map115 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 34)>
#map116 = affine_map<()[s0, s1, s2] -> (((s0 * 4 + s1 * 16 - ((s0 + s1 * 4) floordiv 8) * 31) floordiv 8) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 35)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %209:99 = scf.for %arg3 = %c0 to %c1791 step %c1 iter_args(%arg4 = %cst_4, %arg5 = %cst_4, %arg6 = %cst_4, %arg7 = %cst_4, %arg8 = %cst_4, %arg9 = %cst_4, %arg10 = %cst_4, %arg11 = %cst_4, %arg12 = %cst_4, %arg13 = %cst_4, %arg14 = %cst_4, %arg15 = %cst_4, %arg16 = %cst_4, %arg17 = %cst_4, %arg18 = %cst_4, %arg19 = %cst_4, %arg20 = %cst_4, %arg21 = %cst_4, %arg22 = %cst_4, %arg23 = %cst_4, %arg24 = %cst_4, %arg25 = %cst_4, %arg26 = %cst_4, %arg27 = %cst_4, %arg28 = %cst_4, %arg29 = %cst_4, %arg30 = %cst_4, %arg31 = %cst_4, %arg32 = %cst_4, %arg33 = %cst_4, %arg34 = %cst_4, %arg35 = %cst_4, %arg36 = %cst_4, %arg37 = %cst_4, %arg38 = %cst_4, %arg39 = %cst_4, %arg40 = %cst_4, %arg41 = %cst_4, %arg42 = %cst_4, %arg43 = %cst_4, %arg44 = %cst_4, %arg45 = %cst_4, %arg46 = %cst_4, %arg47 = %cst_4, %arg48 = %cst_4, %arg49 = %cst_4, %arg50 = %cst_4, %arg51 = %cst_4, %arg52 = %cst_4, %arg53 = %cst_4, %arg54 = %cst_4, %arg55 = %cst_4, %arg56 = %cst_4, %arg57 = %cst_4, %arg58 = %cst_4, %arg59 = %cst_4, %arg60 = %cst_4, %arg61 = %cst_4, %arg62 = %cst_4, %arg63 = %cst_4, %arg64 = %cst_4, %arg65 = %cst_4, %arg66 = %cst_4, %arg67 = %cst_4, %arg68 = %cst_4, %arg69 = %cst_4, %arg70 = %cst_4, %arg71 = %cst_4, %arg72 = %cst_4, %arg73 = %cst_4, %arg74 = %cst_4, %arg75 = %cst_4, %arg76 = %cst_4, %arg77 = %cst_4, %arg78 = %cst_4, %arg79 = %cst_4, %arg80 = %cst_4, %arg81 = %cst_4, %arg82 = %cst_4, %arg83 = %cst_4, %arg84 = %cst_4, %arg85 = %cst_4, %arg86 = %cst_4, %arg87 = %cst_4, %arg88 = %cst_4, %arg89 = %cst_4, %arg90 = %cst_4, %arg91 = %cst_4, %arg92 = %cst_4, %arg93 = %cst_4, %arg94 = %cst_4, %arg95 = %cst_4, %arg96 = %cst_4, %arg97 = %cst_4, %arg98 = %cst_4, %arg99 = %cst_4, %arg100 = %cst_4, %arg101 = %cst_4, %arg102 = %cst_4) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          amdgpu.lds_barrier
          %2167 = vector.maskedload %view[%100, %103], %102, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2168 = vector.maskedload %view[%104, %103], %106, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2169 = vector.maskedload %view[%107, %103], %109, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2170 = vector.maskedload %view[%110, %103], %112, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2171 = vector.maskedload %view[%113, %103], %115, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2172 = vector.maskedload %view[%116, %103], %118, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2173 = vector.maskedload %view[%119, %103], %121, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2174 = vector.maskedload %view[%122, %103], %124, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2175 = vector.maskedload %view[%125, %103], %127, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2176 = vector.maskedload %view[%128, %103], %130, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2177 = vector.maskedload %view[%131, %103], %133, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2178 = vector.maskedload %view[%134, %103], %136, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2179 = vector.maskedload %view[%137, %103], %139, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2180 = vector.maskedload %view[%140, %103], %142, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2181 = vector.maskedload %view[%143, %103], %145, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2182 = vector.maskedload %view[%146, %103], %148, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2183 = vector.maskedload %view[%149, %103], %151, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2184 = vector.maskedload %view[%152, %103], %154, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2185 = vector.maskedload %view[%155, %103], %157, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2186 = vector.maskedload %view[%158, %103], %160, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2187 = vector.maskedload %view[%161, %103], %163, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2188 = vector.maskedload %view[%164, %103], %166, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2189 = vector.maskedload %view[%167, %103], %169, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2190 = vector.maskedload %view[%170, %103], %172, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2191 = vector.maskedload %view[%173, %103], %175, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2192 = vector.maskedload %view[%176, %103], %178, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2193 = vector.maskedload %view[%179, %103], %181, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2194 = vector.maskedload %view[%182, %103], %184, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2195 = vector.maskedload %view[%185, %103], %187, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2196 = vector.maskedload %view[%188, %103], %190, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2197 = vector.maskedload %view[%191, %103], %193, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2198 = vector.maskedload %view[%194, %103], %196, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %2199 = vector.maskedload %view[%197, %103], %199, %cst : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          ...
          vector.maskedstore %view[%85, %19], %87, %2220 : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
          vector.maskedstore %view[%88, %19], %90, %2228 : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
          vector.maskedstore %view[%91, %19], %93, %2236 : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
          vector.maskedstore %view[%94, %19], %96, %2244 : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
          vector.maskedstore %view[%97, %19], %99, %2252 : memref<1038x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        ...
        %455 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<642x8192xf32, strided<[8192, 1], offset: ?>>
        %456 = affine.apply #map55()[%block_id_y, %thread_id_y]
        %457 = affine.apply #map56()[%block_id_y]
        %458 = arith.minsi %456, %457 : index
        %459 = arith.minsi %458, %c8192 : index
        ...
        %472 = arith.muli %469, %c8192 overflow<nsw> : index
        %473 = arith.muli %471, %c8192 overflow<nsw> : index
        %474 = arith.addi %472, %470 overflow<nsw> : index
        %475 = arith.addi %473, %210 overflow<nsw> : index
        %base_buffer_11, %offset_12, %sizes_13:2, %strides_14:2 = memref.extract_strided_metadata %455 : memref<642x8192xf32, strided<[8192, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %476 = arith.addi %474, %offset_12 overflow<nsw> : index
        %reinterpret_cast_15 = memref.reinterpret_cast %455 to offset: [%476], sizes: [%c536870910], strides: [1] : memref<642x8192xf32, strided<[8192, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %477 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_15 validBytes(%c2147483643_i32) cacheSwizzleStride(%c-8192_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %1084 = arith.muli %1083, %c8192 overflow<nsw> : index
        ...
        %1092 = arith.muli %1091, %c8192 overflow<nsw> : index
        ...
        %1100 = arith.muli %1099, %c8192 overflow<nsw> : index
        ...
        %1108 = arith.muli %1107, %c8192 overflow<nsw> : index
