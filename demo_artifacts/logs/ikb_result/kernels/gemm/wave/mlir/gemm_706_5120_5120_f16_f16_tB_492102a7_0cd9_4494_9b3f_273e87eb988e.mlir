...
#map1 = affine_map<()[s0, s1, s2] -> (s0 mod 16 + ((s1 * 81000 + s2 * 1800 - ((s1 * 45 + s2) floordiv 8) * 14399) floordiv 320) * 16 + (s0 floordiv 64) * 4)>
#map2 = affine_map<()[s0] -> (((s0 mod 64) floordiv 16) * 4)>
#map3 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 1296000 + s2 * 28800 + s3 * 8 - (s0 floordiv 16) * 16 - ((s1 * 45 + s2) floordiv 8) * 230384 - ((s1 * 81000 + s2 * 1800 - ((s1 * 45 + s2) floordiv 8) * 14399) floordiv 320) * 5120)>
...
#map10 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4)>
#map11 = affine_map<()[s0, s1] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16)>
#map12 = affine_map<()[s0, s1] -> (s0 * 1296000 + s1 * 28800 - ((s0 * 45 + s1) floordiv 8) * 230384 - ((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 5120)>
#map13 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4)>
#map14 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4 + 1)>
#map15 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map16 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4 + 2)>
#map17 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map18 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4 + 3)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %17 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<5120x5120xf16, strided<[5120, 1], offset: ?>>
        ...
        %base_buffer_4, %offset_5, %sizes_6:2, %strides_7:2 = memref.extract_strided_metadata %17 : memref<5120x5120xf16, strided<[5120, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_8 = memref.reinterpret_cast %17 to offset: [%offset_5], sizes: [%c1073741822], strides: [1] : memref<5120x5120xf16, strided<[5120, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %46 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<706x5120xf32, strided<[5120, 1], offset: ?>>
        ...
        %53 = arith.muli %50, %c5120 overflow<nsw> : index
        %54 = arith.muli %52, %c5120 overflow<nsw> : index
        %55 = arith.addi %53, %51 overflow<nsw> : index
        %56 = arith.addi %54, %37 overflow<nsw> : index
        %base_buffer_9, %offset_10, %sizes_11:2, %strides_12:2 = memref.extract_strided_metadata %46 : memref<706x5120xf32, strided<[5120, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %57 = arith.addi %55, %offset_10 overflow<nsw> : index
        %reinterpret_cast_13 = memref.reinterpret_cast %46 to offset: [%57], sizes: [%c536870910], strides: [1] : memref<706x5120xf32, strided<[5120, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %58 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_13 validBytes(%c2147483643_i32) cacheSwizzleStride(%c5120_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %65 = arith.muli %64, %c5120 overflow<nsw> : index
        ...
        %73 = arith.muli %72, %c5120 overflow<nsw> : index
        ...
        %81 = arith.muli %80, %c5120 overflow<nsw> : index
