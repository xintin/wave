#map = affine_map<()[s0, s1] -> (((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) floordiv 160) * -8 + 6)>
#map1 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8) floordiv 128) * 128 + ((s2 * 90 + s3 * 15 - ((s2 * 6 + s3) floordiv 8) * 119) floordiv 160) * 1024 + (((s2 * 90 + s3 * 15 - ((s2 * 6 + s3) floordiv 8) * 119) mod 160) mod s4) * 128)>
#map2 = affine_map<()[s0] -> (s0 * 8 - (s0 floordiv 8) * 64)>
#map3 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 128) * 128 + ((s2 * 90 + s3 * 15 - ((s2 * 6 + s3) floordiv 8) * 119) floordiv 160) * 1024 + (((s2 * 90 + s3 * 15 - ((s2 * 6 + s3) floordiv 8) * 119) mod 160) mod s4) * 128 + 64)>
#map4 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8) floordiv 256) * 256 + (((s2 * 90 + s3 * 15 - ((s2 * 6 + s3) floordiv 8) * 119) mod 160) floordiv s4) * 256)>
#map5 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 256) * 256 + (((s2 * 90 + s3 * 15 - ((s2 * 6 + s3) floordiv 8) * 119) mod 160) floordiv s4) * 256 + 64)>
#map6 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 128) floordiv 256) * 256 + (((s2 * 90 + s3 * 15 - ((s2 * 6 + s3) floordiv 8) * 119) mod 160) floordiv s4) * 256 + 128)>
#map7 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 192) floordiv 256) * 256 + (((s2 * 90 + s3 * 15 - ((s2 * 6 + s3) floordiv 8) * 119) mod 160) floordiv s4) * 256 + 192)>
...
#map30 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 32 + ((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) floordiv 160) * 1024 + (((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) mod 160) mod s2) * 128 + ((s3 mod 64) floordiv 16) * 4)>
#map31 = affine_map<()[s0, s1, s2] -> (((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) floordiv 160) * 1024 + (((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) mod 160) mod s2) * 128)>
#map32 = affine_map<()[s0, s1, s2] -> ((((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) mod 160) floordiv s2) * 256)>
#map33 = affine_map<()[s0] -> ((s0 floordiv 64) * 32 + ((s0 mod 64) floordiv 16) * 4)>
#map34 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 32 + ((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) floordiv 160) * 1024 + (((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) mod 160) mod s2) * 128 + ((s3 mod 64) floordiv 16) * 4 + 1)>
#map35 = affine_map<()[s0] -> ((s0 floordiv 64) * 32 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map36 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 32 + ((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) floordiv 160) * 1024 + (((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) mod 160) mod s2) * 128 + ((s3 mod 64) floordiv 16) * 4 + 2)>
#map37 = affine_map<()[s0] -> ((s0 floordiv 64) * 32 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map38 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 32 + ((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) floordiv 160) * 1024 + (((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) mod 160) mod s2) * 128 + ((s3 mod 64) floordiv 16) * 4 + 3)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 32 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map40 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 32 + ((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) floordiv 160) * 1024 + (((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) mod 160) mod s2) * 128 + ((s3 mod 64) floordiv 16) * 4 + 16)>
#map41 = affine_map<()[s0] -> ((s0 floordiv 64) * 32 + ((s0 mod 64) floordiv 16) * 4 + 16)>
#map42 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 32 + ((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) floordiv 160) * 1024 + (((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) mod 160) mod s2) * 128 + ((s3 mod 64) floordiv 16) * 4 + 17)>
#map43 = affine_map<()[s0] -> ((s0 floordiv 64) * 32 + ((s0 mod 64) floordiv 16) * 4 + 17)>
#map44 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 32 + ((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) floordiv 160) * 1024 + (((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) mod 160) mod s2) * 128 + ((s3 mod 64) floordiv 16) * 4 + 18)>
#map45 = affine_map<()[s0] -> ((s0 floordiv 64) * 32 + ((s0 mod 64) floordiv 16) * 4 + 18)>
#map46 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 32 + ((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) floordiv 160) * 1024 + (((s0 * 90 + s1 * 15 - ((s0 * 6 + s1) floordiv 8) * 119) mod 160) mod s2) * 128 + ((s3 mod 64) floordiv 16) * 4 + 19)>
...
module attributes {transform.with_named_sequence} {
  stream.executable private @gemm {
    stream.executable.export public @gemm workgroups() -> (index, index, index) {
      ...
      stream.return %c6, %c20, %c1 : index, index, index
    }
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %31 = arith.muli %30, %c13824 overflow<nsw> : index
        %32 = arith.addi %31, %6 overflow<nsw> : index
        %base_buffer_3, %offset_4, %sizes_5:2, %strides_6:2 = memref.extract_strided_metadata %29 : memref<5120x13824xf16, strided<[13824, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_7 = memref.reinterpret_cast %29 to offset: [%offset_4], sizes: [%c1073741822], strides: [1] : memref<5120x13824xf16, strided<[13824, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        %33 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_7 validBytes(%c2147483645_i32) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %36 = arith.muli %35, %c13824 overflow<nsw> : index
        ...
        %40 = arith.muli %39, %c13824 overflow<nsw> : index
        ...
        %44 = arith.muli %43, %c13824 overflow<nsw> : index
        ...
        %71:16 = scf.for %arg3 = %c0 to %c215 step %c1 iter_args(%arg4 = %cst_1, %arg5 = %cst_1, %arg6 = %cst_1, %arg7 = %cst_1, %arg8 = %cst_1, %arg9 = %cst_1, %arg10 = %cst_1, %arg11 = %cst_1, %arg12 = %cst_1, %arg13 = %cst_1, %arg14 = %cst_1, %arg15 = %cst_1, %arg16 = %cst_1, %arg17 = %cst_1, %arg18 = %cst_1, %arg19 = %cst_1) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          ...
          vector.store %485, %view[%51, %6] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %479, %view[%49, %6] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %483, %view[%52, %6] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %481, %view[%50, %6] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          rocdl.s.barrier
          llvm.call_intrinsic "llvm.amdgcn.sched.barrier"(%c0_i32) : (i32) -> ()
          rocdl.s.setprio 1
        ...
        %191 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<706x5120xf32, strided<[5120, 1], offset: ?>>
        %192 = affine.apply #map30()[%block_id_y, %block_id_x, %2, %thread_id_x]
        %193 = arith.cmpi slt, %192, %c706 : index
        ...
        %197 = arith.muli %194, %c5120 overflow<nsw> : index
        %198 = arith.muli %196, %c5120 overflow<nsw> : index
        %199 = arith.addi %197, %195 overflow<nsw> : index
        %200 = arith.addi %198, %72 overflow<nsw> : index
        %base_buffer_8, %offset_9, %sizes_10:2, %strides_11:2 = memref.extract_strided_metadata %191 : memref<706x5120xf32, strided<[5120, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %201 = arith.addi %199, %offset_9 overflow<nsw> : index
        %reinterpret_cast_12 = memref.reinterpret_cast %191 to offset: [%201], sizes: [%c536870910], strides: [1] : memref<706x5120xf32, strided<[5120, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %202 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_12 validBytes(%c2147483643_i32) cacheSwizzleStride(%c5120_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %206 = arith.cmpi slt, %205, %c706 : index
        ...
        %220 = arith.cmpi slt, %219, %c706 : index
        ...
        %311 = arith.cmpi slt, %310, %c706 : index
        ...
        %318 = arith.cmpi slt, %317, %c706 : index
        ...
        %332 = arith.cmpi slt, %331, %c706 : index
