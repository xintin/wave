#map = affine_map<()[s0, s1] -> (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 8960) * -5 + 7)>
#map1 = affine_map<()[s0, s1] -> (s0 * 96 + (s1 floordiv 64) * 24 + 24)>
#map2 = affine_map<()[s0, s1, s2, s3] -> (s0 mod 32 + (s0 floordiv 64) * 24 + ((s1 * 10976 + s2 * 1568 - ((s1 * 7 + s2) floordiv 8) * 12543) floordiv 8960) * 480 + (((s1 * 10976 + s2 * 1568 - ((s1 * 7 + s2) floordiv 8) * 12543) mod 8960) mod s3) * 96)>
#map3 = affine_map<()[s0] -> (((s0 mod 64) floordiv 32) * 8)>
#map4 = affine_map<()[s0, s1] -> (s0 * 16 + s1 * 8 + 8)>
#map5 = affine_map<()[s0] -> (s0 * 16 + 16)>
#map6 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 32 + s4 * 8 + (((s1 * 10976 + s2 * 1568 - ((s1 * 7 + s2) floordiv 8) * 12543) mod 8960) floordiv s3) * 16)>
...
#map12 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 8960) * 480 + (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) mod 8960) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4)>
#map13 = affine_map<()[s0, s1, s2] -> (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 8960) * 480 + (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) mod 8960) mod s2) * 96)>
#map14 = affine_map<()[s0, s1, s2] -> ((((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) mod 8960) floordiv s2) * 16)>
#map15 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4)>
#map16 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 8960) * 480 + (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) mod 8960) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 1)>
#map17 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map18 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 8960) * 480 + (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) mod 8960) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 2)>
#map19 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map20 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 8960) * 480 + (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) mod 8960) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 3)>
#map21 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map22 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 8960) * 480 + (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) mod 8960) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 8)>
#map23 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map24 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 8960) * 480 + (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) mod 8960) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 9)>
#map25 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map26 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 8960) * 480 + (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) mod 8960) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 10)>
#map27 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map28 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 8960) * 480 + (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) mod 8960) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 11)>
#map29 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map30 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 8960) * 480 + (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) mod 8960) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 16)>
#map31 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map32 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 8960) * 480 + (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) mod 8960) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 17)>
#map33 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map34 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 8960) * 480 + (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) mod 8960) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 18)>
#map35 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map36 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 8960) * 480 + (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) mod 8960) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 19)>
#map37 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map38 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 8960) * 480 + (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) mod 8960) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 24)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map40 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 8960) * 480 + (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) mod 8960) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 25)>
#map41 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map42 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 8960) * 480 + (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) mod 8960) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 26)>
#map43 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map44 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 8960) * 480 + (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) mod 8960) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 27)>
...
module attributes {transform.with_named_sequence} {
  stream.executable private @gemm {
    stream.executable.export public @gemm workgroups() -> (index, index, index) {
      ...
      stream.return %c7, %c1792, %c1 : index, index, index
    }
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %20 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<28672x8192xf16, strided<[8192, 1], offset: ?>>
        ...
        %27 = arith.muli %24, %c8192 overflow<nsw> : index
        %28 = arith.addi %27, %9 overflow<nsw> : index
        %base_buffer_4, %offset_5, %sizes_6:2, %strides_7:2 = memref.extract_strided_metadata %20 : memref<28672x8192xf16, strided<[8192, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_8 = memref.reinterpret_cast %20 to offset: [%offset_5], sizes: [%c1073741822], strides: [1] : memref<28672x8192xf16, strided<[8192, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        %29 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_8 validBytes(%c2147483645_i32) cacheSwizzleStride(%c-8192_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %47 = scf.for %arg3 = %c0 to %c511 step %c1 iter_args(%arg4 = %cst_2) -> (vector<16xf32>) {
          amdgpu.lds_barrier
        ...
        %57 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<642x28672xf32, strided<[28672, 1], offset: ?>>
        ...
        %64 = arith.muli %61, %c28672 overflow<nsw> : index
        %65 = arith.muli %63, %c28672 overflow<nsw> : index
        %66 = arith.addi %64, %62 overflow<nsw> : index
        %67 = arith.addi %65, %44 overflow<nsw> : index
        %base_buffer_9, %offset_10, %sizes_11:2, %strides_12:2 = memref.extract_strided_metadata %57 : memref<642x28672xf32, strided<[28672, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %68 = arith.addi %66, %offset_10 overflow<nsw> : index
        %reinterpret_cast_13 = memref.reinterpret_cast %57 to offset: [%68], sizes: [%c536870910], strides: [1] : memref<642x28672xf32, strided<[28672, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %69 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_13 validBytes(%c2147483643_i32) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %76 = arith.muli %75, %c28672 overflow<nsw> : index
        ...
        %84 = arith.muli %83, %c28672 overflow<nsw> : index
        ...
        %92 = arith.muli %91, %c28672 overflow<nsw> : index
        ...
        %100 = arith.muli %99, %c28672 overflow<nsw> : index
        ...
        %108 = arith.muli %107, %c28672 overflow<nsw> : index
        ...
        %116 = arith.muli %115, %c28672 overflow<nsw> : index
