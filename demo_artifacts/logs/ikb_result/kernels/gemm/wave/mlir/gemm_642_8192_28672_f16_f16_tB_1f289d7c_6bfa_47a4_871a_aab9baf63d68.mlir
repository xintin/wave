...
#map3 = affine_map<()[s0, s1, s2, s3] -> ((s0 floordiv 16) mod 16 + (((s1 * 256 + s2 * 1024 - ((s1 + s2 * 4) floordiv 8) * 2047) mod 1536) floordiv s3) * 16)>
...
#map18 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 32 + s4 * 8 + (((s1 * 256 + s2 * 1024 - ((s1 + s2 * 4) floordiv 8) * 2047) mod 1536) floordiv s3) * 16)>
#map19 = affine_map<()[s0, s1] -> (s0 * 172 + (s1 floordiv 64) * 43 + 43)>
#map20 = affine_map<()[s0] -> (s0 * 172 + 172)>
#map21 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4)>
#map22 = affine_map<()[s0, s1, s2] -> (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172)>
#map23 = affine_map<()[s0, s1, s2] -> ((((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) floordiv s2) * 16)>
#map24 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4)>
#map25 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 1)>
#map26 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map27 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 2)>
#map28 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map29 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 3)>
#map30 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map31 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 8)>
#map32 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map33 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 9)>
#map34 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map35 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 10)>
#map36 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map37 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 11)>
#map38 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map39 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 16)>
#map40 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map41 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 17)>
#map42 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map43 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 18)>
#map44 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map45 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 19)>
#map46 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map47 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 24)>
#map48 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map49 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 25)>
#map50 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map51 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 26)>
#map52 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map53 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 27)>
#map54 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 27)>
#map55 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 32)>
#map56 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 32)>
#map57 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 33)>
#map58 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 33)>
#map59 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 34)>
#map60 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 34)>
#map61 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 35)>
#map62 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 35)>
#map63 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 40)>
#map64 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 40)>
#map65 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 41)>
#map66 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 41)>
#map67 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 42)>
#map68 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 42)>
#map69 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 43)>
#map70 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 43)>
#map71 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 48)>
#map72 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 48)>
#map73 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 49)>
#map74 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 49)>
#map75 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 50)>
#map76 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 50)>
#map77 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 51)>
#map78 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 51)>
#map79 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 56)>
#map80 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 56)>
#map81 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 57)>
#map82 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 57)>
#map83 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 58)>
#map84 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 32) * 4 + 58)>
#map85 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 43 + ((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 1536) * 516 + (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) mod 1536) mod s2) * 172 + ((s3 mod 64) floordiv 32) * 4 + 59)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %21 = arith.muli %19, %c28672 overflow<nsw> : index
        %22 = arith.addi %21, %20 overflow<nsw> : index
        %base_buffer_4, %offset_5, %sizes_6:2, %strides_7:2 = memref.extract_strided_metadata %18 : memref<8192x28672xf16, strided<[28672, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_8 = memref.reinterpret_cast %18 to offset: [%offset_5], sizes: [%c1073741822], strides: [1] : memref<8192x28672xf16, strided<[28672, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %46:2 = scf.for %arg3 = %c0 to %c1791 step %c1 iter_args(%arg4 = %cst_2, %arg5 = %cst_2) -> (vector<16xf32>, vector<16xf32>) {
          amdgpu.lds_barrier
        ...
        %69 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<642x8192xf32, strided<[8192, 1], offset: ?>>
        ...
        %85 = arith.muli %82, %c8192 overflow<nsw> : index
        %86 = arith.muli %84, %c8192 overflow<nsw> : index
        %87 = arith.addi %85, %83 overflow<nsw> : index
        %88 = arith.addi %86, %47 overflow<nsw> : index
        %base_buffer_9, %offset_10, %sizes_11:2, %strides_12:2 = memref.extract_strided_metadata %69 : memref<642x8192xf32, strided<[8192, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %89 = arith.addi %87, %offset_10 overflow<nsw> : index
        %reinterpret_cast_13 = memref.reinterpret_cast %69 to offset: [%89], sizes: [%c536870910], strides: [1] : memref<642x8192xf32, strided<[8192, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %90 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_13 validBytes(%c2147483643_i32) cacheSwizzleStride(%c-8192_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
