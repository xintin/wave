...
#map2 = affine_map<()[s0, s1, s2, s3] -> (s0 mod 16 + (s0 floordiv 64) * 4 + ((s1 * 226800 + s2 * 5040 - ((s1 * 45 + s2) floordiv 8) * 40319) floordiv 20608) * 368 + (((s1 * 226800 + s2 * 5040 - ((s1 * 45 + s2) floordiv 8) * 40319) mod 20608) mod s3) * 16)>
#map3 = affine_map<()[s0] -> (((s0 mod 64) floordiv 16) * 4)>
#map4 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 8 + (((s1 * 226800 + s2 * 5040 - ((s1 * 45 + s2) floordiv 8) * 40319) mod 20608) floordiv s3) * 16)>
...
#map11 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 226800 + s1 * 5040 - ((s0 * 45 + s1) floordiv 8) * 40319) floordiv 20608) * 368 + (((s0 * 226800 + s1 * 5040 - ((s0 * 45 + s1) floordiv 8) * 40319) mod 20608) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4)>
#map12 = affine_map<()[s0, s1, s2] -> (((s0 * 226800 + s1 * 5040 - ((s0 * 45 + s1) floordiv 8) * 40319) floordiv 20608) * 368 + (((s0 * 226800 + s1 * 5040 - ((s0 * 45 + s1) floordiv 8) * 40319) mod 20608) mod s2) * 16)>
#map13 = affine_map<()[s0, s1, s2] -> ((((s0 * 226800 + s1 * 5040 - ((s0 * 45 + s1) floordiv 8) * 40319) mod 20608) floordiv s2) * 16)>
#map14 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4)>
#map15 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 226800 + s1 * 5040 - ((s0 * 45 + s1) floordiv 8) * 40319) floordiv 20608) * 368 + (((s0 * 226800 + s1 * 5040 - ((s0 * 45 + s1) floordiv 8) * 40319) mod 20608) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4 + 1)>
#map16 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map17 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 226800 + s1 * 5040 - ((s0 * 45 + s1) floordiv 8) * 40319) floordiv 20608) * 368 + (((s0 * 226800 + s1 * 5040 - ((s0 * 45 + s1) floordiv 8) * 40319) mod 20608) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4 + 2)>
#map18 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map19 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 226800 + s1 * 5040 - ((s0 * 45 + s1) floordiv 8) * 40319) floordiv 20608) * 368 + (((s0 * 226800 + s1 * 5040 - ((s0 * 45 + s1) floordiv 8) * 40319) mod 20608) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4 + 3)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %49 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<706x14336xf32, strided<[14336, 1], offset: ?>>
        ...
        %base_buffer_9, %offset_10, %sizes_11:2, %strides_12:2 = memref.extract_strided_metadata %49 : memref<706x14336xf32, strided<[14336, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %60 = arith.addi %58, %offset_10 overflow<nsw> : index
        %reinterpret_cast_13 = memref.reinterpret_cast %49 to offset: [%60], sizes: [%c536870910], strides: [1] : memref<706x14336xf32, strided<[14336, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
