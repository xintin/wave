...
#map53 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 8 + (((s1 * 512 + s2 * 8 - (s1 floordiv 8) * 4095) mod 4032) floordiv s3) * 16)>
#map54 = affine_map<()[s0, s1] -> (s0 * 16 + s1 * 8 + 8)>
#map55 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4)>
#map56 = affine_map<()[s0, s1] -> (s0 * 16 + (s1 floordiv 64) * 4 + 4)>
#map57 = affine_map<()[s0, s1, s2] -> (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16)>
#map58 = affine_map<()[s0, s1, s2] -> ((((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) floordiv s2) * 16)>
#map59 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4)>
#map60 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4 + 1)>
#map61 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map62 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4 + 2)>
#map63 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map64 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4 + 3)>
