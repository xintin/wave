...
#map21 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 47)>
#map22 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 47 + 16)>
#map23 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 47 + 32)>
...
#map28 = affine_map<()[s0, s1] -> (s0 * 188 + (s1 floordiv 64) * 47 + 47)>
#map29 = affine_map<()[s0] -> (s0 * 188 + 188)>
#map30 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) floordiv 48) * 564 + (((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) mod 48) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4)>
#map31 = affine_map<()[s0, s1, s2] -> (((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) floordiv 48) * 564 + (((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) mod 48) mod s2) * 188)>
#map32 = affine_map<()[s0, s1, s2] -> ((((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) mod 48) floordiv s2) * 272)>
#map33 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4)>
#map34 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) floordiv 48) * 564 + (((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) mod 48) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 1)>
#map35 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map36 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) floordiv 48) * 564 + (((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) mod 48) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 2)>
#map37 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map38 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) floordiv 48) * 564 + (((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) mod 48) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 3)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 3)>
...
#map48 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) floordiv 48) * 564 + (((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) mod 48) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 16)>
#map49 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 16)>
#map50 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) floordiv 48) * 564 + (((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) mod 48) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 17)>
#map51 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 17)>
#map52 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) floordiv 48) * 564 + (((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) mod 48) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 18)>
#map53 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 18)>
#map54 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) floordiv 48) * 564 + (((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) mod 48) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 19)>
#map55 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 19)>
#map56 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) floordiv 48) * 564 + (((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) mod 48) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 32)>
#map57 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 32)>
#map58 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) floordiv 48) * 564 + (((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) mod 48) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 33)>
#map59 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 33)>
#map60 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) floordiv 48) * 564 + (((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) mod 48) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 34)>
#map61 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 34)>
#map62 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) floordiv 48) * 564 + (((s0 * 8 + s1 * 32 - ((s0 + s1 * 4) floordiv 8) * 63) mod 48) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 35)>
#map63 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 35)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %95:27 = scf.for %arg3 = %c0 to %c895 step %c1 iter_args(%arg4 = %cst_4, %arg5 = %cst_4, %arg6 = %cst_4, %arg7 = %cst_4, %arg8 = %cst_4, %arg9 = %cst_4, %arg10 = %cst_4, %arg11 = %cst_4, %arg12 = %cst_4, %arg13 = %cst_4, %arg14 = %cst_4, %arg15 = %cst_4, %arg16 = %cst_4, %arg17 = %cst_4, %arg18 = %cst_4, %arg19 = %cst_4, %arg20 = %cst_4, %arg21 = %cst_4, %arg22 = %cst_4, %arg23 = %cst_4, %arg24 = %cst_4, %arg25 = %cst_4, %arg26 = %cst_4, %arg27 = %cst_4, %arg28 = %cst_4, %arg29 = %cst_4, %arg30 = %cst_4) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          amdgpu.lds_barrier
          ...
          %692 = vector.maskedload %view_5[%86, %61], %88, %cst : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %693 = vector.maskedload %view_5[%89, %61], %91, %cst : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %694 = vector.maskedload %view_5[%92, %61], %94, %cst : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          ...
          amdgpu.lds_barrier
          vector.maskedstore %view_5[%47, %7], %49, %703 : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<6xi1>, vector<6xf16>
        ...
        %136 = vector.maskedload %view_5[%133, %99], %135, %cst : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %137 = affine.apply #map22()[%thread_id_x]
        %138 = arith.cmpi slt, %137, %46 : index
        %139 = vector.broadcast %138 : i1 to vector<4xi1>
        %140 = vector.maskedload %view_5[%137, %99], %139, %cst : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %141 = affine.apply #map23()[%thread_id_x]
        %142 = arith.cmpi slt, %141, %46 : index
        %143 = vector.broadcast %142 : i1 to vector<4xi1>
        %144 = vector.maskedload %view_5[%141, %99], %143, %cst : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        ...
        %181 = arith.minsi %180, %c706 : index
        ...
        %base_buffer_11, %offset_12, %sizes_13:2, %strides_14:2 = memref.extract_strided_metadata %173 : memref<706x4096xf32, strided<[4096, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %192 = arith.addi %190, %offset_12 overflow<nsw> : index
        %reinterpret_cast_15 = memref.reinterpret_cast %173 to offset: [%192], sizes: [%c536870910], strides: [1] : memref<706x4096xf32, strided<[4096, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
