...
#map3 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 8 + (((s1 * 432 + s2 * 1728 - ((s1 + s2 * 4) floordiv 8) * 3455) mod 2592) floordiv s3) * 16)>
...
#map10 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 47)>
#map11 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 47 + 16)>
#map12 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 47 + 32)>
...
#map17 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 2592) * 564 + (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) mod 2592) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4)>
...
#map20 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4)>
#map21 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 2592) * 564 + (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) mod 2592) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 1)>
#map22 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map23 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 2592) * 564 + (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) mod 2592) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 2)>
#map24 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map25 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 2592) * 564 + (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) mod 2592) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 3)>
#map26 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map27 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 2592) * 564 + (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) mod 2592) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 16)>
#map28 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 16)>
#map29 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 2592) * 564 + (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) mod 2592) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 17)>
#map30 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 17)>
#map31 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 2592) * 564 + (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) mod 2592) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 18)>
#map32 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 18)>
#map33 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 2592) * 564 + (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) mod 2592) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 19)>
#map34 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 19)>
#map35 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 2592) * 564 + (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) mod 2592) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 32)>
#map36 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 32)>
#map37 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 2592) * 564 + (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) mod 2592) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 33)>
#map38 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 33)>
#map39 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 2592) * 564 + (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) mod 2592) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 34)>
#map40 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 34)>
#map41 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 47 + ((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 2592) * 564 + (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) mod 2592) mod s2) * 188 + ((s3 mod 64) floordiv 16) * 4 + 35)>
#map42 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 35)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %26 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_10 validBytes(%c2147483645_i32) cacheSwizzleStride(%c5120_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %35 = arith.minsi %34, %c188 : index
        %36 = affine.apply #map7()[%thread_id_x, %thread_id_y]
        %37 = arith.cmpi slt, %36, %35 : index
        %38 = vector.broadcast %37 : i1 to vector<6xi1>
        vector.maskedstore %view_5[%36, %7], %38, %17 : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<6xi1>, vector<6xf16>
        ...
        %52:3 = scf.for %arg3 = %c0 to %c319 step %c1 iter_args(%arg4 = %cst_4, %arg5 = %cst_4, %arg6 = %cst_4) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          amdgpu.lds_barrier
          ...
          %177 = vector.maskedload %view_5[%43, %23], %45, %cst : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %178 = vector.maskedload %view_5[%46, %23], %48, %cst : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %179 = vector.maskedload %view_5[%49, %23], %51, %cst : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          ...
          amdgpu.lds_barrier
          vector.maskedstore %view_5[%36, %7], %38, %188 : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<6xi1>, vector<6xf16>
        ...
        %57 = vector.maskedload %view_5[%54, %23], %56, %cst : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %58 = affine.apply #map11()[%thread_id_x]
        %59 = arith.cmpi slt, %58, %35 : index
        %60 = vector.broadcast %59 : i1 to vector<4xi1>
        %61 = vector.maskedload %view_5[%58, %23], %60, %cst : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %62 = affine.apply #map12()[%thread_id_x]
        %63 = arith.cmpi slt, %62, %35 : index
        %64 = vector.broadcast %63 : i1 to vector<4xi1>
        %65 = vector.maskedload %view_5[%62, %23], %64, %cst : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
