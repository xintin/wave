...
#map1 = affine_map<()[s0, s1, s2] -> (s0 mod 16 + ((s1 * 226800 + s2 * 5040 - ((s1 * 45 + s2) floordiv 8) * 40319) floordiv 896) * 16 + (s0 floordiv 64) * 4)>
#map2 = affine_map<()[s0] -> (((s0 mod 64) floordiv 16) * 4)>
#map3 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 3628800 + s2 * 80640 + s3 * 8 - (s0 floordiv 16) * 16 - ((s1 * 45 + s2) floordiv 8) * 645104 - ((s1 * 226800 + s2 * 5040 - ((s1 * 45 + s2) floordiv 8) * 40319) floordiv 896) * 14336)>
...
#map10 = affine_map<()[s0, s1, s2] -> (((s0 * 226800 + s1 * 5040 - ((s0 * 45 + s1) floordiv 8) * 40319) floordiv 896) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4)>
#map11 = affine_map<()[s0, s1] -> (((s0 * 226800 + s1 * 5040 - ((s0 * 45 + s1) floordiv 8) * 40319) floordiv 896) * 16)>
#map12 = affine_map<()[s0, s1] -> (s0 * 3628800 + s1 * 80640 - ((s0 * 45 + s1) floordiv 8) * 645104 - ((s0 * 226800 + s1 * 5040 - ((s0 * 45 + s1) floordiv 8) * 40319) floordiv 896) * 14336)>
#map13 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4)>
#map14 = affine_map<()[s0, s1, s2] -> (((s0 * 226800 + s1 * 5040 - ((s0 * 45 + s1) floordiv 8) * 40319) floordiv 896) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4 + 1)>
#map15 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map16 = affine_map<()[s0, s1, s2] -> (((s0 * 226800 + s1 * 5040 - ((s0 * 45 + s1) floordiv 8) * 40319) floordiv 896) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4 + 2)>
#map17 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map18 = affine_map<()[s0, s1, s2] -> (((s0 * 226800 + s1 * 5040 - ((s0 * 45 + s1) floordiv 8) * 40319) floordiv 896) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4 + 3)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %46 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<706x14336xf32, strided<[14336, 1], offset: ?>>
        ...
        %53 = arith.muli %50, %c14336 overflow<nsw> : index
        %54 = arith.muli %52, %c14336 overflow<nsw> : index
        %55 = arith.addi %53, %51 overflow<nsw> : index
        %56 = arith.addi %54, %37 overflow<nsw> : index
        %base_buffer_9, %offset_10, %sizes_11:2, %strides_12:2 = memref.extract_strided_metadata %46 : memref<706x14336xf32, strided<[14336, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %57 = arith.addi %55, %offset_10 overflow<nsw> : index
        %reinterpret_cast_13 = memref.reinterpret_cast %46 to offset: [%57], sizes: [%c536870910], strides: [1] : memref<706x14336xf32, strided<[14336, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        ...
        %65 = arith.muli %64, %c14336 overflow<nsw> : index
