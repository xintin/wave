#map = affine_map<()[s0, s1] -> (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * -44 + 45)>
#map1 = affine_map<()[s0, s1, s2, s3] -> ((s0 floordiv 16) mod 16 + ((s1 * 218700 + s2 * 4860 - ((s1 * 45 + s2) floordiv 8) * 38879) floordiv 38016) * 704 + (((s1 * 218700 + s2 * 4860 - ((s1 * 45 + s2) floordiv 8) * 38879) mod 38016) mod s3) * 16)>
#map2 = affine_map<()[s0] -> (s0 mod 16)>
#map3 = affine_map<()[s0, s1, s2, s3] -> ((s0 floordiv 16) mod 16 + (((s1 * 218700 + s2 * 4860 - ((s1 * 45 + s2) floordiv 8) * 38879) mod 38016) floordiv s3) * 16)>
...
#map14 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 32 + s4 * 8 + (((s1 * 218700 + s2 * 4860 - ((s1 * 45 + s2) floordiv 8) * 38879) mod 38016) floordiv s3) * 16)>
#map15 = affine_map<()[s0, s1] -> (s0 * 16 + (s1 floordiv 64) * 4 + 4)>
#map16 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4)>
#map17 = affine_map<()[s0, s1, s2] -> (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16)>
#map18 = affine_map<()[s0, s1, s2] -> ((((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) floordiv s2) * 16)>
#map19 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4)>
#map20 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 1)>
#map21 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map22 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 2)>
#map23 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map24 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 3)>
#map25 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map26 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 8)>
#map27 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map28 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 9)>
#map29 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map30 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 10)>
#map31 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map32 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 11)>
#map33 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map34 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 16)>
#map35 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map36 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 17)>
#map37 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map38 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 18)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map40 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 19)>
#map41 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map42 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 24)>
#map43 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map44 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 25)>
#map45 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map46 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 26)>
#map47 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map48 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 27)>
