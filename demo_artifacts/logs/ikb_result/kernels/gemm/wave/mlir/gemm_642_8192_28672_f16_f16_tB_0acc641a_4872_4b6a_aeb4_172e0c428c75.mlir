...
#map3 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 8 + (((s1 * 576 + s2 * 192 - ((s1 * 3 + s2) floordiv 8) * 1535) mod 1536) floordiv s3) * 16)>
...
#map18 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 16) * 4)>
#map19 = affine_map<()[s0, s1, s2] -> (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248)>
#map20 = affine_map<()[s0, s1, s2] -> ((((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) floordiv s2) * 16)>
#map21 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4)>
#map22 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 16) * 4 + 1)>
#map23 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map24 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 16) * 4 + 2)>
#map25 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map26 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 16) * 4 + 3)>
#map27 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map28 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 16) * 4 + 16)>
#map29 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 16)>
#map30 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 16) * 4 + 17)>
#map31 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 17)>
#map32 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 16) * 4 + 18)>
#map33 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 18)>
#map34 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 16) * 4 + 19)>
#map35 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 19)>
#map36 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 16) * 4 + 32)>
#map37 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 32)>
#map38 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 16) * 4 + 33)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 33)>
#map40 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 16) * 4 + 34)>
#map41 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 34)>
#map42 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 16) * 4 + 35)>
#map43 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 35)>
#map44 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 16) * 4 + 48)>
#map45 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 48)>
#map46 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 16) * 4 + 49)>
#map47 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 49)>
#map48 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 16) * 4 + 50)>
#map49 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 50)>
#map50 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 16) * 4 + 51)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %23 = arith.muli %18, %c28672 overflow<nsw> : index
        %24 = arith.addi %23, %22 overflow<nsw> : index
        %base_buffer_6, %offset_7, %sizes_8:2, %strides_9:2 = memref.extract_strided_metadata %17 : memref<8192x28672xf16, strided<[28672, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_10 = memref.reinterpret_cast %17 to offset: [%offset_7], sizes: [%c1073741822], strides: [1] : memref<8192x28672xf16, strided<[28672, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %54:4 = scf.for %arg3 = %c0 to %c1791 step %c1 iter_args(%arg4 = %cst_4, %arg5 = %cst_4, %arg6 = %cst_4, %arg7 = %cst_4) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          amdgpu.lds_barrier
        ...
        %77 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<642x8192xf32, strided<[8192, 1], offset: ?>>
        ...
        %88 = arith.muli %85, %c8192 overflow<nsw> : index
        %89 = arith.muli %87, %c8192 overflow<nsw> : index
        %90 = arith.addi %88, %86 overflow<nsw> : index
        %91 = arith.addi %89, %38 overflow<nsw> : index
        %base_buffer_11, %offset_12, %sizes_13:2, %strides_14:2 = memref.extract_strided_metadata %77 : memref<642x8192xf32, strided<[8192, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %92 = arith.addi %90, %offset_12 overflow<nsw> : index
        %reinterpret_cast_15 = memref.reinterpret_cast %77 to offset: [%92], sizes: [%c536870910], strides: [1] : memref<642x8192xf32, strided<[8192, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %93 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_15 validBytes(%c2147483643_i32) cacheSwizzleStride(%c-8192_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
