...
#map1 = affine_map<()[s0, s1, s2] -> (s0 mod 16 + (s0 floordiv 64) * 4 + ((s1 * 8 - (s1 floordiv 8) * 63) floordiv 32) * 512 + (((s1 * 8 - (s1 floordiv 8) * 63) mod 32) mod s2) * 16)>
#map2 = affine_map<()[s0, s1] -> (s0 * 16 + (s1 floordiv 64) * 4 + 4)>
#map3 = affine_map<()[s0] -> (((s0 mod 64) floordiv 16) * 4)>
#map4 = affine_map<()[s0, s1, s2, s3] -> (s0 floordiv 2 + s1 * 128 - ((s1 * 128 + s0 floordiv 2) floordiv 1024) * 1024 + (((s2 * 8 - (s2 floordiv 8) * 63) mod 32) floordiv s3) * 1024)>
#map5 = affine_map<()[s0] -> (s0 * 8 - (s0 floordiv 2) * 16)>
#map6 = affine_map<()[s0, s1, s2, s3] -> (s0 floordiv 2 + s1 * 128 - ((s1 * 128 + s0 floordiv 2 + 256) floordiv 1024) * 1024 + (((s2 * 8 - (s2 floordiv 8) * 63) mod 32) floordiv s3) * 1024 + 256)>
#map7 = affine_map<()[s0, s1, s2, s3] -> (s0 floordiv 2 + s1 * 128 - ((s1 * 128 + s0 floordiv 2 + 512) floordiv 1024) * 1024 + (((s2 * 8 - (s2 floordiv 8) * 63) mod 32) floordiv s3) * 1024 + 512)>
#map8 = affine_map<()[s0, s1, s2, s3] -> (s0 floordiv 2 + s1 * 128 - ((s1 * 128 + s0 floordiv 2 + 768) floordiv 1024) * 1024 + (((s2 * 8 - (s2 floordiv 8) * 63) mod 32) floordiv s3) * 1024 + 768)>
...
#map49 = affine_map<()[s0, s1, s2] -> ((s2 floordiv 64) * 4 + ((s0 * 8 - (s0 floordiv 8) * 63) floordiv 32) * 512 + (((s0 * 8 - (s0 floordiv 8) * 63) mod 32) mod s1) * 16 + ((s2 mod 64) floordiv 16) * 4)>
#map50 = affine_map<()[s0, s1] -> (((s0 * 8 - (s0 floordiv 8) * 63) floordiv 32) * 512 + (((s0 * 8 - (s0 floordiv 8) * 63) mod 32) mod s1) * 16)>
#map51 = affine_map<()[s0, s1] -> ((((s0 * 8 - (s0 floordiv 8) * 63) mod 32) floordiv s1) * 1024)>
#map52 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4)>
#map53 = affine_map<()[s0, s1, s2] -> ((s2 floordiv 64) * 4 + ((s0 * 8 - (s0 floordiv 8) * 63) floordiv 32) * 512 + (((s0 * 8 - (s0 floordiv 8) * 63) mod 32) mod s1) * 16 + ((s2 mod 64) floordiv 16) * 4 + 1)>
#map54 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map55 = affine_map<()[s0, s1, s2] -> ((s2 floordiv 64) * 4 + ((s0 * 8 - (s0 floordiv 8) * 63) floordiv 32) * 512 + (((s0 * 8 - (s0 floordiv 8) * 63) mod 32) mod s1) * 16 + ((s2 mod 64) floordiv 16) * 4 + 2)>
#map56 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map57 = affine_map<()[s0, s1, s2] -> ((s2 floordiv 64) * 4 + ((s0 * 8 - (s0 floordiv 8) * 63) floordiv 32) * 512 + (((s0 * 8 - (s0 floordiv 8) * 63) mod 32) mod s1) * 16 + ((s2 mod 64) floordiv 16) * 4 + 3)>
