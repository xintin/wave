...
#map16 = affine_map<()[s0, s1, s2] -> (((s0 * 128 + s1 * 512 - ((s0 + s1 * 4) floordiv 8) * 1023) floordiv 256) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4)>
...
#map20 = affine_map<()[s0, s1, s2] -> (((s0 * 128 + s1 * 512 - ((s0 + s1 * 4) floordiv 8) * 1023) floordiv 256) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 1)>
#map21 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map22 = affine_map<()[s0, s1, s2] -> (((s0 * 128 + s1 * 512 - ((s0 + s1 * 4) floordiv 8) * 1023) floordiv 256) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 2)>
#map23 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map24 = affine_map<()[s0, s1, s2] -> (((s0 * 128 + s1 * 512 - ((s0 + s1 * 4) floordiv 8) * 1023) floordiv 256) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 3)>
#map25 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map26 = affine_map<()[s0, s1, s2] -> (((s0 * 128 + s1 * 512 - ((s0 + s1 * 4) floordiv 8) * 1023) floordiv 256) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 16)>
#map27 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 16)>
#map28 = affine_map<()[s0, s1, s2] -> (((s0 * 128 + s1 * 512 - ((s0 + s1 * 4) floordiv 8) * 1023) floordiv 256) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 17)>
#map29 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 17)>
#map30 = affine_map<()[s0, s1, s2] -> (((s0 * 128 + s1 * 512 - ((s0 + s1 * 4) floordiv 8) * 1023) floordiv 256) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 18)>
#map31 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 18)>
#map32 = affine_map<()[s0, s1, s2] -> (((s0 * 128 + s1 * 512 - ((s0 + s1 * 4) floordiv 8) * 1023) floordiv 256) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 19)>
#map33 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 19)>
#map34 = affine_map<()[s0, s1, s2] -> (((s0 * 128 + s1 * 512 - ((s0 + s1 * 4) floordiv 8) * 1023) floordiv 256) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 32)>
#map35 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 32)>
#map36 = affine_map<()[s0, s1, s2] -> (((s0 * 128 + s1 * 512 - ((s0 + s1 * 4) floordiv 8) * 1023) floordiv 256) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 33)>
#map37 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 33)>
#map38 = affine_map<()[s0, s1, s2] -> (((s0 * 128 + s1 * 512 - ((s0 + s1 * 4) floordiv 8) * 1023) floordiv 256) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 34)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 34)>
#map40 = affine_map<()[s0, s1, s2] -> (((s0 * 128 + s1 * 512 - ((s0 + s1 * 4) floordiv 8) * 1023) floordiv 256) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 35)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %49:3 = scf.for %arg3 = %c0 to %c895 step %c1 iter_args(%arg4 = %cst_4, %arg5 = %cst_4, %arg6 = %cst_4) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          amdgpu.lds_barrier
        ...
        %67 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<706x4096xf32, strided<[4096, 1], offset: ?>>
        ...
        %base_buffer_11, %offset_12, %sizes_13:2, %strides_14:2 = memref.extract_strided_metadata %67 : memref<706x4096xf32, strided<[4096, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %82 = arith.addi %80, %offset_12 overflow<nsw> : index
        %reinterpret_cast_15 = memref.reinterpret_cast %67 to offset: [%82], sizes: [%c536870910], strides: [1] : memref<706x4096xf32, strided<[4096, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
