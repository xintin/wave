#map = affine_map<()[s0, s1] -> (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 11264) * -44 + 45)>
#map1 = affine_map<()[s0, s1, s2, s3] -> ((s0 floordiv 16) mod 16 + ((s1 * 64800 + s2 * 1440 - ((s1 * 45 + s2) floordiv 8) * 11519) floordiv 11264) * 704 + (((s1 * 64800 + s2 * 1440 - ((s1 * 45 + s2) floordiv 8) * 11519) mod 11264) mod s3) * 16)>
#map2 = affine_map<()[s0] -> (s0 mod 16)>
#map3 = affine_map<()[s0, s1, s2, s3] -> ((s0 floordiv 16) mod 16 + (((s1 * 64800 + s2 * 1440 - ((s1 * 45 + s2) floordiv 8) * 11519) mod 11264) floordiv s3) * 16)>
...
#map14 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 32 + s4 * 8 + (((s1 * 64800 + s2 * 1440 - ((s1 * 45 + s2) floordiv 8) * 11519) mod 11264) floordiv s3) * 16)>
#map15 = affine_map<()[s0, s1] -> (s0 * 16 + (s1 floordiv 64) * 4 + 4)>
#map16 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 11264) * 704 + (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) mod 11264) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4)>
#map17 = affine_map<()[s0, s1, s2] -> (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 11264) * 704 + (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) mod 11264) mod s2) * 16)>
#map18 = affine_map<()[s0, s1, s2] -> ((((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) mod 11264) floordiv s2) * 16)>
#map19 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4)>
#map20 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 11264) * 704 + (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) mod 11264) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 1)>
#map21 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map22 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 11264) * 704 + (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) mod 11264) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 2)>
#map23 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map24 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 11264) * 704 + (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) mod 11264) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 3)>
#map25 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map26 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 11264) * 704 + (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) mod 11264) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 8)>
#map27 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map28 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 11264) * 704 + (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) mod 11264) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 9)>
#map29 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map30 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 11264) * 704 + (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) mod 11264) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 10)>
#map31 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map32 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 11264) * 704 + (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) mod 11264) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 11)>
#map33 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map34 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 11264) * 704 + (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) mod 11264) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 16)>
#map35 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map36 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 11264) * 704 + (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) mod 11264) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 17)>
#map37 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map38 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 11264) * 704 + (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) mod 11264) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 18)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map40 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 11264) * 704 + (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) mod 11264) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 19)>
#map41 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map42 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 11264) * 704 + (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) mod 11264) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 24)>
#map43 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map44 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 11264) * 704 + (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) mod 11264) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 25)>
#map45 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map46 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 11264) * 704 + (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) mod 11264) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 26)>
#map47 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map48 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 11264) * 704 + (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) mod 11264) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 27)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %7 = arith.muli %4, %c14336 overflow<nsw> : index
        ...
        %12 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<4096x14336xf16, strided<[14336, 1], offset: ?>>
        %13 = affine.apply #map3()[%thread_id_x, %block_id_y, %block_id_x, %3]
        %14 = arith.muli %13, %c14336 overflow<nsw> : index
        %15 = arith.addi %14, %6 overflow<nsw> : index
        %base_buffer_2, %offset_3, %sizes_4:2, %strides_5:2 = memref.extract_strided_metadata %12 : memref<4096x14336xf16, strided<[14336, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_6 = memref.reinterpret_cast %12 to offset: [%offset_3], sizes: [%c1073741822], strides: [1] : memref<4096x14336xf16, strided<[14336, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %35 = scf.for %arg3 = %c0 to %c895 step %c1 iter_args(%arg4 = %cst_0) -> (vector<16xf32>) {
          amdgpu.lds_barrier
        ...
        %51 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<706x4096xf32, strided<[4096, 1], offset: ?>>
        ...
        %68 = arith.muli %66, %c4096 overflow<nsw> : index
        %69 = arith.addi %67, %65 overflow<nsw> : index
        %70 = arith.addi %68, %36 overflow<nsw> : index
        %base_buffer_7, %offset_8, %sizes_9:2, %strides_10:2 = memref.extract_strided_metadata %51 : memref<706x4096xf32, strided<[4096, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %71 = arith.addi %69, %offset_8 overflow<nsw> : index
        %reinterpret_cast_11 = memref.reinterpret_cast %51 to offset: [%71], sizes: [%c536870910], strides: [1] : memref<706x4096xf32, strided<[4096, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %72 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_11 validBytes(%c2147483643_i32) cacheSwizzleStride(%c4096_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %87 = arith.muli %86, %c4096 overflow<nsw> : index
