...
module attributes {transform.with_named_sequence} {
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %14 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<3072x4096xf16, strided<[4096, 1], offset: ?>>
        ...
        %base_buffer_1, %offset_2, %sizes_3:2, %strides_4:2 = memref.extract_strided_metadata %14 : memref<3072x4096xf16, strided<[4096, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_5 = memref.reinterpret_cast %14 to offset: [%offset_2], sizes: [%c1073741822], strides: [1] : memref<3072x4096xf16, strided<[4096, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
  ...
  func.func @isolated_benchmark(%arg0: tensor<8192x4096xf16>, %arg1: tensor<3072x4096xf16>, %arg2: tensor<8192x3072xf32>) -> tensor<8192x3072xf32> {
    %0 = flow.dispatch @gemm::@gemm(%arg0, %arg1, %arg2) : (tensor<8192x4096xf16>, tensor<3072x4096xf16>, tensor<8192x3072xf32>) -> %arg2
