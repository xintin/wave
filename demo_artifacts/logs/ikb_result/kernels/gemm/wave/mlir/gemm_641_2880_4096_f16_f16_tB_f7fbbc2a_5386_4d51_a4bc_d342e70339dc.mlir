...
#map3 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 720 + s2 * 1440 + s3 * 8 - (s0 floordiv 16) * 16 - ((s1 + s2 * 2) floordiv 8) * 5744 - ((s1 * 45 + s2 * 90 - ((s1 + s2 * 2) floordiv 8) * 359) floordiv 180) * 2880)>
...
#map21 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4)>
#map22 = affine_map<()[s0, s1] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328)>
#map23 = affine_map<()[s0, s1] -> (s0 * 720 + s1 * 1440 - ((s0 + s1 * 2) floordiv 8) * 5744 - ((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 2880)>
#map24 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4)>
#map25 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 1)>
#map26 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map27 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 2)>
#map28 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map29 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 3)>
#map30 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map31 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 16)>
#map32 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 16)>
#map33 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 17)>
#map34 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 17)>
#map35 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 18)>
#map36 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 18)>
#map37 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 19)>
#map38 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 19)>
#map39 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 32)>
#map40 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 32)>
#map41 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 33)>
#map42 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 33)>
#map43 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 34)>
#map44 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 34)>
#map45 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 35)>
#map46 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 35)>
#map47 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 48)>
#map48 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 48)>
#map49 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 49)>
#map50 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 49)>
#map51 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 50)>
#map52 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 50)>
#map53 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 51)>
#map54 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 51)>
#map55 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 64)>
#map56 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 64)>
#map57 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 65)>
#map58 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 65)>
#map59 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 66)>
#map60 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 66)>
#map61 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 67)>
#map62 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 67)>
#map63 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 80)>
#map64 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 80)>
#map65 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 81)>
#map66 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 81)>
#map67 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 82)>
#map68 = affine_map<()[s0] -> ((s0 floordiv 64) * 82 + ((s0 mod 64) floordiv 16) * 4 + 82)>
#map69 = affine_map<()[s0, s1, s2] -> (((s0 * 45 + s1 * 90 - ((s0 + s1 * 2) floordiv 8) * 359) floordiv 180) * 328 + (s2 floordiv 64) * 82 + ((s2 mod 64) floordiv 16) * 4 + 83)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %base_buffer_6, %offset_7, %sizes_8:2, %strides_9:2 = memref.extract_strided_metadata %27 : memref<2880x4096xf16, strided<[4096, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_10 = memref.reinterpret_cast %27 to offset: [%offset_7], sizes: [%c1073741822], strides: [1] : memref<2880x4096xf16, strided<[4096, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %106 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<641x2880xf32, strided<[2880, 1], offset: ?>>
        ...
        %117 = arith.muli %114, %c2880 overflow<nsw> : index
        %118 = arith.muli %116, %c2880 overflow<nsw> : index
        %119 = arith.addi %117, %115 overflow<nsw> : index
        %120 = arith.addi %118, %51 overflow<nsw> : index
        %base_buffer_11, %offset_12, %sizes_13:2, %strides_14:2 = memref.extract_strided_metadata %106 : memref<641x2880xf32, strided<[2880, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %121 = arith.addi %119, %offset_12 overflow<nsw> : index
        %reinterpret_cast_15 = memref.reinterpret_cast %106 to offset: [%121], sizes: [%c536870910], strides: [1] : memref<641x2880xf32, strided<[2880, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %122 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_15 validBytes(%c2147483643_i32) cacheSwizzleStride(%c2880_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %201 = arith.muli %200, %c2880 overflow<nsw> : index
        ...
        %209 = arith.muli %208, %c2880 overflow<nsw> : index
        ...
        %217 = arith.muli %216, %c2880 overflow<nsw> : index
        ...
        %225 = arith.muli %224, %c2880 overflow<nsw> : index
        ...
        %233 = arith.muli %232, %c2880 overflow<nsw> : index
        ...
        %241 = arith.muli %240, %c2880 overflow<nsw> : index
        ...
        %249 = arith.muli %248, %c2880 overflow<nsw> : index
        ...
        %257 = arith.muli %256, %c2880 overflow<nsw> : index
