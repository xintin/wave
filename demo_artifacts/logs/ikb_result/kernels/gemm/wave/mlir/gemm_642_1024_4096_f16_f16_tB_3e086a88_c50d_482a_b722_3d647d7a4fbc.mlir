#map = affine_map<()[s0, s1] -> (((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) floordiv 1344) * -21 + 41)>
#map1 = affine_map<()[s0, s1] -> (s0 * 16 + (s1 floordiv 64) * 4 + 4)>
#map2 = affine_map<()[s0] -> (s0 * 16 + 16)>
#map3 = affine_map<()[s0, s1, s2, s3] -> (s0 mod 32 + (s0 floordiv 64) * 4 + ((s1 * 13448 + s2 * 328 - ((s1 * 41 + s2) floordiv 8) * 2623) floordiv 1344) * 336 + (((s1 * 13448 + s2 * 328 - ((s1 * 41 + s2) floordiv 8) * 2623) mod 1344) mod s3) * 16)>
#map4 = affine_map<()[s0] -> (((s0 mod 64) floordiv 32) * 8)>
#map5 = affine_map<()[s0, s1] -> (s0 * 16 + s1 * 8 + 8)>
#map6 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 32 + s4 * 8 + (((s1 * 13448 + s2 * 328 - ((s1 * 41 + s2) floordiv 8) * 2623) mod 1344) floordiv s3) * 16)>
...
#map12 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) floordiv 1344) * 336 + (((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) mod 1344) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4)>
#map13 = affine_map<()[s0, s1, s2] -> (((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) floordiv 1344) * 336 + (((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) mod 1344) mod s2) * 16)>
#map14 = affine_map<()[s0, s1, s2] -> ((((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) mod 1344) floordiv s2) * 16)>
#map15 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4)>
#map16 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) floordiv 1344) * 336 + (((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) mod 1344) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 1)>
#map17 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map18 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) floordiv 1344) * 336 + (((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) mod 1344) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 2)>
#map19 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map20 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) floordiv 1344) * 336 + (((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) mod 1344) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 3)>
#map21 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map22 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) floordiv 1344) * 336 + (((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) mod 1344) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 8)>
#map23 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map24 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) floordiv 1344) * 336 + (((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) mod 1344) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 9)>
#map25 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map26 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) floordiv 1344) * 336 + (((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) mod 1344) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 10)>
#map27 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map28 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) floordiv 1344) * 336 + (((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) mod 1344) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 11)>
#map29 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map30 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) floordiv 1344) * 336 + (((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) mod 1344) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 16)>
#map31 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map32 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) floordiv 1344) * 336 + (((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) mod 1344) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 17)>
#map33 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map34 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) floordiv 1344) * 336 + (((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) mod 1344) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 18)>
#map35 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map36 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) floordiv 1344) * 336 + (((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) mod 1344) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 19)>
#map37 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map38 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) floordiv 1344) * 336 + (((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) mod 1344) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 24)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map40 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) floordiv 1344) * 336 + (((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) mod 1344) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 25)>
#map41 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map42 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) floordiv 1344) * 336 + (((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) mod 1344) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 26)>
#map43 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map44 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) floordiv 1344) * 336 + (((s0 * 13448 + s1 * 328 - ((s0 * 41 + s1) floordiv 8) * 2623) mod 1344) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 27)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %59 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<642x1024xf32, strided<[1024, 1], offset: ?>>
        ...
        %base_buffer_9, %offset_10, %sizes_11:2, %strides_12:2 = memref.extract_strided_metadata %59 : memref<642x1024xf32, strided<[1024, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %70 = arith.addi %68, %offset_10 overflow<nsw> : index
        %reinterpret_cast_13 = memref.reinterpret_cast %59 to offset: [%70], sizes: [%c536870910], strides: [1] : memref<642x1024xf32, strided<[1024, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
