...
#map3 = affine_map<()[s0, s1, s2, s3] -> (s0 mod 32 + (s0 floordiv 64) * 4 + ((s1 * 512 + s2 * 8 - (s1 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s1 * 512 + s2 * 8 - (s1 floordiv 8) * 4095) mod 4032) mod s3) * 16)>
#map4 = affine_map<()[s0] -> (((s0 mod 64) floordiv 32) * 8)>
#map5 = affine_map<()[s0, s1] -> (s0 * 16 + s1 * 8 + 8)>
#map6 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 32 + s4 * 8 + (((s1 * 512 + s2 * 8 - (s1 floordiv 8) * 4095) mod 4032) floordiv s3) * 16)>
...
#map12 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4)>
#map13 = affine_map<()[s0, s1, s2] -> (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16)>
#map14 = affine_map<()[s0, s1, s2] -> ((((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) floordiv s2) * 16)>
#map15 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4)>
#map16 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 1)>
#map17 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map18 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 2)>
#map19 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map20 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 3)>
#map21 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map22 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 8)>
#map23 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map24 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 9)>
#map25 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map26 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 10)>
#map27 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map28 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 11)>
#map29 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map30 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 16)>
#map31 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map32 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 17)>
#map33 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map34 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 18)>
#map35 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map36 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 19)>
#map37 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map38 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 24)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map40 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 25)>
#map41 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map42 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 26)>
#map43 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map44 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 27)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %25 = affine.apply #map6()[%thread_id_x, %block_id_x, %block_id_y, %3, %thread_id_y]
        ...
        %30 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_8 validBytes(%c2147483645_i32) cacheSwizzleStride(%c1024_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %48 = scf.for %arg3 = %c0 to %c63 step %c1 iter_args(%arg4 = %cst_2) -> (vector<16xf32>) {
          amdgpu.lds_barrier
        ...
        %58 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<1024x1024xf32, strided<[1024, 1], offset: ?>>
        %59 = affine.apply #map12()[%block_id_x, %block_id_y, %3, %thread_id_x]
        %60 = arith.cmpi slt, %59, %6 : index
        %61 = arith.andi %26, %60 : i1
        %62 = affine.apply #map13()[%block_id_x, %block_id_y, %3]
        %63 = affine.apply #map14()[%block_id_x, %block_id_y, %3]
        %64 = affine.apply #map15()[%thread_id_x]
        %65 = arith.muli %62, %c1024 overflow<nsw> : index
        %66 = arith.muli %64, %c1024 overflow<nsw> : index
        %67 = arith.addi %65, %63 overflow<nsw> : index
        %68 = arith.addi %66, %45 overflow<nsw> : index
        %base_buffer_9, %offset_10, %sizes_11:2, %strides_12:2 = memref.extract_strided_metadata %58 : memref<1024x1024xf32, strided<[1024, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %69 = arith.addi %67, %offset_10 overflow<nsw> : index
        %reinterpret_cast_13 = memref.reinterpret_cast %58 to offset: [%69], sizes: [%c536870910], strides: [1] : memref<1024x1024xf32, strided<[1024, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %70 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_13 validBytes(%c2147483643_i32) cacheSwizzleStride(%c1024_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %77 = arith.muli %76, %c1024 overflow<nsw> : index
        ...
        %81 = affine.apply #map18()[%block_id_x, %block_id_y, %3, %thread_id_x]
        %82 = arith.cmpi slt, %81, %6 : index
        %83 = arith.andi %26, %82 : i1
        %84 = affine.apply #map19()[%thread_id_x]
        %85 = arith.muli %84, %c1024 overflow<nsw> : index
        ...
        %89 = affine.apply #map20()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %97 = affine.apply #map22()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %105 = affine.apply #map24()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %113 = affine.apply #map26()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %121 = affine.apply #map28()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %129 = affine.apply #map30()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %137 = affine.apply #map32()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %145 = affine.apply #map34()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %153 = affine.apply #map36()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %161 = affine.apply #map38()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %169 = affine.apply #map40()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %177 = affine.apply #map42()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %185 = affine.apply #map44()[%block_id_x, %block_id_y, %3, %thread_id_x]
