...
#map5 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 2 + s1 * 128 - ((s1 * 128 + s0 floordiv 2) floordiv 520) * 520 + (((s2 * 410 + s3 * 10 + s4 - ((s2 * 41 + s3) floordiv 8) * 79) mod 80) floordiv s5) * 520)>
#map6 = affine_map<()[s0] -> (s0 * 8 - (s0 floordiv 2) * 16)>
#map7 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 2 + s1 * 128 - ((s1 * 128 + s0 floordiv 2 + 256) floordiv 520) * 520 + (((s2 * 410 + s3 * 10 + s4 - ((s2 * 41 + s3) floordiv 8) * 79) mod 80) floordiv s5) * 520 + 256)>
#map8 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 2 + s1 * 128 - ((s1 * 128 + s0 floordiv 2 + 512) floordiv 520) * 520 + (((s2 * 410 + s3 * 10 + s4 - ((s2 * 41 + s3) floordiv 8) * 79) mod 80) floordiv s5) * 520 + 512)>
...
#map36 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 260 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 80) floordiv s4) * 520)>
#map37 = affine_map<()[s0, s1, s2, s3, s4, s5] -> ((s5 floordiv 64) * 4 + ((s0 * 410 + s1 * 10 + s2 - ((s0 * 41 + s1) floordiv 8) * 79) floordiv 80) * 640 + (((s0 * 410 + s1 * 10 + s3 - ((s0 * 41 + s1) floordiv 8) * 79) mod 80) mod s4) * 16 + ((s5 mod 64) floordiv 16) * 4)>
#map38 = affine_map<()[s0, s1, s2, s3, s4] -> (((s0 * 410 + s1 * 10 + s2 - ((s0 * 41 + s1) floordiv 8) * 79) floordiv 80) * 640 + (((s0 * 410 + s1 * 10 + s3 - ((s0 * 41 + s1) floordiv 8) * 79) mod 80) mod s4) * 16)>
#map39 = affine_map<()[s0, s1, s2, s3] -> ((((s0 * 410 + s1 * 10 + s2 - ((s0 * 41 + s1) floordiv 8) * 79) mod 80) floordiv s3) * 520)>
#map40 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4)>
#map41 = affine_map<()[s0, s1, s2, s3, s4, s5] -> ((s5 floordiv 64) * 4 + ((s0 * 410 + s1 * 10 + s2 - ((s0 * 41 + s1) floordiv 8) * 79) floordiv 80) * 640 + (((s0 * 410 + s1 * 10 + s3 - ((s0 * 41 + s1) floordiv 8) * 79) mod 80) mod s4) * 16 + ((s5 mod 64) floordiv 16) * 4 + 1)>
#map42 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map43 = affine_map<()[s0, s1, s2, s3, s4, s5] -> ((s5 floordiv 64) * 4 + ((s0 * 410 + s1 * 10 + s2 - ((s0 * 41 + s1) floordiv 8) * 79) floordiv 80) * 640 + (((s0 * 410 + s1 * 10 + s3 - ((s0 * 41 + s1) floordiv 8) * 79) mod 80) mod s4) * 16 + ((s5 mod 64) floordiv 16) * 4 + 2)>
#map44 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map45 = affine_map<()[s0, s1, s2, s3, s4, s5] -> ((s5 floordiv 64) * 4 + ((s0 * 410 + s1 * 10 + s2 - ((s0 * 41 + s1) floordiv 8) * 79) floordiv 80) * 640 + (((s0 * 410 + s1 * 10 + s3 - ((s0 * 41 + s1) floordiv 8) * 79) mod 80) mod s4) * 16 + ((s5 mod 64) floordiv 16) * 4 + 3)>
#map46 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map47 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 260 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 80) floordiv s4) * 520 + 16)>
#map48 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 260 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 80) floordiv s4) * 520 + 32)>
#map49 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 260 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 80) floordiv s4) * 520 + 48)>
#map50 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 260 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 80) floordiv s4) * 520 + 64)>
#map51 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 260 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 80) floordiv s4) * 520 + 80)>
#map52 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 260 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 80) floordiv s4) * 520 + 96)>
#map53 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 260 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 80) floordiv s4) * 520 + 112)>
#map54 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 260 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 80) floordiv s4) * 520 + 128)>
#map55 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 260 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 80) floordiv s4) * 520 + 144)>
#map56 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 260 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 80) floordiv s4) * 520 + 160)>
#map57 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 260 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 80) floordiv s4) * 520 + 176)>
#map58 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 260 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 80) floordiv s4) * 520 + 192)>
#map59 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 260 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 80) floordiv s4) * 520 + 208)>
#map60 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 260 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 80) floordiv s4) * 520 + 224)>
#map61 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 260 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 80) floordiv s4) * 520 + 240)>
#map62 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 260 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 80) floordiv s4) * 520 + 256)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %27 = arith.muli %23, %c8192 overflow<nsw> : index
        %28 = arith.addi %27, %26 overflow<nsw> : index
        %base_buffer_6, %offset_7, %sizes_8:2, %strides_9:2 = memref.extract_strided_metadata %22 : memref<1024x8192xf16, strided<[8192, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_10 = memref.reinterpret_cast %22 to offset: [%offset_7], sizes: [%c1073741822], strides: [1] : memref<1024x8192xf16, strided<[8192, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        %29 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_10 validBytes(%c2147483645_i32) cacheSwizzleStride(%c-8192_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %40 = arith.muli %37, %c8192 overflow<nsw> : index
        ...
        %52 = arith.muli %49, %c8192 overflow<nsw> : index
        ...
        %128:17 = scf.for %arg3 = %c0 to %c511 step %c1 iter_args(%arg4 = %cst_4, %arg5 = %cst_4, %arg6 = %cst_4, %arg7 = %cst_4, %arg8 = %cst_4, %arg9 = %cst_4, %arg10 = %cst_4, %arg11 = %cst_4, %arg12 = %cst_4, %arg13 = %cst_4, %arg14 = %cst_4, %arg15 = %cst_4, %arg16 = %cst_4, %arg17 = %cst_4, %arg18 = %cst_4, %arg19 = %cst_4, %arg20 = %cst_4) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          amdgpu.lds_barrier
        ...
        %216 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<642x1024xf32, strided<[1024, 1], offset: ?>>
        ...
        %base_buffer_11, %offset_12, %sizes_13:2, %strides_14:2 = memref.extract_strided_metadata %216 : memref<642x1024xf32, strided<[1024, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %233 = arith.addi %231, %offset_12 overflow<nsw> : index
        %reinterpret_cast_15 = memref.reinterpret_cast %216 to offset: [%233], sizes: [%c536870910], strides: [1] : memref<642x1024xf32, strided<[1024, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
