...
#map1 = affine_map<()[s0, s1, s2] -> (s0 mod 16 + ((s1 * 107584 + s2 * 2624 - ((s1 * 41 + s2) floordiv 8) * 20991) floordiv 512) * 16 + (s0 floordiv 64) * 4)>
#map2 = affine_map<()[s0] -> (((s0 mod 64) floordiv 16) * 4)>
#map3 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 1721344 + s2 * 41984 + s3 * 8 - (s0 floordiv 16) * 16 - ((s1 * 41 + s2) floordiv 8) * 335856 - ((s1 * 107584 + s2 * 2624 - ((s1 * 41 + s2) floordiv 8) * 20991) floordiv 512) * 8192)>
...
#map10 = affine_map<()[s0, s1, s2] -> (((s0 * 107584 + s1 * 2624 - ((s0 * 41 + s1) floordiv 8) * 20991) floordiv 512) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4)>
#map11 = affine_map<()[s0, s1] -> (((s0 * 107584 + s1 * 2624 - ((s0 * 41 + s1) floordiv 8) * 20991) floordiv 512) * 16)>
#map12 = affine_map<()[s0, s1] -> (s0 * 1721344 + s1 * 41984 - ((s0 * 41 + s1) floordiv 8) * 335856 - ((s0 * 107584 + s1 * 2624 - ((s0 * 41 + s1) floordiv 8) * 20991) floordiv 512) * 8192)>
#map13 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4)>
#map14 = affine_map<()[s0, s1, s2] -> (((s0 * 107584 + s1 * 2624 - ((s0 * 41 + s1) floordiv 8) * 20991) floordiv 512) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4 + 1)>
#map15 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map16 = affine_map<()[s0, s1, s2] -> (((s0 * 107584 + s1 * 2624 - ((s0 * 41 + s1) floordiv 8) * 20991) floordiv 512) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4 + 2)>
#map17 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map18 = affine_map<()[s0, s1, s2] -> (((s0 * 107584 + s1 * 2624 - ((s0 * 41 + s1) floordiv 8) * 20991) floordiv 512) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4 + 3)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %41 = scf.for %arg3 = %c0 to %c1791 step %c1 iter_args(%arg4 = %cst_2) -> (vector<4xf32>) {
          amdgpu.lds_barrier
        ...
        %46 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<642x8192xf32, strided<[8192, 1], offset: ?>>
        ...
        %53 = arith.muli %50, %c8192 overflow<nsw> : index
        %54 = arith.muli %52, %c8192 overflow<nsw> : index
        %55 = arith.addi %53, %51 overflow<nsw> : index
        %56 = arith.addi %54, %37 overflow<nsw> : index
        %base_buffer_9, %offset_10, %sizes_11:2, %strides_12:2 = memref.extract_strided_metadata %46 : memref<642x8192xf32, strided<[8192, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %57 = arith.addi %55, %offset_10 overflow<nsw> : index
        %reinterpret_cast_13 = memref.reinterpret_cast %46 to offset: [%57], sizes: [%c536870910], strides: [1] : memref<642x8192xf32, strided<[8192, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %58 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_13 validBytes(%c2147483643_i32) cacheSwizzleStride(%c-8192_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
