#map = affine_map<()[s0, s1] -> (((s0 * 28 + s1 * 112 - ((s0 + s1 * 4) floordiv 8) * 223) floordiv 448) * -8 + 4)>
#map1 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8) floordiv 128) * 128 + ((s2 * 28 + s3 * 112 - ((s2 + s3 * 4) floordiv 8) * 223) floordiv 448) * 1024 + (((s2 * 28 + s3 * 112 - ((s2 + s3 * 4) floordiv 8) * 223) mod 448) mod s4) * 128)>
#map2 = affine_map<()[s0] -> (s0 * 8 - (s0 floordiv 8) * 64)>
#map3 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 128) * 128 + ((s2 * 28 + s3 * 112 - ((s2 + s3 * 4) floordiv 8) * 223) floordiv 448) * 1024 + (((s2 * 28 + s3 * 112 - ((s2 + s3 * 4) floordiv 8) * 223) mod 448) mod s4) * 128 + 64)>
#map4 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8) floordiv 256) * 256 + (((s2 * 28 + s3 * 112 - ((s2 + s3 * 4) floordiv 8) * 223) mod 448) floordiv s4) * 256)>
#map5 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 256) * 256 + (((s2 * 28 + s3 * 112 - ((s2 + s3 * 4) floordiv 8) * 223) mod 448) floordiv s4) * 256 + 64)>
#map6 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 128) floordiv 256) * 256 + (((s2 * 28 + s3 * 112 - ((s2 + s3 * 4) floordiv 8) * 223) mod 448) floordiv s4) * 256 + 128)>
#map7 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 192) floordiv 256) * 256 + (((s2 * 28 + s3 * 112 - ((s2 + s3 * 4) floordiv 8) * 223) mod 448) floordiv s4) * 256 + 192)>
...
#map30 = affine_map<()[s0, s1, s2] -> (((s0 * 28 + s1 * 112 - ((s0 + s1 * 4) floordiv 8) * 223) floordiv 448) * 1024 + (((s0 * 28 + s1 * 112 - ((s0 + s1 * 4) floordiv 8) * 223) mod 448) mod s2) * 128)>
#map31 = affine_map<()[s0, s1, s2] -> ((((s0 * 28 + s1 * 112 - ((s0 + s1 * 4) floordiv 8) * 223) mod 448) floordiv s2) * 256)>
...
module attributes {transform.with_named_sequence} {
  stream.executable private @gemm {
    stream.executable.export public @gemm workgroups() -> (index, index, index) {
      ...
      stream.return %c4, %c56, %c1 : index, index, index
    }
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %0 = stream.binding.subspan %arg0[%c0] : !stream.binding -> memref<512x4096xf16, strided<[4096, 1], offset: ?>>
        %1 = affine.apply #map()[%block_id_x, %block_id_y]
        %2 = arith.maxsi %1, %c1 : index
        %3 = affine.apply #map1()[%thread_id_x, %thread_id_y, %block_id_x, %block_id_y, %2]
        %4 = affine.apply #map2()[%thread_id_x]
        %5 = arith.muli %3, %c4096 overflow<nsw> : index
        %6 = arith.addi %5, %4 overflow<nsw> : index
        %base_buffer, %offset, %sizes:2, %strides:2 = memref.extract_strided_metadata %0 : memref<512x4096xf16, strided<[4096, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast = memref.reinterpret_cast %0 to offset: [%offset], sizes: [%c1073741822], strides: [1] : memref<512x4096xf16, strided<[4096, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %10 = arith.muli %9, %c4096 overflow<nsw> : index
        %11 = arith.addi %10, %4 overflow<nsw> : index
        %12 = vector.load %7[%11] : memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>, vector<8xf16>
        %13 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<14336x4096xf16, strided<[4096, 1], offset: ?>>
        %14 = affine.apply #map4()[%thread_id_x, %thread_id_y, %block_id_x, %block_id_y, %2]
        %15 = arith.muli %14, %c4096 overflow<nsw> : index
        %16 = arith.addi %15, %4 overflow<nsw> : index
        %base_buffer_1, %offset_2, %sizes_3:2, %strides_4:2 = memref.extract_strided_metadata %13 : memref<14336x4096xf16, strided<[4096, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_5 = memref.reinterpret_cast %13 to offset: [%offset_2], sizes: [%c1073741822], strides: [1] : memref<14336x4096xf16, strided<[4096, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        %17 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_5 validBytes(%c2147483645_i32) cacheSwizzleStride(%c4096_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %20 = arith.muli %19, %c4096 overflow<nsw> : index
        ...
        %24 = arith.muli %23, %c4096 overflow<nsw> : index
        ...
        %28 = arith.muli %27, %c4096 overflow<nsw> : index
        ...
        %55:16 = scf.for %arg3 = %c0 to %c63 step %c1 iter_args(%arg4 = %cst, %arg5 = %cst, %arg6 = %cst, %arg7 = %cst, %arg8 = %cst, %arg9 = %cst, %arg10 = %cst, %arg11 = %cst, %arg12 = %cst, %arg13 = %cst, %arg14 = %cst, %arg15 = %cst, %arg16 = %cst, %arg17 = %cst, %arg18 = %cst, %arg19 = %cst) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          ...
          %374 = arith.addi %20, %345 overflow<nsw> : index
          ...
          vector.store %375, %view[%34, %4] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          rocdl.s.barrier
          llvm.call_intrinsic "llvm.amdgcn.sched.barrier"(%c0_i32) : (i32) -> ()
          rocdl.s.setprio 1
        ...
        %175 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<512x14336xf32, strided<[14336, 1], offset: ?>>
        ...
        %179 = arith.muli %176, %c14336 overflow<nsw> : index
        %180 = arith.muli %178, %c14336 overflow<nsw> : index
        %181 = arith.addi %179, %177 overflow<nsw> : index
        %182 = arith.addi %180, %56 overflow<nsw> : index
        %base_buffer_6, %offset_7, %sizes_8:2, %strides_9:2 = memref.extract_strided_metadata %175 : memref<512x14336xf32, strided<[14336, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %183 = arith.addi %181, %offset_7 overflow<nsw> : index
        %reinterpret_cast_10 = memref.reinterpret_cast %175 to offset: [%183], sizes: [%c536870910], strides: [1] : memref<512x14336xf32, strided<[14336, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        ...
        %195 = arith.muli %194, %c14336 overflow<nsw> : index
        ...
        %259 = arith.muli %258, %c14336 overflow<nsw> : index
        ...
        %267 = arith.muli %266, %c14336 overflow<nsw> : index
  ...
  func.func @isolated_benchmark(%arg0: tensor<512x4096xf16>, %arg1: tensor<14336x4096xf16>, %arg2: tensor<512x14336xf32>) -> tensor<512x14336xf32> {
    %0 = flow.dispatch @gemm::@gemm(%arg0, %arg1, %arg2) : (tensor<512x4096xf16>, tensor<14336x4096xf16>, tensor<512x14336xf32>) -> %arg2
    return %0 : tensor<512x14336xf32>
  }
}
