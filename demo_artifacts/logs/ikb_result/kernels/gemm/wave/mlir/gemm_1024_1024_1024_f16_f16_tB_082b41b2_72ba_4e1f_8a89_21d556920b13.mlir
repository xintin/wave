...
#map4 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 256 + s2 * 512 + s3 * 8 - (s0 floordiv 16) * 16 - ((s1 + s2 * 2) floordiv 8) * 2032 - ((s1 * 16 + s2 * 32 - ((s1 + s2 * 2) floordiv 8) * 127) floordiv 64) * 1024)>
#map5 = affine_map<()[s0, s1] -> (s0 * 16 + s1 * 8 + 8)>
#map6 = affine_map<()[s0] -> (((s0 mod 64) floordiv 16) * 4)>
#map7 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + 130)>
#map8 = affine_map<()[s0, s1] -> ((s1 * 128 + s0 floordiv 2) mod 520)>
#map9 = affine_map<()[s0, s1] -> (s1 * 128 + s0 floordiv 2 - ((s1 * 128 + s0 floordiv 2 + 256) floordiv 520) * 520 + 256)>
#map10 = affine_map<()[s0, s1] -> (s1 * 128 + s0 floordiv 2 - ((s1 * 128 + s0 floordiv 2 + 512) floordiv 520) * 520 + 512)>
#map11 = affine_map<()[s0, s1] -> (s0 + s1 * 8 - (s0 floordiv 16) * 16)>
#map12 = affine_map<()[s0] -> (s0 * 8 + 8)>
#map13 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 130)>
#map14 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 130 + 16)>
#map15 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 130 + 32)>
#map16 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 130 + 48)>
#map17 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 130 + 64)>
#map18 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 130 + 80)>
#map19 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 130 + 96)>
#map20 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 130 + 112)>
#map21 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 130 + 128)>
#map22 = affine_map<()[s0, s1] -> (s0 * 16 + s1 * 8 - (s1 floordiv 2) * 16 + 16)>
#map23 = affine_map<()[s0, s1] -> (s0 * 16 + ((s1 mod 64) floordiv 16) * 4 + 16)>
#map24 = affine_map<()[s0, s1] -> (s0 * 520 + (s1 floordiv 64) * 130 + 130)>
#map25 = affine_map<()[s0] -> (s0 * 520 + 520)>
#map26 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4)>
#map27 = affine_map<()[s0, s1] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520)>
#map28 = affine_map<()[s0, s1] -> (s0 * 256 + s1 * 512 - ((s0 + s1 * 2) floordiv 8) * 2032 - ((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 1024)>
#map29 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4)>
#map30 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 1)>
#map31 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map32 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 2)>
#map33 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map34 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 3)>
#map35 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map36 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 16)>
#map37 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 16)>
#map38 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 17)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 17)>
#map40 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 18)>
#map41 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 18)>
#map42 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 19)>
#map43 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 19)>
#map44 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 32)>
#map45 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 32)>
#map46 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 33)>
#map47 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 33)>
#map48 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 34)>
#map49 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 34)>
#map50 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 35)>
#map51 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 35)>
#map52 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 48)>
#map53 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 48)>
#map54 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 49)>
#map55 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 49)>
#map56 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 50)>
#map57 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 50)>
#map58 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 51)>
#map59 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 51)>
#map60 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 64)>
#map61 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 64)>
#map62 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 65)>
#map63 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 65)>
#map64 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 66)>
#map65 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 66)>
#map66 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 67)>
#map67 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 67)>
#map68 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 80)>
#map69 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 80)>
#map70 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 81)>
#map71 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 81)>
#map72 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 82)>
#map73 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 82)>
#map74 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 83)>
#map75 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 83)>
#map76 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 96)>
#map77 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 96)>
#map78 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 97)>
#map79 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 97)>
#map80 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 98)>
#map81 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 98)>
#map82 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 99)>
#map83 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 99)>
#map84 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 112)>
#map85 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 112)>
#map86 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 113)>
#map87 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 113)>
#map88 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 114)>
#map89 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 114)>
#map90 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 115)>
#map91 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 115)>
#map92 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 128)>
#map93 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 128)>
#map94 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 129)>
#map95 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 129)>
#map96 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 130)>
#map97 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 130)>
#map98 = affine_map<()[s0, s1, s2] -> (((s0 * 16 + s1 * 32 - ((s0 + s1 * 2) floordiv 8) * 127) floordiv 64) * 520 + (s2 floordiv 64) * 130 + ((s2 mod 64) floordiv 16) * 4 + 131)>
#map99 = affine_map<()[s0] -> ((s0 floordiv 64) * 130 + ((s0 mod 64) floordiv 16) * 4 + 131)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %view_5 = memref.view %alloc[%c0][] : memref<21440xi8, #gpu.address_space<workgroup>> to memref<520x20xf16, #gpu.address_space<workgroup>>
        ...
        %47 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_10 validBytes(%c2147483645_i32) cacheSwizzleStride(%c1024_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        vector.maskedstore %view_5[%57, %4], %59, %14 : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        %60 = affine.apply #map9()[%thread_id_x, %thread_id_y]
        %61 = arith.cmpi slt, %60, %56 : index
        %62 = vector.broadcast %61 : i1 to vector<8xi1>
        vector.maskedstore %view_5[%60, %4], %62, %26 : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        %63 = affine.apply #map10()[%thread_id_x, %thread_id_y]
        %64 = arith.cmpi slt, %63, %56 : index
        %65 = vector.broadcast %64 : i1 to vector<8xi1>
        vector.maskedstore %view_5[%63, %4], %65, %38 : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        ...
        %97:9 = scf.for %arg3 = %c0 to %c63 step %c1 iter_args(%arg4 = %cst_4, %arg5 = %cst_4, %arg6 = %cst_4, %arg7 = %cst_4, %arg8 = %cst_4, %arg9 = %cst_4, %arg10 = %cst_4, %arg11 = %cst_4, %arg12 = %cst_4) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          amdgpu.lds_barrier
          ...
          %444 = vector.maskedload %view_5[%70, %44], %72, %cst : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %445 = vector.maskedload %view_5[%73, %44], %75, %cst : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %446 = vector.maskedload %view_5[%76, %44], %78, %cst : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %447 = vector.maskedload %view_5[%79, %44], %81, %cst : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %448 = vector.maskedload %view_5[%82, %44], %84, %cst : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %449 = vector.maskedload %view_5[%85, %44], %87, %cst : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %450 = vector.maskedload %view_5[%88, %44], %90, %cst : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %451 = vector.maskedload %view_5[%91, %44], %93, %cst : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %452 = vector.maskedload %view_5[%94, %44], %96, %cst : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          ...
          amdgpu.lds_barrier
          vector.maskedstore %view_5[%57, %4], %59, %461 : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
          vector.maskedstore %view_5[%60, %4], %62, %469 : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
          vector.maskedstore %view_5[%63, %4], %65, %477 : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        ...
        %102 = vector.maskedload %view_5[%99, %44], %101, %cst : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %103 = affine.apply #map14()[%thread_id_x]
        %104 = arith.cmpi slt, %103, %56 : index
        %105 = vector.broadcast %104 : i1 to vector<4xi1>
        %106 = vector.maskedload %view_5[%103, %44], %105, %cst : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %107 = affine.apply #map15()[%thread_id_x]
        %108 = arith.cmpi slt, %107, %56 : index
        %109 = vector.broadcast %108 : i1 to vector<4xi1>
        %110 = vector.maskedload %view_5[%107, %44], %109, %cst : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %111 = affine.apply #map16()[%thread_id_x]
        %112 = arith.cmpi slt, %111, %56 : index
        %113 = vector.broadcast %112 : i1 to vector<4xi1>
        %114 = vector.maskedload %view_5[%111, %44], %113, %cst : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %115 = affine.apply #map17()[%thread_id_x]
        %116 = arith.cmpi slt, %115, %56 : index
        %117 = vector.broadcast %116 : i1 to vector<4xi1>
        %118 = vector.maskedload %view_5[%115, %44], %117, %cst : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %119 = affine.apply #map18()[%thread_id_x]
        %120 = arith.cmpi slt, %119, %56 : index
        %121 = vector.broadcast %120 : i1 to vector<4xi1>
        %122 = vector.maskedload %view_5[%119, %44], %121, %cst : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %123 = affine.apply #map19()[%thread_id_x]
        %124 = arith.cmpi slt, %123, %56 : index
        %125 = vector.broadcast %124 : i1 to vector<4xi1>
        %126 = vector.maskedload %view_5[%123, %44], %125, %cst : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %127 = affine.apply #map20()[%thread_id_x]
        %128 = arith.cmpi slt, %127, %56 : index
        %129 = vector.broadcast %128 : i1 to vector<4xi1>
        %130 = vector.maskedload %view_5[%127, %44], %129, %cst : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %131 = affine.apply #map21()[%thread_id_x]
        %132 = arith.cmpi slt, %131, %56 : index
        %133 = vector.broadcast %132 : i1 to vector<4xi1>
        %134 = vector.maskedload %view_5[%131, %44], %133, %cst : memref<520x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        ...
        %145 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<1024x1024xf32, strided<[1024, 1], offset: ?>>
        %146 = affine.apply #map24()[%block_id_x, %thread_id_x]
        %147 = affine.apply #map25()[%block_id_x]
        %148 = arith.minsi %146, %147 : index
        %149 = arith.minsi %148, %c1024 : index
        ...
        %156 = arith.muli %153, %c1024 overflow<nsw> : index
        %157 = arith.muli %155, %c1024 overflow<nsw> : index
        %158 = arith.addi %156, %154 overflow<nsw> : index
        %159 = arith.addi %157, %66 overflow<nsw> : index
        %base_buffer_11, %offset_12, %sizes_13:2, %strides_14:2 = memref.extract_strided_metadata %145 : memref<1024x1024xf32, strided<[1024, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %160 = arith.addi %158, %offset_12 overflow<nsw> : index
        %reinterpret_cast_15 = memref.reinterpret_cast %145 to offset: [%160], sizes: [%c536870910], strides: [1] : memref<1024x1024xf32, strided<[1024, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %161 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_15 validBytes(%c2147483643_i32) cacheSwizzleStride(%c1024_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
