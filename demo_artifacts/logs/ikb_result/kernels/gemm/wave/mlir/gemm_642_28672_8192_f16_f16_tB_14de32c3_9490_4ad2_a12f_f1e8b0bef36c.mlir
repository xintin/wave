#map = affine_map<()[s0, s1, s2, s3] -> ((s1 * 48 + (s0 * 3) floordiv 16) mod 96 + ((s2 * 10976 + s3 * 1568 - ((s2 * 7 + s3) floordiv 8) * 12543) floordiv 1792) * 96)>
#map1 = affine_map<()[s0] -> ((s0 * 3) mod 16)>
#map2 = affine_map<()[s0, s1, s2] -> (s1 * 175616 + s2 * 25088 + (s0 floordiv 16) mod 16 - ((s1 * 7 + s2) floordiv 8) * 200688 - ((s1 * 10976 + s2 * 1568 - ((s1 * 7 + s2) floordiv 8) * 12543) floordiv 1792) * 28672)>
...
#map16 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 175616 + s2 * 25088 + s3 * 8 - (s0 floordiv 32) * 32 - ((s1 * 7 + s2) floordiv 8) * 200688 - ((s1 * 10976 + s2 * 1568 - ((s1 * 7 + s2) floordiv 8) * 12543) floordiv 1792) * 28672)>
#map17 = affine_map<()[s0, s1] -> (s0 * 96 + (s1 floordiv 64) * 24 + 24)>
#map18 = affine_map<()[s0, s1, s2] -> (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 1792) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4)>
#map19 = affine_map<()[s0, s1] -> (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 1792) * 96)>
#map20 = affine_map<()[s0, s1] -> (s0 * 175616 + s1 * 25088 - ((s0 * 7 + s1) floordiv 8) * 200688 - ((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 1792) * 28672)>
#map21 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4)>
#map22 = affine_map<()[s0, s1, s2] -> (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 1792) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 1)>
#map23 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map24 = affine_map<()[s0, s1, s2] -> (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 1792) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 2)>
#map25 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map26 = affine_map<()[s0, s1, s2] -> (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 1792) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 3)>
#map27 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map28 = affine_map<()[s0, s1, s2] -> (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 1792) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 8)>
#map29 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map30 = affine_map<()[s0, s1, s2] -> (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 1792) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 9)>
#map31 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map32 = affine_map<()[s0, s1, s2] -> (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 1792) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 10)>
#map33 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map34 = affine_map<()[s0, s1, s2] -> (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 1792) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 11)>
#map35 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map36 = affine_map<()[s0, s1, s2] -> (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 1792) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 16)>
#map37 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map38 = affine_map<()[s0, s1, s2] -> (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 1792) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 17)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map40 = affine_map<()[s0, s1, s2] -> (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 1792) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 18)>
#map41 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map42 = affine_map<()[s0, s1, s2] -> (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 1792) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 19)>
#map43 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map44 = affine_map<()[s0, s1, s2] -> (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 1792) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 24)>
#map45 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map46 = affine_map<()[s0, s1, s2] -> (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 1792) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 25)>
#map47 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map48 = affine_map<()[s0, s1, s2] -> (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 1792) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 26)>
#map49 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map50 = affine_map<()[s0, s1, s2] -> (((s0 * 10976 + s1 * 1568 - ((s0 * 7 + s1) floordiv 8) * 12543) floordiv 1792) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 27)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %40 = scf.for %arg3 = %c0 to %c511 step %c1 iter_args(%arg4 = %cst_2) -> (vector<16xf32>) {
          amdgpu.lds_barrier
        ...
        %71 = arith.muli %69, %c28672 overflow<nsw> : index
        ...
        %reinterpret_cast_13 = memref.reinterpret_cast %56 to offset: [%74], sizes: [%c536870910], strides: [1] : memref<642x28672xf32, strided<[28672, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        ...
        %82 = arith.muli %81, %c28672 overflow<nsw> : index
        ...
        %90 = arith.muli %89, %c28672 overflow<nsw> : index
        ...
        %98 = arith.muli %97, %c28672 overflow<nsw> : index
        ...
        %106 = arith.muli %105, %c28672 overflow<nsw> : index
        ...
        %114 = arith.muli %113, %c28672 overflow<nsw> : index
