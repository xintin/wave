...
#map1 = affine_map<()[s0, s1, s2, s3] -> (s0 mod 16 + (s0 floordiv 64) * 4 + ((s1 * 512 + s2 * 8 - (s1 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s1 * 512 + s2 * 8 - (s1 floordiv 8) * 4095) mod 4032) mod s3) * 16)>
#map2 = affine_map<()[s0, s1] -> (s0 * 16 + (s1 floordiv 64) * 4 + 4)>
#map3 = affine_map<()[s0] -> (((s0 mod 64) floordiv 16) * 4)>
#map4 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 8 + (((s1 * 512 + s2 * 8 - (s1 floordiv 8) * 4095) mod 4032) floordiv s3) * 16)>
...
#map11 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4)>
#map12 = affine_map<()[s0, s1, s2] -> (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16)>
#map13 = affine_map<()[s0, s1, s2] -> ((((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) floordiv s2) * 16)>
#map14 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4)>
#map15 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4 + 1)>
#map16 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map17 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4 + 2)>
#map18 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map19 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4 + 3)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %20 = affine.apply #map4()[%thread_id_x, %block_id_x, %block_id_y, %3, %thread_id_y]
        ...
        %42 = scf.for %arg3 = %c0 to %c63 step %c1 iter_args(%arg4 = %cst_2) -> (vector<4xf32>) {
          amdgpu.lds_barrier
        ...
        %47 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<1024x1024xf32, strided<[1024, 1], offset: ?>>
        %48 = affine.apply #map11()[%block_id_x, %block_id_y, %3, %thread_id_x]
        %49 = arith.cmpi slt, %48, %5 : index
        %50 = arith.andi %22, %49 : i1
        %51 = affine.apply #map12()[%block_id_x, %block_id_y, %3]
        %52 = affine.apply #map13()[%block_id_x, %block_id_y, %3]
        %53 = affine.apply #map14()[%thread_id_x]
        %54 = arith.muli %51, %c1024 overflow<nsw> : index
        %55 = arith.muli %53, %c1024 overflow<nsw> : index
        %56 = arith.addi %54, %52 overflow<nsw> : index
        %57 = arith.addi %55, %38 overflow<nsw> : index
        %base_buffer_9, %offset_10, %sizes_11:2, %strides_12:2 = memref.extract_strided_metadata %47 : memref<1024x1024xf32, strided<[1024, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %58 = arith.addi %56, %offset_10 overflow<nsw> : index
        %reinterpret_cast_13 = memref.reinterpret_cast %47 to offset: [%58], sizes: [%c536870910], strides: [1] : memref<1024x1024xf32, strided<[1024, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %59 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_13 validBytes(%c2147483643_i32) cacheSwizzleStride(%c1024_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %62 = affine.apply #map15()[%block_id_x, %block_id_y, %3, %thread_id_x]
        %63 = arith.cmpi slt, %62, %5 : index
        %64 = arith.andi %22, %63 : i1
        %65 = affine.apply #map16()[%thread_id_x]
        %66 = arith.muli %65, %c1024 overflow<nsw> : index
        ...
        %70 = affine.apply #map17()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %78 = affine.apply #map19()[%block_id_x, %block_id_y, %3, %thread_id_x]
