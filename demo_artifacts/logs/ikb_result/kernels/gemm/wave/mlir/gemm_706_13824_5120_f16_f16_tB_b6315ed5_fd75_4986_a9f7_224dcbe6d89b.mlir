...
#map2 = affine_map<()[s0, s1, s2] -> (s0 mod 32 + ((s1 * 5292 + s2 * 756 - ((s1 * 7 + s2) floordiv 8) * 6047) floordiv 864) * 104 + (s0 floordiv 64) * 26)>
#map3 = affine_map<()[s0] -> (((s0 mod 64) floordiv 32) * 8)>
#map4 = affine_map<()[s0, s1] -> (s0 * 16 + s1 * 8 + 8)>
#map5 = affine_map<()[s0] -> (s0 * 16 + 16)>
#map6 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 84672 + s2 * 12096 + s3 * 8 - (s0 floordiv 32) * 32 - ((s1 * 7 + s2) floordiv 8) * 96752 - ((s1 * 5292 + s2 * 756 - ((s1 * 7 + s2) floordiv 8) * 6047) floordiv 864) * 13824)>
...
#map12 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4)>
#map13 = affine_map<()[s0, s1] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104)>
#map14 = affine_map<()[s0, s1] -> (s0 * 84672 + s1 * 12096 - ((s0 * 7 + s1) floordiv 8) * 96752 - ((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 13824)>
#map15 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4)>
#map16 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 1)>
#map17 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map18 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 2)>
#map19 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map20 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 3)>
#map21 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map22 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 8)>
#map23 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map24 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 9)>
#map25 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map26 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 10)>
#map27 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map28 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 11)>
#map29 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map30 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 16)>
#map31 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map32 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 17)>
#map33 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map34 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 18)>
#map35 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map36 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 19)>
#map37 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map38 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 24)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map40 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 25)>
#map41 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map42 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 26)>
#map43 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map44 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 27)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %19 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<13824x5120xf16, strided<[5120, 1], offset: ?>>
        ...
        %26 = arith.muli %23, %c5120 overflow<nsw> : index
        %27 = arith.addi %26, %8 overflow<nsw> : index
        %base_buffer_4, %offset_5, %sizes_6:2, %strides_7:2 = memref.extract_strided_metadata %19 : memref<13824x5120xf16, strided<[5120, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_8 = memref.reinterpret_cast %19 to offset: [%offset_5], sizes: [%c1073741822], strides: [1] : memref<13824x5120xf16, strided<[5120, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        %28 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_8 validBytes(%c2147483645_i32) cacheSwizzleStride(%c5120_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %46 = scf.for %arg3 = %c0 to %c319 step %c1 iter_args(%arg4 = %cst_2) -> (vector<16xf32>) {
          amdgpu.lds_barrier
        ...
        %63 = arith.muli %60, %c13824 overflow<nsw> : index
        %64 = arith.muli %62, %c13824 overflow<nsw> : index
        ...
        %reinterpret_cast_13 = memref.reinterpret_cast %56 to offset: [%67], sizes: [%c536870910], strides: [1] : memref<706x13824xf32, strided<[13824, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        ...
        %75 = arith.muli %74, %c13824 overflow<nsw> : index
        ...
        %83 = arith.muli %82, %c13824 overflow<nsw> : index
        ...
        %91 = arith.muli %90, %c13824 overflow<nsw> : index
        ...
        %99 = arith.muli %98, %c13824 overflow<nsw> : index
        ...
        %107 = arith.muli %106, %c13824 overflow<nsw> : index
        ...
        %115 = arith.muli %114, %c13824 overflow<nsw> : index
        ...
        %123 = arith.muli %122, %c13824 overflow<nsw> : index
        ...
        %131 = arith.muli %130, %c13824 overflow<nsw> : index
        ...
        %139 = arith.muli %138, %c13824 overflow<nsw> : index
        ...
        %147 = arith.muli %146, %c13824 overflow<nsw> : index
        ...
        %155 = arith.muli %154, %c13824 overflow<nsw> : index
        ...
        %163 = arith.muli %162, %c13824 overflow<nsw> : index
        ...
        %171 = arith.muli %170, %c13824 overflow<nsw> : index
        ...
        %179 = arith.muli %178, %c13824 overflow<nsw> : index
        ...
        %187 = arith.muli %186, %c13824 overflow<nsw> : index
