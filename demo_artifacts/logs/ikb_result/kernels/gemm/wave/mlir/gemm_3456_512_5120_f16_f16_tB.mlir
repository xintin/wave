...
#map1 = affine_map<()[s0, s1, s2] -> (((s0 * 162 + s1 * 6 + s2 - ((s0 * 27 + s1) floordiv 8) * 47) floordiv 16) * -8 + 27)>
#map2 = affine_map<()[s0, s1, s2, s3, s4, s5, s6] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8) floordiv 128) * 128 + ((s2 * 162 + s3 * 6 + s4 - ((s2 * 27 + s3) floordiv 8) * 47) floordiv 16) * 1024 + (((s2 * 162 + s3 * 6 + s5 - ((s2 * 27 + s3) floordiv 8) * 47) mod 16) mod s6) * 128)>
#map3 = affine_map<()[s0] -> (s0 * 8 - (s0 floordiv 8) * 64)>
#map4 = affine_map<()[s0, s1, s2, s3, s4, s5, s6] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 128) * 128 + ((s2 * 162 + s3 * 6 + s4 - ((s2 * 27 + s3) floordiv 8) * 47) floordiv 16) * 1024 + (((s2 * 162 + s3 * 6 + s5 - ((s2 * 27 + s3) floordiv 8) * 47) mod 16) mod s6) * 128 + 64)>
#map5 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8) floordiv 256) * 256 + (((s2 * 162 + s3 * 6 + s4 - ((s2 * 27 + s3) floordiv 8) * 47) mod 16) floordiv s5) * 256)>
#map6 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 256) * 256 + (((s2 * 162 + s3 * 6 + s4 - ((s2 * 27 + s3) floordiv 8) * 47) mod 16) floordiv s5) * 256 + 64)>
#map7 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 128) floordiv 256) * 256 + (((s2 * 162 + s3 * 6 + s4 - ((s2 * 27 + s3) floordiv 8) * 47) mod 16) floordiv s5) * 256 + 128)>
#map8 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 192) floordiv 256) * 256 + (((s2 * 162 + s3 * 6 + s4 - ((s2 * 27 + s3) floordiv 8) * 47) mod 16) floordiv s5) * 256 + 192)>
...
#map31 = affine_map<()[s0, s1, s2, s3, s4] -> (((s0 * 162 + s1 * 6 + s2 - ((s0 * 27 + s1) floordiv 8) * 47) floordiv 16) * 1024 + (((s0 * 162 + s1 * 6 + s3 - ((s0 * 27 + s1) floordiv 8) * 47) mod 16) mod s4) * 128)>
#map32 = affine_map<()[s0, s1, s2, s3] -> ((((s0 * 162 + s1 * 6 + s2 - ((s0 * 27 + s1) floordiv 8) * 47) mod 16) floordiv s3) * 256)>
...
module attributes {transform.with_named_sequence} {
  stream.executable private @gemm {
    stream.executable.export public @gemm workgroups() -> (index, index, index) {
      ...
      stream.return %c27, %c2, %c1 : index, index, index
    }
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %178 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<3456x512xf32, strided<[512, 1], offset: ?>>
        ...
        %base_buffer_6, %offset_7, %sizes_8:2, %strides_9:2 = memref.extract_strided_metadata %178 : memref<3456x512xf32, strided<[512, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %186 = arith.addi %184, %offset_7 overflow<nsw> : index
        %reinterpret_cast_10 = memref.reinterpret_cast %178 to offset: [%186], sizes: [%c536870910], strides: [1] : memref<3456x512xf32, strided<[512, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
  ...
  func.func @isolated_benchmark(%arg0: tensor<3456x5120xf16>, %arg1: tensor<512x5120xf16>, %arg2: tensor<3456x512xf32>) -> tensor<3456x512xf32> {
    %0 = flow.dispatch @gemm::@gemm(%arg0, %arg1, %arg2) : (tensor<3456x5120xf16>, tensor<512x5120xf16>, tensor<3456x512xf32>) -> %arg2
    return %0 : tensor<3456x512xf32>
  }
}
