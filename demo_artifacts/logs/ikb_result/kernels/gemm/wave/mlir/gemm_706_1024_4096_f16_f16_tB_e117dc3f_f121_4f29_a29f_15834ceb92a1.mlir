...
#map3 = affine_map<()[s0, s1, s2, s3] -> (s0 mod 32 + ((s1 * 495 + s2 * 11 + s3 - ((s1 * 45 + s2) floordiv 8) * 87) floordiv 2) * 16 + (s0 floordiv 64) * 4)>
#map4 = affine_map<()[s0] -> (((s0 mod 64) floordiv 32) * 8)>
#map5 = affine_map<()[s0, s1, s2, s3, s4] -> (s1 * 128 + s2 * 257400 + s3 * 5720 + s4 * 520 + s0 floordiv 2 - ((s1 * 128 + s0 floordiv 2) floordiv 520) * 520 - ((s2 * 45 + s3) floordiv 8) * 45240 - ((s2 * 495 + s3 * 11 + s4 - ((s2 * 45 + s3) floordiv 8) * 87) floordiv 2) * 1040)>
#map6 = affine_map<()[s0] -> (s0 * 8 - (s0 floordiv 2) * 16)>
#map7 = affine_map<()[s0, s1, s2, s3, s4] -> (s1 * 128 + s2 * 257400 + s3 * 5720 + s4 * 520 + s0 floordiv 2 - ((s1 * 128 + s0 floordiv 2 + 256) floordiv 520) * 520 - ((s2 * 45 + s3) floordiv 8) * 45240 - ((s2 * 495 + s3 * 11 + s4 - ((s2 * 45 + s3) floordiv 8) * 87) floordiv 2) * 1040 + 256)>
#map8 = affine_map<()[s0, s1, s2, s3, s4] -> (s1 * 128 + s2 * 257400 + s3 * 5720 + s4 * 520 + s0 floordiv 2 - ((s1 * 128 + s0 floordiv 2 + 512) floordiv 520) * 520 - ((s2 * 45 + s3) floordiv 8) * 45240 - ((s2 * 495 + s3 * 11 + s4 - ((s2 * 45 + s3) floordiv 8) * 87) floordiv 2) * 1040 + 512)>
...
#map28 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s1 * 257400 + s2 * 5720 + s3 * 520 + s4 * 260 - (s0 floordiv 32) * 32 - ((s1 * 45 + s2) floordiv 8) * 45240 - ((s1 * 495 + s2 * 11 + s3 - ((s1 * 45 + s2) floordiv 8) * 87) floordiv 2) * 1040)>
#map29 = affine_map<()[s0, s1, s2, s3] -> (((s0 * 495 + s1 * 11 + s2 - ((s0 * 45 + s1) floordiv 8) * 87) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 32) * 4)>
#map30 = affine_map<()[s0, s1, s2] -> (((s0 * 495 + s1 * 11 + s2 - ((s0 * 45 + s1) floordiv 8) * 87) floordiv 2) * 16)>
#map31 = affine_map<()[s0, s1, s2] -> (s0 * 257400 + s1 * 5720 + s2 * 520 - ((s0 * 45 + s1) floordiv 8) * 45240 - ((s0 * 495 + s1 * 11 + s2 - ((s0 * 45 + s1) floordiv 8) * 87) floordiv 2) * 1040)>
#map32 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4)>
#map33 = affine_map<()[s0, s1, s2, s3] -> (((s0 * 495 + s1 * 11 + s2 - ((s0 * 45 + s1) floordiv 8) * 87) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 32) * 4 + 1)>
#map34 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map35 = affine_map<()[s0, s1, s2, s3] -> (((s0 * 495 + s1 * 11 + s2 - ((s0 * 45 + s1) floordiv 8) * 87) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 32) * 4 + 2)>
#map36 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map37 = affine_map<()[s0, s1, s2, s3] -> (((s0 * 495 + s1 * 11 + s2 - ((s0 * 45 + s1) floordiv 8) * 87) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 32) * 4 + 3)>
#map38 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map39 = affine_map<()[s0, s1, s2, s3] -> (((s0 * 495 + s1 * 11 + s2 - ((s0 * 45 + s1) floordiv 8) * 87) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 32) * 4 + 8)>
#map40 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map41 = affine_map<()[s0, s1, s2, s3] -> (((s0 * 495 + s1 * 11 + s2 - ((s0 * 45 + s1) floordiv 8) * 87) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 32) * 4 + 9)>
#map42 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map43 = affine_map<()[s0, s1, s2, s3] -> (((s0 * 495 + s1 * 11 + s2 - ((s0 * 45 + s1) floordiv 8) * 87) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 32) * 4 + 10)>
#map44 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map45 = affine_map<()[s0, s1, s2, s3] -> (((s0 * 495 + s1 * 11 + s2 - ((s0 * 45 + s1) floordiv 8) * 87) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 32) * 4 + 11)>
#map46 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map47 = affine_map<()[s0, s1, s2, s3] -> (((s0 * 495 + s1 * 11 + s2 - ((s0 * 45 + s1) floordiv 8) * 87) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 32) * 4 + 16)>
#map48 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map49 = affine_map<()[s0, s1, s2, s3] -> (((s0 * 495 + s1 * 11 + s2 - ((s0 * 45 + s1) floordiv 8) * 87) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 32) * 4 + 17)>
#map50 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map51 = affine_map<()[s0, s1, s2, s3] -> (((s0 * 495 + s1 * 11 + s2 - ((s0 * 45 + s1) floordiv 8) * 87) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 32) * 4 + 18)>
#map52 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map53 = affine_map<()[s0, s1, s2, s3] -> (((s0 * 495 + s1 * 11 + s2 - ((s0 * 45 + s1) floordiv 8) * 87) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 32) * 4 + 19)>
#map54 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map55 = affine_map<()[s0, s1, s2, s3] -> (((s0 * 495 + s1 * 11 + s2 - ((s0 * 45 + s1) floordiv 8) * 87) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 32) * 4 + 24)>
#map56 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map57 = affine_map<()[s0, s1, s2, s3] -> (((s0 * 495 + s1 * 11 + s2 - ((s0 * 45 + s1) floordiv 8) * 87) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 32) * 4 + 25)>
#map58 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map59 = affine_map<()[s0, s1, s2, s3] -> (((s0 * 495 + s1 * 11 + s2 - ((s0 * 45 + s1) floordiv 8) * 87) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 32) * 4 + 26)>
#map60 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map61 = affine_map<()[s0, s1, s2, s3] -> (((s0 * 495 + s1 * 11 + s2 - ((s0 * 45 + s1) floordiv 8) * 87) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 32) * 4 + 27)>
#map62 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 27)>
#map63 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s1 * 257400 + s2 * 5720 + s3 * 520 + s4 * 260 - (s0 floordiv 32) * 32 - ((s1 * 45 + s2) floordiv 8) * 45240 - ((s1 * 495 + s2 * 11 + s3 - ((s1 * 45 + s2) floordiv 8) * 87) floordiv 2) * 1040 + 32)>
#map64 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s1 * 257400 + s2 * 5720 + s3 * 520 + s4 * 260 - (s0 floordiv 32) * 32 - ((s1 * 45 + s2) floordiv 8) * 45240 - ((s1 * 495 + s2 * 11 + s3 - ((s1 * 45 + s2) floordiv 8) * 87) floordiv 2) * 1040 + 64)>
#map65 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s1 * 257400 + s2 * 5720 + s3 * 520 + s4 * 260 - (s0 floordiv 32) * 32 - ((s1 * 45 + s2) floordiv 8) * 45240 - ((s1 * 495 + s2 * 11 + s3 - ((s1 * 45 + s2) floordiv 8) * 87) floordiv 2) * 1040 + 96)>
#map66 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s1 * 257400 + s2 * 5720 + s3 * 520 + s4 * 260 - (s0 floordiv 32) * 32 - ((s1 * 45 + s2) floordiv 8) * 45240 - ((s1 * 495 + s2 * 11 + s3 - ((s1 * 45 + s2) floordiv 8) * 87) floordiv 2) * 1040 + 128)>
#map67 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s1 * 257400 + s2 * 5720 + s3 * 520 + s4 * 260 - (s0 floordiv 32) * 32 - ((s1 * 45 + s2) floordiv 8) * 45240 - ((s1 * 495 + s2 * 11 + s3 - ((s1 * 45 + s2) floordiv 8) * 87) floordiv 2) * 1040 + 160)>
#map68 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s1 * 257400 + s2 * 5720 + s3 * 520 + s4 * 260 - (s0 floordiv 32) * 32 - ((s1 * 45 + s2) floordiv 8) * 45240 - ((s1 * 495 + s2 * 11 + s3 - ((s1 * 45 + s2) floordiv 8) * 87) floordiv 2) * 1040 + 192)>
#map69 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s1 * 257400 + s2 * 5720 + s3 * 520 + s4 * 260 - (s0 floordiv 32) * 32 - ((s1 * 45 + s2) floordiv 8) * 45240 - ((s1 * 495 + s2 * 11 + s3 - ((s1 * 45 + s2) floordiv 8) * 87) floordiv 2) * 1040 + 224)>
#map70 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s1 * 257400 + s2 * 5720 + s3 * 520 + s4 * 260 - (s0 floordiv 32) * 32 - ((s1 * 45 + s2) floordiv 8) * 45240 - ((s1 * 495 + s2 * 11 + s3 - ((s1 * 45 + s2) floordiv 8) * 87) floordiv 2) * 1040 + 256)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %103:9 = scf.for %arg3 = %c0 to %c255 step %c1 iter_args(%arg4 = %cst_2, %arg5 = %cst_2, %arg6 = %cst_2, %arg7 = %cst_2, %arg8 = %cst_2, %arg9 = %cst_2, %arg10 = %cst_2, %arg11 = %cst_2, %arg12 = %cst_2) -> (vector<16xf32>, vector<16xf32>, vector<16xf32>, vector<16xf32>, vector<16xf32>, vector<16xf32>, vector<16xf32>, vector<16xf32>, vector<16xf32>) {
          amdgpu.lds_barrier
        ...
        %180 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<706x1024xf32, strided<[1024, 1], offset: ?>>
        ...
        %base_buffer_9, %offset_10, %sizes_11:2, %strides_12:2 = memref.extract_strided_metadata %180 : memref<706x1024xf32, strided<[1024, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %197 = arith.addi %195, %offset_10 overflow<nsw> : index
        %reinterpret_cast_13 = memref.reinterpret_cast %180 to offset: [%197], sizes: [%c536870910], strides: [1] : memref<706x1024xf32, strided<[1024, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
