...
#map4 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 2 + s1 * 128 - ((s1 * 128 + s0 floordiv 2) floordiv 374) * 374 + (((s2 * 1643524 + s3 * 1282 - ((s2 * 1282 + s3) floordiv 8) * 10255) mod 1288) floordiv s4) * 374)>
#map5 = affine_map<()[s0] -> (s0 * 8 - (s0 floordiv 2) * 16)>
#map6 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 2 + s1 * 128 - ((s1 * 128 + s0 floordiv 2 + 256) floordiv 374) * 374 + (((s2 * 1643524 + s3 * 1282 - ((s2 * 1282 + s3) floordiv 8) * 10255) mod 1288) floordiv s4) * 374 + 256)>
...
#map28 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 187 + (((s1 * 1643524 + s2 * 1282 - ((s1 * 1282 + s2) floordiv 8) * 10255) mod 1288) floordiv s3) * 374)>
#map29 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 1643524 + s1 * 1282 - ((s0 * 1282 + s1) floordiv 8) * 10255) floordiv 1288) * 2576 + (((s0 * 1643524 + s1 * 1282 - ((s0 * 1282 + s1) floordiv 8) * 10255) mod 1288) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4)>
#map30 = affine_map<()[s0, s1, s2] -> (((s0 * 1643524 + s1 * 1282 - ((s0 * 1282 + s1) floordiv 8) * 10255) floordiv 1288) * 2576 + (((s0 * 1643524 + s1 * 1282 - ((s0 * 1282 + s1) floordiv 8) * 10255) mod 1288) mod s2) * 16)>
#map31 = affine_map<()[s0, s1, s2] -> ((((s0 * 1643524 + s1 * 1282 - ((s0 * 1282 + s1) floordiv 8) * 10255) mod 1288) floordiv s2) * 374)>
#map32 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4)>
#map33 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 1643524 + s1 * 1282 - ((s0 * 1282 + s1) floordiv 8) * 10255) floordiv 1288) * 2576 + (((s0 * 1643524 + s1 * 1282 - ((s0 * 1282 + s1) floordiv 8) * 10255) mod 1288) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4 + 1)>
#map34 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map35 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 1643524 + s1 * 1282 - ((s0 * 1282 + s1) floordiv 8) * 10255) floordiv 1288) * 2576 + (((s0 * 1643524 + s1 * 1282 - ((s0 * 1282 + s1) floordiv 8) * 10255) mod 1288) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4 + 2)>
#map36 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map37 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 1643524 + s1 * 1282 - ((s0 * 1282 + s1) floordiv 8) * 10255) floordiv 1288) * 2576 + (((s0 * 1643524 + s1 * 1282 - ((s0 * 1282 + s1) floordiv 8) * 10255) mod 1288) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4 + 3)>
#map38 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map39 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 187 + (((s1 * 1643524 + s2 * 1282 - ((s1 * 1282 + s2) floordiv 8) * 10255) mod 1288) floordiv s3) * 374 + 16)>
#map40 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 187 + (((s1 * 1643524 + s2 * 1282 - ((s1 * 1282 + s2) floordiv 8) * 10255) mod 1288) floordiv s3) * 374 + 32)>
#map41 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 187 + (((s1 * 1643524 + s2 * 1282 - ((s1 * 1282 + s2) floordiv 8) * 10255) mod 1288) floordiv s3) * 374 + 48)>
#map42 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 187 + (((s1 * 1643524 + s2 * 1282 - ((s1 * 1282 + s2) floordiv 8) * 10255) mod 1288) floordiv s3) * 374 + 64)>
#map43 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 187 + (((s1 * 1643524 + s2 * 1282 - ((s1 * 1282 + s2) floordiv 8) * 10255) mod 1288) floordiv s3) * 374 + 80)>
#map44 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 187 + (((s1 * 1643524 + s2 * 1282 - ((s1 * 1282 + s2) floordiv 8) * 10255) mod 1288) floordiv s3) * 374 + 96)>
#map45 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 187 + (((s1 * 1643524 + s2 * 1282 - ((s1 * 1282 + s2) floordiv 8) * 10255) mod 1288) floordiv s3) * 374 + 112)>
#map46 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 187 + (((s1 * 1643524 + s2 * 1282 - ((s1 * 1282 + s2) floordiv 8) * 10255) mod 1288) floordiv s3) * 374 + 128)>
#map47 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 187 + (((s1 * 1643524 + s2 * 1282 - ((s1 * 1282 + s2) floordiv 8) * 10255) mod 1288) floordiv s3) * 374 + 144)>
#map48 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 187 + (((s1 * 1643524 + s2 * 1282 - ((s1 * 1282 + s2) floordiv 8) * 10255) mod 1288) floordiv s3) * 374 + 160)>
#map49 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 187 + (((s1 * 1643524 + s2 * 1282 - ((s1 * 1282 + s2) floordiv 8) * 10255) mod 1288) floordiv s3) * 374 + 176)>
