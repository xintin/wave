...
#map5 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 512 + s2 * 2048 + s3 * 8 - (s0 floordiv 32) * 32 - ((s1 + s2 * 4) floordiv 8) * 4080 - ((s1 * 32 + s2 * 128 - ((s1 + s2 * 4) floordiv 8) * 255) floordiv 64) * 1024)>
#map6 = affine_map<()[s0] -> (((s0 mod 64) floordiv 32) * 8)>
#map7 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + 67)>
#map8 = affine_map<()[s0, s1] -> ((s1 * 128 + s0 floordiv 2) mod 268)>
#map9 = affine_map<()[s0, s1] -> (s1 * 128 + s0 floordiv 2 - ((s1 * 128 + s0 floordiv 2 + 256) floordiv 268) * 268 + 256)>
#map10 = affine_map<()[s0] -> (s0 * 8 + 8)>
#map11 = affine_map<()[s0, s1] -> (s0 + s1 * 8 - (s0 floordiv 32) * 32)>
#map12 = affine_map<()[s0] -> (s0 mod 32 + (s0 floordiv 64) * 67)>
#map13 = affine_map<()[s0] -> (s0 mod 32 + (s0 floordiv 64) * 67 + 32)>
#map14 = affine_map<()[s0] -> (s0 mod 32 + (s0 floordiv 64) * 67 + 64)>
#map15 = affine_map<()[s0, s1] -> (s0 * 16 + s1 * 8 - (s1 floordiv 2) * 16 + 16)>
#map16 = affine_map<()[s0, s1] -> (s0 * 16 + ((s1 mod 64) floordiv 32) * 8 + 16)>
#map17 = affine_map<()[s0, s1] -> (s0 * 268 + (s1 floordiv 64) * 67 + 67)>
#map18 = affine_map<()[s0] -> (s0 * 268 + 268)>
#map19 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4)>
#map20 = affine_map<()[s0, s1] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268)>
#map21 = affine_map<()[s0, s1] -> (s0 * 512 + s1 * 2048 - ((s0 + s1 * 4) floordiv 8) * 4080 - ((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 1024)>
#map22 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4)>
#map23 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 1)>
#map24 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map25 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 2)>
#map26 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map27 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 3)>
#map28 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map29 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 8)>
#map30 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map31 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 9)>
#map32 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map33 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 10)>
#map34 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map35 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 11)>
#map36 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map37 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 16)>
#map38 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map39 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 17)>
#map40 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map41 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 18)>
#map42 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map43 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 19)>
#map44 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map45 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 24)>
#map46 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map47 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 25)>
#map48 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map49 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 26)>
#map50 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map51 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 27)>
#map52 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 27)>
#map53 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 32)>
#map54 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 32)>
#map55 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 33)>
#map56 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 33)>
#map57 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 34)>
#map58 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 34)>
#map59 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 35)>
#map60 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 35)>
#map61 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 40)>
#map62 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 40)>
#map63 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 41)>
#map64 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 41)>
#map65 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 42)>
#map66 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 42)>
#map67 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 43)>
#map68 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 43)>
#map69 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 48)>
#map70 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 48)>
#map71 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 49)>
#map72 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 49)>
#map73 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 50)>
#map74 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 50)>
#map75 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 51)>
#map76 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 51)>
#map77 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 56)>
#map78 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 56)>
#map79 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 57)>
#map80 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 57)>
#map81 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 58)>
#map82 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 58)>
#map83 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 59)>
#map84 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 59)>
#map85 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 64)>
#map86 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 64)>
#map87 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 65)>
#map88 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 65)>
#map89 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 66)>
#map90 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 66)>
#map91 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 67)>
#map92 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 67)>
#map93 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 72)>
#map94 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 72)>
#map95 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 73)>
#map96 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 73)>
#map97 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 74)>
#map98 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 74)>
#map99 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 75)>
#map100 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 75)>
#map101 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 80)>
#map102 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 80)>
#map103 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 81)>
#map104 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 81)>
#map105 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 82)>
#map106 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 82)>
#map107 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 83)>
#map108 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 83)>
#map109 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 88)>
#map110 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 88)>
#map111 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 89)>
#map112 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 89)>
#map113 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 90)>
#map114 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 90)>
#map115 = affine_map<()[s0, s1, s2] -> (((s0 * 32 + s1 * 128 - ((s0 + s1 * 4) floordiv 8) * 255) floordiv 64) * 268 + (s2 floordiv 64) * 67 + ((s2 mod 64) floordiv 32) * 4 + 91)>
#map116 = affine_map<()[s0] -> ((s0 floordiv 64) * 67 + ((s0 mod 64) floordiv 32) * 4 + 91)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %46 = arith.minsi %45, %c268 : index
        %47 = affine.apply #map8()[%thread_id_x, %thread_id_y]
        %48 = arith.cmpi slt, %47, %46 : index
        %49 = vector.broadcast %48 : i1 to vector<8xi1>
        vector.maskedstore %view_3[%47, %4], %49, %14 : memref<268x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        %50 = affine.apply #map9()[%thread_id_x, %thread_id_y]
        %51 = arith.cmpi slt, %50, %46 : index
        %52 = vector.broadcast %51 : i1 to vector<8xi1>
        vector.maskedstore %view_3[%50, %4], %52, %26 : memref<268x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        ...
        %67:3 = scf.for %arg3 = %c0 to %c63 step %c1 iter_args(%arg4 = %cst_2, %arg5 = %cst_2, %arg6 = %cst_2) -> (vector<16xf32>, vector<16xf32>, vector<16xf32>) {
          amdgpu.lds_barrier
          ...
          %491 = vector.maskedload %view_3[%58, %34], %60, %cst : memref<268x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16> into vector<8xf16>
          %492 = vector.maskedload %view_3[%61, %34], %63, %cst : memref<268x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16> into vector<8xf16>
          %493 = vector.maskedload %view_3[%64, %34], %66, %cst : memref<268x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16> into vector<8xf16>
          ...
          amdgpu.lds_barrier
          vector.maskedstore %view_3[%47, %4], %49, %502 : memref<268x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
          vector.maskedstore %view_3[%50, %4], %52, %510 : memref<268x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        ...
        %72 = vector.maskedload %view_3[%69, %34], %71, %cst : memref<268x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16> into vector<8xf16>
        %73 = affine.apply #map13()[%thread_id_x]
        %74 = arith.cmpi slt, %73, %46 : index
        %75 = vector.broadcast %74 : i1 to vector<8xi1>
        %76 = vector.maskedload %view_3[%73, %34], %75, %cst : memref<268x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16> into vector<8xf16>
        %77 = affine.apply #map14()[%thread_id_x]
        %78 = arith.cmpi slt, %77, %46 : index
        %79 = vector.broadcast %78 : i1 to vector<8xi1>
        %80 = vector.maskedload %view_3[%77, %34], %79, %cst : memref<268x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16> into vector<8xf16>
        ...
        %96 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<1024x1024xf32, strided<[1024, 1], offset: ?>>
        ...
        %base_buffer_9, %offset_10, %sizes_11:2, %strides_12:2 = memref.extract_strided_metadata %96 : memref<1024x1024xf32, strided<[1024, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %111 = arith.addi %109, %offset_10 overflow<nsw> : index
        %reinterpret_cast_13 = memref.reinterpret_cast %96 to offset: [%111], sizes: [%c536870910], strides: [1] : memref<1024x1024xf32, strided<[1024, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
