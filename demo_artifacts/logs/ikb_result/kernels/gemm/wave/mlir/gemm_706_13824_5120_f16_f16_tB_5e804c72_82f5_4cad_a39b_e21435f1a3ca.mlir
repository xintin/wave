...
#map3 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 3456 + s2 * 6912 + s3 * 8 - (s0 floordiv 16) * 16 - ((s1 + s2 * 2) floordiv 8) * 27632 - ((s1 * 216 + s2 * 432 - ((s1 + s2 * 2) floordiv 8) * 1727) floordiv 864) * 13824)>
...
#map11 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 90)>
#map12 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 90 + 16)>
#map13 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 90 + 32)>
#map14 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 90 + 48)>
#map15 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 90 + 64)>
#map16 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 90 + 80)>
#map17 = affine_map<()[s0, s1] -> (s0 * 16 + s1 * 8 - (s1 floordiv 2) * 16 + 16)>
#map18 = affine_map<()[s0, s1] -> (s0 * 16 + ((s1 mod 64) floordiv 16) * 4 + 16)>
#map19 = affine_map<()[s0, s1] -> (s0 * 360 + (s1 floordiv 64) * 90 + 90)>
#map20 = affine_map<()[s0] -> (s0 * 360 + 360)>
#map21 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4)>
#map22 = affine_map<()[s0, s1] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360)>
#map23 = affine_map<()[s0, s1] -> (s0 * 3456 + s1 * 6912 - ((s0 + s1 * 2) floordiv 8) * 27632 - ((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 13824)>
#map24 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4)>
#map25 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 1)>
#map26 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map27 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 2)>
#map28 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map29 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 3)>
#map30 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map31 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 16)>
#map32 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 16)>
#map33 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 17)>
#map34 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 17)>
#map35 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 18)>
#map36 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 18)>
#map37 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 19)>
#map38 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 19)>
#map39 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 32)>
#map40 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 32)>
#map41 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 33)>
#map42 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 33)>
#map43 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 34)>
#map44 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 34)>
#map45 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 35)>
#map46 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 35)>
#map47 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 48)>
#map48 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 48)>
#map49 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 49)>
#map50 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 49)>
#map51 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 50)>
#map52 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 50)>
#map53 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 51)>
#map54 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 51)>
#map55 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 64)>
#map56 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 64)>
#map57 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 65)>
#map58 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 65)>
#map59 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 66)>
#map60 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 66)>
#map61 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 67)>
#map62 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 67)>
#map63 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 80)>
#map64 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 80)>
#map65 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 81)>
#map66 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 81)>
#map67 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 82)>
#map68 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 82)>
#map69 = affine_map<()[s0, s1, s2] -> (((s0 * 216 + s1 * 432 - ((s0 + s1 * 2) floordiv 8) * 1727) floordiv 864) * 360 + (s2 floordiv 64) * 90 + ((s2 mod 64) floordiv 16) * 4 + 83)>
#map70 = affine_map<()[s0] -> ((s0 floordiv 64) * 90 + ((s0 mod 64) floordiv 16) * 4 + 83)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %view_5 = memref.view %alloc[%c0][] : memref<15040xi8, #gpu.address_space<workgroup>> to memref<360x20xf16, #gpu.address_space<workgroup>>
        ...
        %33 = arith.muli %28, %c5120 overflow<nsw> : index
        %34 = arith.addi %33, %32 overflow<nsw> : index
        %base_buffer_6, %offset_7, %sizes_8:2, %strides_9:2 = memref.extract_strided_metadata %27 : memref<13824x5120xf16, strided<[5120, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_10 = memref.reinterpret_cast %27 to offset: [%offset_7], sizes: [%c1073741822], strides: [1] : memref<13824x5120xf16, strided<[5120, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        %35 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_10 validBytes(%c2147483645_i32) cacheSwizzleStride(%c5120_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %44 = arith.minsi %43, %c360 : index
        %45 = affine.apply #map7()[%thread_id_x, %thread_id_y]
        %46 = arith.cmpi slt, %45, %44 : index
        %47 = vector.broadcast %46 : i1 to vector<8xi1>
        vector.maskedstore %view_5[%45, %4], %47, %14 : memref<360x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        %48 = affine.apply #map8()[%thread_id_x, %thread_id_y]
        %49 = arith.cmpi slt, %48, %44 : index
        %50 = vector.broadcast %49 : i1 to vector<8xi1>
        vector.maskedstore %view_5[%48, %4], %50, %26 : memref<360x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        ...
        %73:6 = scf.for %arg3 = %c0 to %c319 step %c1 iter_args(%arg4 = %cst_4, %arg5 = %cst_4, %arg6 = %cst_4, %arg7 = %cst_4, %arg8 = %cst_4, %arg9 = %cst_4) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          amdgpu.lds_barrier
          ...
          %309 = vector.maskedload %view_5[%55, %32], %57, %cst : memref<360x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %310 = vector.maskedload %view_5[%58, %32], %60, %cst : memref<360x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %311 = vector.maskedload %view_5[%61, %32], %63, %cst : memref<360x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %312 = vector.maskedload %view_5[%64, %32], %66, %cst : memref<360x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %313 = vector.maskedload %view_5[%67, %32], %69, %cst : memref<360x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %314 = vector.maskedload %view_5[%70, %32], %72, %cst : memref<360x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          ...
          amdgpu.lds_barrier
          vector.maskedstore %view_5[%45, %4], %47, %323 : memref<360x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
          vector.maskedstore %view_5[%48, %4], %50, %331 : memref<360x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        ...
        %78 = vector.maskedload %view_5[%75, %32], %77, %cst : memref<360x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %79 = affine.apply #map12()[%thread_id_x]
        %80 = arith.cmpi slt, %79, %44 : index
        %81 = vector.broadcast %80 : i1 to vector<4xi1>
        %82 = vector.maskedload %view_5[%79, %32], %81, %cst : memref<360x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %83 = affine.apply #map13()[%thread_id_x]
        %84 = arith.cmpi slt, %83, %44 : index
        %85 = vector.broadcast %84 : i1 to vector<4xi1>
        %86 = vector.maskedload %view_5[%83, %32], %85, %cst : memref<360x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %87 = affine.apply #map14()[%thread_id_x]
        %88 = arith.cmpi slt, %87, %44 : index
        %89 = vector.broadcast %88 : i1 to vector<4xi1>
        %90 = vector.maskedload %view_5[%87, %32], %89, %cst : memref<360x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %91 = affine.apply #map15()[%thread_id_x]
        %92 = arith.cmpi slt, %91, %44 : index
        %93 = vector.broadcast %92 : i1 to vector<4xi1>
        %94 = vector.maskedload %view_5[%91, %32], %93, %cst : memref<360x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %95 = affine.apply #map16()[%thread_id_x]
        %96 = arith.cmpi slt, %95, %44 : index
        %97 = vector.broadcast %96 : i1 to vector<4xi1>
        %98 = vector.maskedload %view_5[%95, %32], %97, %cst : memref<360x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        ...
        %106 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<706x13824xf32, strided<[13824, 1], offset: ?>>
        %107 = affine.apply #map19()[%block_id_x, %thread_id_x]
        %108 = affine.apply #map20()[%block_id_x]
        %109 = arith.minsi %107, %108 : index
        %110 = arith.minsi %109, %c706 : index
        ...
        %117 = arith.muli %114, %c13824 overflow<nsw> : index
        %118 = arith.muli %116, %c13824 overflow<nsw> : index
        %119 = arith.addi %117, %115 overflow<nsw> : index
        %120 = arith.addi %118, %51 overflow<nsw> : index
        %base_buffer_11, %offset_12, %sizes_13:2, %strides_14:2 = memref.extract_strided_metadata %106 : memref<706x13824xf32, strided<[13824, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %121 = arith.addi %119, %offset_12 overflow<nsw> : index
        %reinterpret_cast_15 = memref.reinterpret_cast %106 to offset: [%121], sizes: [%c536870910], strides: [1] : memref<706x13824xf32, strided<[13824, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %122 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_15 validBytes(%c2147483643_i32) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
