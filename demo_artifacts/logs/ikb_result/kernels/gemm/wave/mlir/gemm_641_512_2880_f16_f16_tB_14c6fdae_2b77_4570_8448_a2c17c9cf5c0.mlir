...
#map49 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 8 + (((s1 * 196 + s2 * 28 - ((s1 * 7 + s2) floordiv 8) * 223) mod 96) floordiv s3) * 16)>
#map50 = affine_map<()[s0, s1] -> (s0 * 16 + s1 * 8 + 8)>
#map51 = affine_map<()[s0, s1] -> (s0 * 96 + (s1 floordiv 64) * 24 + 24)>
#map52 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 16) * 4)>
...
#map56 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 16) * 4 + 1)>
#map57 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map58 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 16) * 4 + 2)>
#map59 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map60 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 16) * 4 + 3)>
#map61 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map62 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 16) * 4 + 16)>
#map63 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4 + 16)>
#map64 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 16) * 4 + 17)>
#map65 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4 + 17)>
#map66 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 16) * 4 + 18)>
#map67 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4 + 18)>
#map68 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 16) * 4 + 19)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %base_buffer_26, %offset_27, %sizes_28:2, %strides_29:2 = memref.extract_strided_metadata %165 : memref<512x2880xf16, strided<[2880, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_30 = memref.reinterpret_cast %165 to offset: [%offset_27], sizes: [%c1073741822], strides: [1] : memref<512x2880xf16, strided<[2880, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %470 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<641x512xf32, strided<[512, 1], offset: ?>>
        ...
        %482 = arith.muli %479, %c512 overflow<nsw> : index
        %483 = arith.muli %481, %c512 overflow<nsw> : index
        %484 = arith.addi %482, %480 overflow<nsw> : index
        %485 = arith.addi %483, %320 overflow<nsw> : index
        %base_buffer_31, %offset_32, %sizes_33:2, %strides_34:2 = memref.extract_strided_metadata %470 : memref<641x512xf32, strided<[512, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %486 = arith.addi %484, %offset_32 overflow<nsw> : index
        %reinterpret_cast_35 = memref.reinterpret_cast %470 to offset: [%486], sizes: [%c536870910], strides: [1] : memref<641x512xf32, strided<[512, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %487 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_35 validBytes(%c2147483643_i32) cacheSwizzleStride(%c512_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
