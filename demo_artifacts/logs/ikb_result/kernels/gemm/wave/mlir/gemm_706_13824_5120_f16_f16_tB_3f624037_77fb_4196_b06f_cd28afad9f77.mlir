...
#map3 = affine_map<()[s0, s1, s2, s3] -> (s0 mod 32 + (s0 floordiv 64) * 4 + ((s1 * 218700 + s2 * 4860 - ((s1 * 45 + s2) floordiv 8) * 38879) floordiv 38016) * 704 + (((s1 * 218700 + s2 * 4860 - ((s1 * 45 + s2) floordiv 8) * 38879) mod 38016) mod s3) * 16)>
#map4 = affine_map<()[s0] -> (((s0 mod 64) floordiv 32) * 8)>
#map5 = affine_map<()[s0, s1] -> (s0 * 16 + s1 * 8 + 8)>
#map6 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 32 + s4 * 8 + (((s1 * 218700 + s2 * 4860 - ((s1 * 45 + s2) floordiv 8) * 38879) mod 38016) floordiv s3) * 16)>
...
#map12 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4)>
#map13 = affine_map<()[s0, s1, s2] -> (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16)>
#map14 = affine_map<()[s0, s1, s2] -> ((((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) floordiv s2) * 16)>
#map15 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4)>
#map16 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 1)>
#map17 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map18 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 2)>
#map19 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map20 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 3)>
#map21 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map22 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 8)>
#map23 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map24 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 9)>
#map25 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map26 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 10)>
#map27 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map28 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 11)>
#map29 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map30 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 16)>
#map31 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map32 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 17)>
#map33 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map34 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 18)>
#map35 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map36 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 19)>
#map37 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map38 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 24)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map40 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 25)>
#map41 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map42 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 26)>
#map43 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map44 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) floordiv 38016) * 704 + (((s0 * 218700 + s1 * 4860 - ((s0 * 45 + s1) floordiv 8) * 38879) mod 38016) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 27)>
