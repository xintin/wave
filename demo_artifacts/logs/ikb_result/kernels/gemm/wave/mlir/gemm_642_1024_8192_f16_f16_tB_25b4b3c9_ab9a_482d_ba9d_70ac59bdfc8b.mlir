...
#map4 = affine_map<()[s0, s1, s2, s3, s4] -> (s1 * 128 + s4 * 520 + s0 floordiv 2 - ((s1 * 128 + s0 floordiv 2) floordiv 520) * 520 + ((s2 * 41 + s3) floordiv 8) * 520 - ((s4 + (s2 * 41 + s3) floordiv 8) floordiv 2) * 1040)>
#map5 = affine_map<()[s0] -> (s0 * 8 - (s0 floordiv 2) * 16)>
#map6 = affine_map<()[s0, s1, s2, s3, s4] -> (s1 * 128 + s4 * 520 + s0 floordiv 2 - ((s1 * 128 + s0 floordiv 2 + 256) floordiv 520) * 520 + ((s2 * 41 + s3) floordiv 8) * 520 - ((s4 + (s2 * 41 + s3) floordiv 8) floordiv 2) * 1040 + 256)>
#map7 = affine_map<()[s0, s1, s2, s3, s4] -> (s1 * 128 + s4 * 520 + s0 floordiv 2 - ((s1 * 128 + s0 floordiv 2 + 512) floordiv 520) * 520 + ((s2 * 41 + s3) floordiv 8) * 520 - ((s4 + (s2 * 41 + s3) floordiv 8) floordiv 2) * 1040 + 512)>
...
#map35 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s3 * 520 + s4 * 260 - (s0 floordiv 16) * 16 + ((s1 * 41 + s2) floordiv 8) * 520 - ((s3 + (s1 * 41 + s2) floordiv 8) floordiv 2) * 1040)>
#map36 = affine_map<()[s0, s1, s2, s3] -> (s0 * 3280 + s1 * 80 - ((s0 * 41 + s1) floordiv 8) * 640 + ((s2 + (s0 * 41 + s1) floordiv 8) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 16) * 4)>
#map37 = affine_map<()[s0, s1, s2] -> (s0 * 3280 + s1 * 80 - ((s0 * 41 + s1) floordiv 8) * 640 + ((s2 + (s0 * 41 + s1) floordiv 8) floordiv 2) * 16)>
#map38 = affine_map<()[s0, s1, s2] -> (s2 * 520 + ((s0 * 41 + s1) floordiv 8) * 520 - ((s2 + (s0 * 41 + s1) floordiv 8) floordiv 2) * 1040)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4)>
#map40 = affine_map<()[s0, s1, s2, s3] -> (s0 * 3280 + s1 * 80 - ((s0 * 41 + s1) floordiv 8) * 640 + ((s2 + (s0 * 41 + s1) floordiv 8) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 16) * 4 + 1)>
#map41 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map42 = affine_map<()[s0, s1, s2, s3] -> (s0 * 3280 + s1 * 80 - ((s0 * 41 + s1) floordiv 8) * 640 + ((s2 + (s0 * 41 + s1) floordiv 8) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 16) * 4 + 2)>
#map43 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map44 = affine_map<()[s0, s1, s2, s3] -> (s0 * 3280 + s1 * 80 - ((s0 * 41 + s1) floordiv 8) * 640 + ((s2 + (s0 * 41 + s1) floordiv 8) floordiv 2) * 16 + (s3 floordiv 64) * 4 + ((s3 mod 64) floordiv 16) * 4 + 3)>
#map45 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map46 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s3 * 520 + s4 * 260 - (s0 floordiv 16) * 16 + ((s1 * 41 + s2) floordiv 8) * 520 - ((s3 + (s1 * 41 + s2) floordiv 8) floordiv 2) * 1040 + 16)>
#map47 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s3 * 520 + s4 * 260 - (s0 floordiv 16) * 16 + ((s1 * 41 + s2) floordiv 8) * 520 - ((s3 + (s1 * 41 + s2) floordiv 8) floordiv 2) * 1040 + 32)>
#map48 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s3 * 520 + s4 * 260 - (s0 floordiv 16) * 16 + ((s1 * 41 + s2) floordiv 8) * 520 - ((s3 + (s1 * 41 + s2) floordiv 8) floordiv 2) * 1040 + 48)>
#map49 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s3 * 520 + s4 * 260 - (s0 floordiv 16) * 16 + ((s1 * 41 + s2) floordiv 8) * 520 - ((s3 + (s1 * 41 + s2) floordiv 8) floordiv 2) * 1040 + 64)>
#map50 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s3 * 520 + s4 * 260 - (s0 floordiv 16) * 16 + ((s1 * 41 + s2) floordiv 8) * 520 - ((s3 + (s1 * 41 + s2) floordiv 8) floordiv 2) * 1040 + 80)>
#map51 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s3 * 520 + s4 * 260 - (s0 floordiv 16) * 16 + ((s1 * 41 + s2) floordiv 8) * 520 - ((s3 + (s1 * 41 + s2) floordiv 8) floordiv 2) * 1040 + 96)>
#map52 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s3 * 520 + s4 * 260 - (s0 floordiv 16) * 16 + ((s1 * 41 + s2) floordiv 8) * 520 - ((s3 + (s1 * 41 + s2) floordiv 8) floordiv 2) * 1040 + 112)>
#map53 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s3 * 520 + s4 * 260 - (s0 floordiv 16) * 16 + ((s1 * 41 + s2) floordiv 8) * 520 - ((s3 + (s1 * 41 + s2) floordiv 8) floordiv 2) * 1040 + 128)>
#map54 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s3 * 520 + s4 * 260 - (s0 floordiv 16) * 16 + ((s1 * 41 + s2) floordiv 8) * 520 - ((s3 + (s1 * 41 + s2) floordiv 8) floordiv 2) * 1040 + 144)>
#map55 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s3 * 520 + s4 * 260 - (s0 floordiv 16) * 16 + ((s1 * 41 + s2) floordiv 8) * 520 - ((s3 + (s1 * 41 + s2) floordiv 8) floordiv 2) * 1040 + 160)>
#map56 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s3 * 520 + s4 * 260 - (s0 floordiv 16) * 16 + ((s1 * 41 + s2) floordiv 8) * 520 - ((s3 + (s1 * 41 + s2) floordiv 8) floordiv 2) * 1040 + 176)>
#map57 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s3 * 520 + s4 * 260 - (s0 floordiv 16) * 16 + ((s1 * 41 + s2) floordiv 8) * 520 - ((s3 + (s1 * 41 + s2) floordiv 8) floordiv 2) * 1040 + 192)>
#map58 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s3 * 520 + s4 * 260 - (s0 floordiv 16) * 16 + ((s1 * 41 + s2) floordiv 8) * 520 - ((s3 + (s1 * 41 + s2) floordiv 8) floordiv 2) * 1040 + 208)>
#map59 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s3 * 520 + s4 * 260 - (s0 floordiv 16) * 16 + ((s1 * 41 + s2) floordiv 8) * 520 - ((s3 + (s1 * 41 + s2) floordiv 8) floordiv 2) * 1040 + 224)>
#map60 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s3 * 520 + s4 * 260 - (s0 floordiv 16) * 16 + ((s1 * 41 + s2) floordiv 8) * 520 - ((s3 + (s1 * 41 + s2) floordiv 8) floordiv 2) * 1040 + 240)>
#map61 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 + s3 * 520 + s4 * 260 - (s0 floordiv 16) * 16 + ((s1 * 41 + s2) floordiv 8) * 520 - ((s3 + (s1 * 41 + s2) floordiv 8) floordiv 2) * 1040 + 256)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %9 = arith.muli %5, %c8192 overflow<nsw> : index
        ...
        %19 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<1024x8192xf16, strided<[8192, 1], offset: ?>>
        ...
        %24 = arith.muli %20, %c8192 overflow<nsw> : index
        %25 = arith.addi %24, %23 overflow<nsw> : index
        %base_buffer_6, %offset_7, %sizes_8:2, %strides_9:2 = memref.extract_strided_metadata %19 : memref<1024x8192xf16, strided<[8192, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_10 = memref.reinterpret_cast %19 to offset: [%offset_7], sizes: [%c1073741822], strides: [1] : memref<1024x8192xf16, strided<[8192, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        %26 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_10 validBytes(%c2147483645_i32) cacheSwizzleStride(%c-8192_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %37 = arith.muli %34, %c8192 overflow<nsw> : index
        ...
        %49 = arith.muli %46, %c8192 overflow<nsw> : index
        ...
        %125:17 = scf.for %arg3 = %c0 to %c511 step %c1 iter_args(%arg4 = %cst_4, %arg5 = %cst_4, %arg6 = %cst_4, %arg7 = %cst_4, %arg8 = %cst_4, %arg9 = %cst_4, %arg10 = %cst_4, %arg11 = %cst_4, %arg12 = %cst_4, %arg13 = %cst_4, %arg14 = %cst_4, %arg15 = %cst_4, %arg16 = %cst_4, %arg17 = %cst_4, %arg18 = %cst_4, %arg19 = %cst_4, %arg20 = %cst_4) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          amdgpu.lds_barrier
        ...
        %213 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<642x1024xf32, strided<[1024, 1], offset: ?>>
        ...
        %base_buffer_11, %offset_12, %sizes_13:2, %strides_14:2 = memref.extract_strided_metadata %213 : memref<642x1024xf32, strided<[1024, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %230 = arith.addi %228, %offset_12 overflow<nsw> : index
        %reinterpret_cast_15 = memref.reinterpret_cast %213 to offset: [%230], sizes: [%c536870910], strides: [1] : memref<642x1024xf32, strided<[1024, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
