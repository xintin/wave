...
#map3 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 8 + (((s1 * 3136 + s2 * 448 - ((s1 * 7 + s2) floordiv 8) * 3583) mod 1536) floordiv s3) * 16)>
...
#map15 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) floordiv 1536) * 288 + (((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) mod 1536) mod s2) * 96 + ((s3 mod 64) floordiv 16) * 4)>
#map16 = affine_map<()[s0, s1, s2] -> (((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) floordiv 1536) * 288 + (((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) mod 1536) mod s2) * 96)>
#map17 = affine_map<()[s0, s1, s2] -> ((((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) mod 1536) floordiv s2) * 16)>
#map18 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4)>
#map19 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) floordiv 1536) * 288 + (((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) mod 1536) mod s2) * 96 + ((s3 mod 64) floordiv 16) * 4 + 1)>
#map20 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map21 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) floordiv 1536) * 288 + (((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) mod 1536) mod s2) * 96 + ((s3 mod 64) floordiv 16) * 4 + 2)>
#map22 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map23 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) floordiv 1536) * 288 + (((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) mod 1536) mod s2) * 96 + ((s3 mod 64) floordiv 16) * 4 + 3)>
#map24 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map25 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) floordiv 1536) * 288 + (((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) mod 1536) mod s2) * 96 + ((s3 mod 64) floordiv 16) * 4 + 16)>
#map26 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4 + 16)>
#map27 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) floordiv 1536) * 288 + (((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) mod 1536) mod s2) * 96 + ((s3 mod 64) floordiv 16) * 4 + 17)>
#map28 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4 + 17)>
#map29 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) floordiv 1536) * 288 + (((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) mod 1536) mod s2) * 96 + ((s3 mod 64) floordiv 16) * 4 + 18)>
#map30 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4 + 18)>
#map31 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) floordiv 1536) * 288 + (((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) mod 1536) mod s2) * 96 + ((s3 mod 64) floordiv 16) * 4 + 19)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %62 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<642x8192xf32, strided<[8192, 1], offset: ?>>
        ...
        %72 = arith.muli %70, %c8192 overflow<nsw> : index
        %73 = arith.addi %71, %69 overflow<nsw> : index
        %74 = arith.addi %72, %39 overflow<nsw> : index
        %base_buffer_11, %offset_12, %sizes_13:2, %strides_14:2 = memref.extract_strided_metadata %62 : memref<642x8192xf32, strided<[8192, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %75 = arith.addi %73, %offset_12 overflow<nsw> : index
        %reinterpret_cast_15 = memref.reinterpret_cast %62 to offset: [%75], sizes: [%c536870910], strides: [1] : memref<642x8192xf32, strided<[8192, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %76 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_15 validBytes(%c2147483643_i32) cacheSwizzleStride(%c-8192_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
