...
module attributes {transform.with_named_sequence} {
  ...
  func.func @isolated_benchmark(%arg0: tensor<5120x8192xf16>, %arg1: tensor<14336x8192xf16>, %arg2: tensor<5120x14336xf32>) -> tensor<5120x14336xf32> {
    %0 = flow.dispatch @gemm::@gemm(%arg0, %arg1, %arg2) : (tensor<5120x8192xf16>, tensor<14336x8192xf16>, tensor<5120x14336xf32>) -> %arg2
