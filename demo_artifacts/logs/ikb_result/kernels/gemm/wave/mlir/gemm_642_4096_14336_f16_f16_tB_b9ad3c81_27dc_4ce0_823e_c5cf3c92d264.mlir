...
#map1 = affine_map<()[s0, s1, s2] -> (s0 mod 16 + ((s1 * 53792 + s2 * 1312 - ((s1 * 41 + s2) floordiv 8) * 10495) floordiv 256) * 16 + (s0 floordiv 64) * 4)>
#map2 = affine_map<()[s0] -> (((s0 mod 64) floordiv 16) * 4)>
#map3 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 860672 + s2 * 20992 + s3 * 8 - (s0 floordiv 16) * 16 - ((s1 * 41 + s2) floordiv 8) * 167920 - ((s1 * 53792 + s2 * 1312 - ((s1 * 41 + s2) floordiv 8) * 10495) floordiv 256) * 4096)>
...
#map10 = affine_map<()[s0, s1, s2] -> (((s0 * 53792 + s1 * 1312 - ((s0 * 41 + s1) floordiv 8) * 10495) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4)>
#map11 = affine_map<()[s0, s1] -> (((s0 * 53792 + s1 * 1312 - ((s0 * 41 + s1) floordiv 8) * 10495) floordiv 256) * 16)>
#map12 = affine_map<()[s0, s1] -> (s0 * 860672 + s1 * 20992 - ((s0 * 41 + s1) floordiv 8) * 167920 - ((s0 * 53792 + s1 * 1312 - ((s0 * 41 + s1) floordiv 8) * 10495) floordiv 256) * 4096)>
#map13 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4)>
#map14 = affine_map<()[s0, s1, s2] -> (((s0 * 53792 + s1 * 1312 - ((s0 * 41 + s1) floordiv 8) * 10495) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4 + 1)>
#map15 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map16 = affine_map<()[s0, s1, s2] -> (((s0 * 53792 + s1 * 1312 - ((s0 * 41 + s1) floordiv 8) * 10495) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4 + 2)>
#map17 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map18 = affine_map<()[s0, s1, s2] -> (((s0 * 53792 + s1 * 1312 - ((s0 * 41 + s1) floordiv 8) * 10495) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4 + 3)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %22 = arith.muli %18, %c14336 overflow<nsw> : index
        ...
        %41 = scf.for %arg3 = %c0 to %c895 step %c1 iter_args(%arg4 = %cst_2) -> (vector<4xf32>) {
          amdgpu.lds_barrier
        ...
        %46 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<642x4096xf32, strided<[4096, 1], offset: ?>>
        ...
        %base_buffer_9, %offset_10, %sizes_11:2, %strides_12:2 = memref.extract_strided_metadata %46 : memref<642x4096xf32, strided<[4096, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %57 = arith.addi %55, %offset_10 overflow<nsw> : index
        %reinterpret_cast_13 = memref.reinterpret_cast %46 to offset: [%57], sizes: [%c536870910], strides: [1] : memref<642x4096xf32, strided<[4096, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
