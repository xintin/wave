...
#map2 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 50176 + s2 * 7168 + s3 * 8 - (s0 floordiv 16) * 16 - ((s1 * 7 + s2) floordiv 8) * 57328 - ((s1 * 3136 + s2 * 448 - ((s1 * 7 + s2) floordiv 8) * 3583) floordiv 512) * 8192)>
...
#map14 = affine_map<()[s0, s1, s2] -> (((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) floordiv 512) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 16) * 4)>
#map15 = affine_map<()[s0, s1] -> (((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) floordiv 512) * 96)>
#map16 = affine_map<()[s0, s1] -> (s0 * 50176 + s1 * 7168 - ((s0 * 7 + s1) floordiv 8) * 57328 - ((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) floordiv 512) * 8192)>
#map17 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4)>
#map18 = affine_map<()[s0, s1, s2] -> (((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) floordiv 512) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 16) * 4 + 1)>
#map19 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map20 = affine_map<()[s0, s1, s2] -> (((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) floordiv 512) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 16) * 4 + 2)>
#map21 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map22 = affine_map<()[s0, s1, s2] -> (((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) floordiv 512) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 16) * 4 + 3)>
#map23 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map24 = affine_map<()[s0, s1, s2] -> (((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) floordiv 512) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 16) * 4 + 16)>
#map25 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4 + 16)>
#map26 = affine_map<()[s0, s1, s2] -> (((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) floordiv 512) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 16) * 4 + 17)>
#map27 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4 + 17)>
#map28 = affine_map<()[s0, s1, s2] -> (((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) floordiv 512) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 16) * 4 + 18)>
#map29 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 16) * 4 + 18)>
#map30 = affine_map<()[s0, s1, s2] -> (((s0 * 3136 + s1 * 448 - ((s0 * 7 + s1) floordiv 8) * 3583) floordiv 512) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 16) * 4 + 19)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %46:2 = scf.for %arg3 = %c0 to %c1791 step %c1 iter_args(%arg4 = %cst_4, %arg5 = %cst_4) -> (vector<4xf32>, vector<4xf32>) {
          amdgpu.lds_barrier
        ...
        %69 = arith.muli %67, %c8192 overflow<nsw> : index
        %70 = arith.addi %68, %66 overflow<nsw> : index
        %71 = arith.addi %69, %36 overflow<nsw> : index
        %base_buffer_11, %offset_12, %sizes_13:2, %strides_14:2 = memref.extract_strided_metadata %59 : memref<642x8192xf32, strided<[8192, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %72 = arith.addi %70, %offset_12 overflow<nsw> : index
        %reinterpret_cast_15 = memref.reinterpret_cast %59 to offset: [%72], sizes: [%c536870910], strides: [1] : memref<642x8192xf32, strided<[8192, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %73 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_15 validBytes(%c2147483643_i32) cacheSwizzleStride(%c-8192_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %80 = arith.muli %79, %c8192 overflow<nsw> : index
        ...
        %88 = arith.muli %87, %c8192 overflow<nsw> : index
