...
#map1 = affine_map<()[s0, s1, s2] -> (((s0 * 1080 + s1 * 40 + s2 - ((s0 * 27 + s1) floordiv 8) * 319) floordiv 96) * -8 + 27)>
#map2 = affine_map<()[s0, s1, s2, s3, s4, s5, s6] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8) floordiv 128) * 128 + ((s2 * 1080 + s3 * 40 + s4 - ((s2 * 27 + s3) floordiv 8) * 319) floordiv 96) * 1024 + (((s2 * 1080 + s3 * 40 + s5 - ((s2 * 27 + s3) floordiv 8) * 319) mod 96) mod s6) * 128)>
#map3 = affine_map<()[s0] -> (s0 * 8 - (s0 floordiv 8) * 64)>
#map4 = affine_map<()[s0, s1, s2, s3, s4, s5, s6] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 128) * 128 + ((s2 * 1080 + s3 * 40 + s4 - ((s2 * 27 + s3) floordiv 8) * 319) floordiv 96) * 1024 + (((s2 * 1080 + s3 * 40 + s5 - ((s2 * 27 + s3) floordiv 8) * 319) mod 96) mod s6) * 128 + 64)>
#map5 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8) floordiv 256) * 256 + (((s2 * 1080 + s3 * 40 + s4 - ((s2 * 27 + s3) floordiv 8) * 319) mod 96) floordiv s5) * 256)>
#map6 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 256) * 256 + (((s2 * 1080 + s3 * 40 + s4 - ((s2 * 27 + s3) floordiv 8) * 319) mod 96) floordiv s5) * 256 + 64)>
#map7 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 128) floordiv 256) * 256 + (((s2 * 1080 + s3 * 40 + s4 - ((s2 * 27 + s3) floordiv 8) * 319) mod 96) floordiv s5) * 256 + 128)>
#map8 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 192) floordiv 256) * 256 + (((s2 * 1080 + s3 * 40 + s4 - ((s2 * 27 + s3) floordiv 8) * 319) mod 96) floordiv s5) * 256 + 192)>
...
#map31 = affine_map<()[s0, s1, s2, s3, s4] -> (((s0 * 1080 + s1 * 40 + s2 - ((s0 * 27 + s1) floordiv 8) * 319) floordiv 96) * 1024 + (((s0 * 1080 + s1 * 40 + s3 - ((s0 * 27 + s1) floordiv 8) * 319) mod 96) mod s4) * 128)>
#map32 = affine_map<()[s0, s1, s2, s3] -> ((((s0 * 1080 + s1 * 40 + s2 - ((s0 * 27 + s1) floordiv 8) * 319) mod 96) floordiv s3) * 256)>
...
module attributes {transform.with_named_sequence} {
  stream.executable private @gemm {
    stream.executable.export public @gemm workgroups() -> (index, index, index) {
      ...
      stream.return %c27, %c12, %c1 : index, index, index
    }
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %16 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<3072x5120xf16, strided<[5120, 1], offset: ?>>
        ...
        %base_buffer_1, %offset_2, %sizes_3:2, %strides_4:2 = memref.extract_strided_metadata %16 : memref<3072x5120xf16, strided<[5120, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_5 = memref.reinterpret_cast %16 to offset: [%offset_2], sizes: [%c1073741822], strides: [1] : memref<3072x5120xf16, strided<[5120, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %58:16 = scf.for %arg3 = %c0 to %c79 step %c1 iter_args(%arg4 = %cst, %arg5 = %cst, %arg6 = %cst, %arg7 = %cst, %arg8 = %cst, %arg9 = %cst, %arg10 = %cst, %arg11 = %cst, %arg12 = %cst, %arg13 = %cst, %arg14 = %cst, %arg15 = %cst, %arg16 = %cst, %arg17 = %cst, %arg18 = %cst, %arg19 = %cst) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          ...
          vector.store %380, %view[%38, %7] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %376, %view[%36, %7] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %378, %view[%39, %7] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          rocdl.s.barrier
          llvm.call_intrinsic "llvm.amdgcn.sched.barrier"(%c0_i32) : (i32) -> ()
          rocdl.s.setprio 1
        ...
        %178 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<3456x3072xf32, strided<[3072, 1], offset: ?>>
        ...
        %182 = arith.muli %179, %c3072 overflow<nsw> : index
        %183 = arith.muli %181, %c3072 overflow<nsw> : index
        %184 = arith.addi %182, %180 overflow<nsw> : index
        %185 = arith.addi %183, %59 overflow<nsw> : index
        %base_buffer_6, %offset_7, %sizes_8:2, %strides_9:2 = memref.extract_strided_metadata %178 : memref<3456x3072xf32, strided<[3072, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %186 = arith.addi %184, %offset_7 overflow<nsw> : index
        %reinterpret_cast_10 = memref.reinterpret_cast %178 to offset: [%186], sizes: [%c536870910], strides: [1] : memref<3456x3072xf32, strided<[3072, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %187 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_10 validBytes(%c2147483643_i32) cacheSwizzleStride(%c3072_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %190 = arith.muli %189, %c3072 overflow<nsw> : index
        ...
        %194 = arith.muli %193, %c3072 overflow<nsw> : index
        ...
        %198 = arith.muli %197, %c3072 overflow<nsw> : index
        ...
        %258 = arith.muli %257, %c3072 overflow<nsw> : index
        ...
        %262 = arith.muli %261, %c3072 overflow<nsw> : index
        ...
        %266 = arith.muli %265, %c3072 overflow<nsw> : index
        ...
        %270 = arith.muli %269, %c3072 overflow<nsw> : index
  ...
  func.func @isolated_benchmark(%arg0: tensor<3456x5120xf16>, %arg1: tensor<3072x5120xf16>, %arg2: tensor<3456x3072xf32>) -> tensor<3456x3072xf32> {
    %0 = flow.dispatch @gemm::@gemm(%arg0, %arg1, %arg2) : (tensor<3456x5120xf16>, tensor<3072x5120xf16>, tensor<3456x3072xf32>) -> %arg2
    return %0 : tensor<3456x3072xf32>
  }
}
