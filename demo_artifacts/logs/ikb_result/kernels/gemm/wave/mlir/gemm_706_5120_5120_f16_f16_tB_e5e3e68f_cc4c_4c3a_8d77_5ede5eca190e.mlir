#map = affine_map<()[s0, s1, s2] -> ((s0 floordiv 16) mod 16 + ((s1 * 81000 + s2 * 1800 - ((s1 * 45 + s2) floordiv 8) * 14399) floordiv 320) * 16)>
#map1 = affine_map<()[s0] -> (s0 mod 16)>
#map2 = affine_map<()[s0, s1, s2] -> (s1 * 1296000 + s2 * 28800 + (s0 floordiv 16) mod 16 - ((s1 * 45 + s2) floordiv 8) * 230384 - ((s1 * 81000 + s2 * 1800 - ((s1 * 45 + s2) floordiv 8) * 14399) floordiv 320) * 5120)>
...
#map13 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 1296000 + s2 * 28800 + s3 * 8 - (s0 floordiv 32) * 32 - ((s1 * 45 + s2) floordiv 8) * 230384 - ((s1 * 81000 + s2 * 1800 - ((s1 * 45 + s2) floordiv 8) * 14399) floordiv 320) * 5120)>
#map14 = affine_map<()[s0, s1] -> (s0 * 16 + (s1 floordiv 64) * 4 + 4)>
#map15 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4)>
#map16 = affine_map<()[s0, s1] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16)>
#map17 = affine_map<()[s0, s1] -> (s0 * 1296000 + s1 * 28800 - ((s0 * 45 + s1) floordiv 8) * 230384 - ((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 5120)>
#map18 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4)>
#map19 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 1)>
#map20 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map21 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 2)>
#map22 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map23 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 3)>
#map24 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map25 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 8)>
#map26 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map27 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 9)>
#map28 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map29 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 10)>
#map30 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map31 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 11)>
#map32 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map33 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 16)>
#map34 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map35 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 17)>
#map36 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map37 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 18)>
#map38 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map39 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 19)>
#map40 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map41 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 24)>
#map42 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map43 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 25)>
#map44 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map45 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 26)>
#map46 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map47 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 320) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 27)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %4 = arith.muli %1, %c5120 overflow<nsw> : index
        ...
        %6 = amdgpu.fat_raw_buffer_cast %reinterpret_cast validBytes(%c2147483645_i32) cacheSwizzleStride(%c5120_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        %7 = arith.select %2, %5, %c1073741823 : index
        %8 = vector.load %6[%7] : memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>, vector<1xf16>
        %9 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<5120x5120xf16, strided<[5120, 1], offset: ?>>
        ...
        %base_buffer_2, %offset_3, %sizes_4:2, %strides_5:2 = memref.extract_strided_metadata %9 : memref<5120x5120xf16, strided<[5120, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_6 = memref.reinterpret_cast %9 to offset: [%offset_3], sizes: [%c1073741822], strides: [1] : memref<5120x5120xf16, strided<[5120, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        %13 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_6 validBytes(%c2147483645_i32) cacheSwizzleStride(%c5120_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %32 = scf.for %arg3 = %c0 to %c319 step %c1 iter_args(%arg4 = %cst_0) -> (vector<16xf32>) {
          amdgpu.lds_barrier
        ...
        %48 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<706x5120xf32, strided<[5120, 1], offset: ?>>
        ...
        %64 = arith.muli %61, %c5120 overflow<nsw> : index
        %65 = arith.muli %63, %c5120 overflow<nsw> : index
        %66 = arith.addi %64, %62 overflow<nsw> : index
        %67 = arith.addi %65, %33 overflow<nsw> : index
        %base_buffer_7, %offset_8, %sizes_9:2, %strides_10:2 = memref.extract_strided_metadata %48 : memref<706x5120xf32, strided<[5120, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %68 = arith.addi %66, %offset_8 overflow<nsw> : index
        %reinterpret_cast_11 = memref.reinterpret_cast %48 to offset: [%68], sizes: [%c536870910], strides: [1] : memref<706x5120xf32, strided<[5120, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %69 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_11 validBytes(%c2147483643_i32) cacheSwizzleStride(%c5120_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %76 = arith.muli %75, %c5120 overflow<nsw> : index
        ...
        %84 = arith.muli %83, %c5120 overflow<nsw> : index
        ...
        %92 = arith.muli %91, %c5120 overflow<nsw> : index
        ...
        %100 = arith.muli %99, %c5120 overflow<nsw> : index
        ...
        %108 = arith.muli %107, %c5120 overflow<nsw> : index
        ...
        %116 = arith.muli %115, %c5120 overflow<nsw> : index
        ...
        %124 = arith.muli %123, %c5120 overflow<nsw> : index
        ...
        %132 = arith.muli %131, %c5120 overflow<nsw> : index
        ...
        %140 = arith.muli %139, %c5120 overflow<nsw> : index
        ...
        %148 = arith.muli %147, %c5120 overflow<nsw> : index
