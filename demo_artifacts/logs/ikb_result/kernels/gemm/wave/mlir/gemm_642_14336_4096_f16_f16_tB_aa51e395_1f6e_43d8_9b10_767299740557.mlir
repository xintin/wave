...
#map1 = affine_map<()[s0, s1, s2] -> (s0 mod 32 + ((s1 * 5488 + s2 * 784 - ((s1 * 7 + s2) floordiv 8) * 6271) floordiv 896) * 96 + (s0 floordiv 64) * 24)>
#map2 = affine_map<()[s0] -> (((s0 mod 64) floordiv 32) * 8)>
#map3 = affine_map<()[s0, s1] -> (s0 * 16 + s1 * 8 + 8)>
#map4 = affine_map<()[s0] -> (s0 * 16 + 16)>
#map5 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 87808 + s2 * 12544 + s3 * 8 - (s0 floordiv 32) * 32 - ((s1 * 7 + s2) floordiv 8) * 100336 - ((s1 * 5488 + s2 * 784 - ((s1 * 7 + s2) floordiv 8) * 6271) floordiv 896) * 14336)>
...
#map11 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4)>
#map12 = affine_map<()[s0, s1] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 96)>
#map13 = affine_map<()[s0, s1] -> (s0 * 87808 + s1 * 12544 - ((s0 * 7 + s1) floordiv 8) * 100336 - ((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 14336)>
#map14 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4)>
#map15 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 1)>
#map16 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map17 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 2)>
#map18 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map19 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 3)>
#map20 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map21 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 8)>
#map22 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map23 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 9)>
#map24 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map25 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 10)>
#map26 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map27 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 11)>
#map28 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map29 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 16)>
#map30 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map31 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 17)>
#map32 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map33 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 18)>
#map34 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map35 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 19)>
#map36 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map37 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 24)>
#map38 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map39 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 25)>
#map40 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map41 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 26)>
#map42 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map43 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 96 + (s2 floordiv 64) * 24 + ((s2 mod 64) floordiv 32) * 4 + 27)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %44 = scf.for %arg3 = %c0 to %c255 step %c1 iter_args(%arg4 = %cst_2) -> (vector<16xf32>) {
          amdgpu.lds_barrier
        ...
        %54 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<642x14336xf32, strided<[14336, 1], offset: ?>>
        ...
        %61 = arith.muli %58, %c14336 overflow<nsw> : index
        %62 = arith.muli %60, %c14336 overflow<nsw> : index
        %63 = arith.addi %61, %59 overflow<nsw> : index
        %64 = arith.addi %62, %41 overflow<nsw> : index
        %base_buffer_9, %offset_10, %sizes_11:2, %strides_12:2 = memref.extract_strided_metadata %54 : memref<642x14336xf32, strided<[14336, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %65 = arith.addi %63, %offset_10 overflow<nsw> : index
        %reinterpret_cast_13 = memref.reinterpret_cast %54 to offset: [%65], sizes: [%c536870910], strides: [1] : memref<642x14336xf32, strided<[14336, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        ...
        %73 = arith.muli %72, %c14336 overflow<nsw> : index
        ...
        %81 = arith.muli %80, %c14336 overflow<nsw> : index
        ...
        %89 = arith.muli %88, %c14336 overflow<nsw> : index
