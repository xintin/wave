...
#map16 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 26 + ((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 2688) * 312 + (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) mod 2688) mod s2) * 104 + ((s3 mod 64) floordiv 16) * 4)>
#map17 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 2688) * 312 + (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) mod 2688) mod s2) * 104)>
#map18 = affine_map<()[s0, s1, s2] -> ((((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) mod 2688) floordiv s2) * 16)>
#map19 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 16) * 4)>
#map20 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 26 + ((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 2688) * 312 + (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) mod 2688) mod s2) * 104 + ((s3 mod 64) floordiv 16) * 4 + 1)>
#map21 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map22 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 26 + ((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 2688) * 312 + (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) mod 2688) mod s2) * 104 + ((s3 mod 64) floordiv 16) * 4 + 2)>
#map23 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map24 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 26 + ((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 2688) * 312 + (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) mod 2688) mod s2) * 104 + ((s3 mod 64) floordiv 16) * 4 + 3)>
#map25 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map26 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 26 + ((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 2688) * 312 + (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) mod 2688) mod s2) * 104 + ((s3 mod 64) floordiv 16) * 4 + 16)>
#map27 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 16) * 4 + 16)>
#map28 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 26 + ((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 2688) * 312 + (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) mod 2688) mod s2) * 104 + ((s3 mod 64) floordiv 16) * 4 + 17)>
#map29 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 16) * 4 + 17)>
#map30 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 26 + ((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 2688) * 312 + (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) mod 2688) mod s2) * 104 + ((s3 mod 64) floordiv 16) * 4 + 18)>
#map31 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 16) * 4 + 18)>
#map32 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 26 + ((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 2688) * 312 + (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) mod 2688) mod s2) * 104 + ((s3 mod 64) floordiv 16) * 4 + 19)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %49:2 = scf.for %arg3 = %c0 to %c255 step %c1 iter_args(%arg4 = %cst_2, %arg5 = %cst_2) -> (vector<4xf32>, vector<4xf32>) {
          amdgpu.lds_barrier
        ...
        %62 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<706x14336xf32, strided<[14336, 1], offset: ?>>
        ...
        %base_buffer_9, %offset_10, %sizes_11:2, %strides_12:2 = memref.extract_strided_metadata %62 : memref<706x14336xf32, strided<[14336, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %77 = arith.addi %75, %offset_10 overflow<nsw> : index
        %reinterpret_cast_13 = memref.reinterpret_cast %62 to offset: [%77], sizes: [%c536870910], strides: [1] : memref<706x14336xf32, strided<[14336, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
