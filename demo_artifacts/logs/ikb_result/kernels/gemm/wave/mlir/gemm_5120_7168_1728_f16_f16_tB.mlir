#map = affine_map<()[s0, s1] -> (((s0 * 5 + s1 * 140 - (s1 floordiv 8) * 1119) floordiv 224) * -8 + 40)>
#map1 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8) floordiv 128) * 128 + ((s2 * 5 + s3 * 140 - (s3 floordiv 8) * 1119) floordiv 224) * 1024 + (((s2 * 5 + s3 * 140 - (s3 floordiv 8) * 1119) mod 224) mod s4) * 128)>
#map2 = affine_map<()[s0] -> (s0 * 8 - (s0 floordiv 8) * 64)>
#map3 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 128) * 128 + ((s2 * 5 + s3 * 140 - (s3 floordiv 8) * 1119) floordiv 224) * 1024 + (((s2 * 5 + s3 * 140 - (s3 floordiv 8) * 1119) mod 224) mod s4) * 128 + 64)>
#map4 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8) floordiv 256) * 256 + (((s2 * 140 + s3 * 5 - (s2 floordiv 8) * 1119) mod 224) floordiv s4) * 256)>
#map5 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 256) * 256 + (((s2 * 140 + s3 * 5 - (s2 floordiv 8) * 1119) mod 224) floordiv s4) * 256 + 64)>
#map6 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 128) floordiv 256) * 256 + (((s2 * 140 + s3 * 5 - (s2 floordiv 8) * 1119) mod 224) floordiv s4) * 256 + 128)>
#map7 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 192) floordiv 256) * 256 + (((s2 * 140 + s3 * 5 - (s2 floordiv 8) * 1119) mod 224) floordiv s4) * 256 + 192)>
...
#map30 = affine_map<()[s0, s1, s2] -> (((s0 * 5 + s1 * 140 - (s1 floordiv 8) * 1119) floordiv 224) * 1024 + (((s0 * 5 + s1 * 140 - (s1 floordiv 8) * 1119) mod 224) mod s2) * 128)>
#map31 = affine_map<()[s0, s1, s2] -> ((((s0 * 140 + s1 * 5 - (s0 floordiv 8) * 1119) mod 224) floordiv s2) * 256)>
...
module attributes {transform.with_named_sequence} {
  stream.executable private @gemm {
    stream.executable.export public @gemm workgroups() -> (index, index, index) {
      ...
      stream.return %c40, %c28, %c1 : index, index, index
    }
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        %c7168_i14 = arith.constant 7168 : i14
        %c4_i32 = arith.constant 4 : i32
        %c1728_i14 = arith.constant 1728 : i14
        ...
        %block_id_x = gpu.block_id  x upper_bound 40
        ...
        %0 = stream.binding.subspan %arg0[%c0] : !stream.binding -> memref<5120x1728xf16, strided<[1728, 1], offset: ?>>
        ...
        %6 = arith.muli %4, %c1728 overflow<nsw> : index
        %7 = arith.addi %6, %5 overflow<nsw> : index
        %base_buffer, %offset, %sizes:2, %strides:2 = memref.extract_strided_metadata %0 : memref<5120x1728xf16, strided<[1728, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast = memref.reinterpret_cast %0 to offset: [%offset], sizes: [%c1073741822], strides: [1] : memref<5120x1728xf16, strided<[1728, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        %8 = amdgpu.fat_raw_buffer_cast %reinterpret_cast validBytes(%c2147483645_i32) cacheSwizzleStride(%c1728_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %11 = arith.muli %10, %c1728 overflow<nsw> : index
        %12 = arith.addi %11, %5 overflow<nsw> : index
        %13 = vector.load %8[%12] : memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>, vector<8xf16>
        %14 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<7168x1728xf16, strided<[1728, 1], offset: ?>>
        %15 = affine.apply #map4()[%thread_id_x, %thread_id_y, %block_id_x, %block_id_y, %3]
        %16 = arith.muli %15, %c1728 overflow<nsw> : index
        %17 = arith.addi %16, %5 overflow<nsw> : index
        %base_buffer_1, %offset_2, %sizes_3:2, %strides_4:2 = memref.extract_strided_metadata %14 : memref<7168x1728xf16, strided<[1728, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_5 = memref.reinterpret_cast %14 to offset: [%offset_2], sizes: [%c1073741822], strides: [1] : memref<7168x1728xf16, strided<[1728, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        %18 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_5 validBytes(%c2147483645_i32) cacheSwizzleStride(%c1728_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %21 = arith.muli %20, %c1728 overflow<nsw> : index
        ...
        %25 = arith.muli %24, %c1728 overflow<nsw> : index
        ...
        %29 = arith.muli %28, %c1728 overflow<nsw> : index
        ...
        %56:16 = scf.for %arg3 = %c0 to %c26 step %c1 iter_args(%arg4 = %cst, %arg5 = %cst, %arg6 = %cst, %arg7 = %cst, %arg8 = %cst, %arg9 = %cst, %arg10 = %cst, %arg11 = %cst, %arg12 = %cst, %arg13 = %cst, %arg14 = %cst, %arg15 = %cst, %arg16 = %cst, %arg17 = %cst, %arg18 = %cst, %arg19 = %cst) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
        ...
        %176 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<5120x7168xf32, strided<[7168, 1], offset: ?>>
        ...
        %base_buffer_6, %offset_7, %sizes_8:2, %strides_9:2 = memref.extract_strided_metadata %176 : memref<5120x7168xf32, strided<[7168, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %184 = arith.addi %182, %offset_7 overflow<nsw> : index
        %reinterpret_cast_10 = memref.reinterpret_cast %176 to offset: [%184], sizes: [%c536870910], strides: [1] : memref<5120x7168xf32, strided<[7168, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
  ...
  func.func @isolated_benchmark(%arg0: tensor<5120x1728xf16>, %arg1: tensor<7168x1728xf16>, %arg2: tensor<5120x7168xf32>) -> tensor<5120x7168xf32> {
    %0 = flow.dispatch @gemm::@gemm(%arg0, %arg1, %arg2) : (tensor<5120x1728xf16>, tensor<7168x1728xf16>, tensor<5120x7168xf32>) -> %arg2
    return %0 : tensor<5120x7168xf32>
  }
}
