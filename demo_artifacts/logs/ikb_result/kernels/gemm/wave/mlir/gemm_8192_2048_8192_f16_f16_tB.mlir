...
module attributes {transform.with_named_sequence} {
  ...
  func.func @isolated_benchmark(%arg0: tensor<8192x8192xf16>, %arg1: tensor<2048x8192xf16>, %arg2: tensor<8192x2048xf32>) -> tensor<8192x2048xf32> {
    %0 = flow.dispatch @gemm::@gemm(%arg0, %arg1, %arg2) : (tensor<8192x8192xf16>, tensor<2048x8192xf16>, tensor<8192x2048xf32>) -> %arg2
