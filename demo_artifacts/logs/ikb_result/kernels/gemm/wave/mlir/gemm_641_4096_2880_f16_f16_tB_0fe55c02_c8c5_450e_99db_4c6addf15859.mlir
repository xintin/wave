...
#map2 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4608 + s2 * 1536 + s3 * 8 - (s0 floordiv 16) * 16 - ((s1 * 3 + s2) floordiv 8) * 12272 - ((s1 * 288 + s2 * 96 - ((s1 * 3 + s2) floordiv 8) * 767) floordiv 256) * 4096)>
...
#map17 = affine_map<()[s0, s1, s2] -> (((s0 * 288 + s1 * 96 - ((s0 * 3 + s1) floordiv 8) * 767) floordiv 256) * 248 + (s2 floordiv 64) * 62 + ((s2 mod 64) floordiv 16) * 4)>
#map18 = affine_map<()[s0, s1] -> (((s0 * 288 + s1 * 96 - ((s0 * 3 + s1) floordiv 8) * 767) floordiv 256) * 248)>
#map19 = affine_map<()[s0, s1] -> (s0 * 4608 + s1 * 1536 - ((s0 * 3 + s1) floordiv 8) * 12272 - ((s0 * 288 + s1 * 96 - ((s0 * 3 + s1) floordiv 8) * 767) floordiv 256) * 4096)>
#map20 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4)>
#map21 = affine_map<()[s0, s1, s2] -> (((s0 * 288 + s1 * 96 - ((s0 * 3 + s1) floordiv 8) * 767) floordiv 256) * 248 + (s2 floordiv 64) * 62 + ((s2 mod 64) floordiv 16) * 4 + 1)>
#map22 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map23 = affine_map<()[s0, s1, s2] -> (((s0 * 288 + s1 * 96 - ((s0 * 3 + s1) floordiv 8) * 767) floordiv 256) * 248 + (s2 floordiv 64) * 62 + ((s2 mod 64) floordiv 16) * 4 + 2)>
#map24 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map25 = affine_map<()[s0, s1, s2] -> (((s0 * 288 + s1 * 96 - ((s0 * 3 + s1) floordiv 8) * 767) floordiv 256) * 248 + (s2 floordiv 64) * 62 + ((s2 mod 64) floordiv 16) * 4 + 3)>
#map26 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map27 = affine_map<()[s0, s1, s2] -> (((s0 * 288 + s1 * 96 - ((s0 * 3 + s1) floordiv 8) * 767) floordiv 256) * 248 + (s2 floordiv 64) * 62 + ((s2 mod 64) floordiv 16) * 4 + 16)>
#map28 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 16)>
#map29 = affine_map<()[s0, s1, s2] -> (((s0 * 288 + s1 * 96 - ((s0 * 3 + s1) floordiv 8) * 767) floordiv 256) * 248 + (s2 floordiv 64) * 62 + ((s2 mod 64) floordiv 16) * 4 + 17)>
#map30 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 17)>
#map31 = affine_map<()[s0, s1, s2] -> (((s0 * 288 + s1 * 96 - ((s0 * 3 + s1) floordiv 8) * 767) floordiv 256) * 248 + (s2 floordiv 64) * 62 + ((s2 mod 64) floordiv 16) * 4 + 18)>
#map32 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 18)>
#map33 = affine_map<()[s0, s1, s2] -> (((s0 * 288 + s1 * 96 - ((s0 * 3 + s1) floordiv 8) * 767) floordiv 256) * 248 + (s2 floordiv 64) * 62 + ((s2 mod 64) floordiv 16) * 4 + 19)>
#map34 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 19)>
#map35 = affine_map<()[s0, s1, s2] -> (((s0 * 288 + s1 * 96 - ((s0 * 3 + s1) floordiv 8) * 767) floordiv 256) * 248 + (s2 floordiv 64) * 62 + ((s2 mod 64) floordiv 16) * 4 + 32)>
#map36 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 32)>
#map37 = affine_map<()[s0, s1, s2] -> (((s0 * 288 + s1 * 96 - ((s0 * 3 + s1) floordiv 8) * 767) floordiv 256) * 248 + (s2 floordiv 64) * 62 + ((s2 mod 64) floordiv 16) * 4 + 33)>
#map38 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 33)>
#map39 = affine_map<()[s0, s1, s2] -> (((s0 * 288 + s1 * 96 - ((s0 * 3 + s1) floordiv 8) * 767) floordiv 256) * 248 + (s2 floordiv 64) * 62 + ((s2 mod 64) floordiv 16) * 4 + 34)>
#map40 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 34)>
#map41 = affine_map<()[s0, s1, s2] -> (((s0 * 288 + s1 * 96 - ((s0 * 3 + s1) floordiv 8) * 767) floordiv 256) * 248 + (s2 floordiv 64) * 62 + ((s2 mod 64) floordiv 16) * 4 + 35)>
#map42 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 35)>
#map43 = affine_map<()[s0, s1, s2] -> (((s0 * 288 + s1 * 96 - ((s0 * 3 + s1) floordiv 8) * 767) floordiv 256) * 248 + (s2 floordiv 64) * 62 + ((s2 mod 64) floordiv 16) * 4 + 48)>
#map44 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 48)>
#map45 = affine_map<()[s0, s1, s2] -> (((s0 * 288 + s1 * 96 - ((s0 * 3 + s1) floordiv 8) * 767) floordiv 256) * 248 + (s2 floordiv 64) * 62 + ((s2 mod 64) floordiv 16) * 4 + 49)>
#map46 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 49)>
#map47 = affine_map<()[s0, s1, s2] -> (((s0 * 288 + s1 * 96 - ((s0 * 3 + s1) floordiv 8) * 767) floordiv 256) * 248 + (s2 floordiv 64) * 62 + ((s2 mod 64) floordiv 16) * 4 + 50)>
#map48 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 16) * 4 + 50)>
#map49 = affine_map<()[s0, s1, s2] -> (((s0 * 288 + s1 * 96 - ((s0 * 3 + s1) floordiv 8) * 767) floordiv 256) * 248 + (s2 floordiv 64) * 62 + ((s2 mod 64) floordiv 16) * 4 + 51)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %21 = arith.muli %16, %c2880 overflow<nsw> : index
        ...
        %52:4 = scf.for %arg3 = %c0 to %c179 step %c1 iter_args(%arg4 = %cst_4, %arg5 = %cst_4, %arg6 = %cst_4, %arg7 = %cst_4) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          amdgpu.lds_barrier
        ...
        %75 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<641x4096xf32, strided<[4096, 1], offset: ?>>
        ...
        %86 = arith.muli %83, %c4096 overflow<nsw> : index
        %87 = arith.muli %85, %c4096 overflow<nsw> : index
        %88 = arith.addi %86, %84 overflow<nsw> : index
        %89 = arith.addi %87, %36 overflow<nsw> : index
        %base_buffer_11, %offset_12, %sizes_13:2, %strides_14:2 = memref.extract_strided_metadata %75 : memref<641x4096xf32, strided<[4096, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %90 = arith.addi %88, %offset_12 overflow<nsw> : index
        %reinterpret_cast_15 = memref.reinterpret_cast %75 to offset: [%90], sizes: [%c536870910], strides: [1] : memref<641x4096xf32, strided<[4096, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %91 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_15 validBytes(%c2147483643_i32) cacheSwizzleStride(%c4096_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
