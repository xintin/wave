...
#map2 = affine_map<()[s0, s1, s2] -> (s0 mod 32 + ((s1 * 5488 + s2 * 784 - ((s1 * 7 + s2) floordiv 8) * 6271) floordiv 896) * 104 + (s0 floordiv 64) * 26)>
#map3 = affine_map<()[s0] -> (((s0 mod 64) floordiv 32) * 8)>
#map4 = affine_map<()[s0, s1] -> (s0 * 16 + s1 * 8 + 8)>
#map5 = affine_map<()[s0] -> (s0 * 16 + 16)>
#map6 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 87808 + s2 * 12544 + s3 * 8 - (s0 floordiv 32) * 32 - ((s1 * 7 + s2) floordiv 8) * 100336 - ((s1 * 5488 + s2 * 784 - ((s1 * 7 + s2) floordiv 8) * 6271) floordiv 896) * 14336)>
...
#map12 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4)>
#map13 = affine_map<()[s0, s1] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 104)>
#map14 = affine_map<()[s0, s1] -> (s0 * 87808 + s1 * 12544 - ((s0 * 7 + s1) floordiv 8) * 100336 - ((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 14336)>
#map15 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4)>
#map16 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 1)>
#map17 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map18 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 2)>
#map19 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map20 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 3)>
#map21 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map22 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 8)>
#map23 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map24 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 9)>
#map25 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map26 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 10)>
#map27 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map28 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 11)>
#map29 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map30 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 16)>
#map31 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map32 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 17)>
#map33 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map34 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 18)>
#map35 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map36 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 19)>
#map37 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map38 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 24)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map40 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 25)>
#map41 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map42 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 26)>
#map43 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map44 = affine_map<()[s0, s1, s2] -> (((s0 * 5488 + s1 * 784 - ((s0 * 7 + s1) floordiv 8) * 6271) floordiv 896) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 32) * 4 + 27)>
#map45 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 32) * 4 + 27)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %19 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<14336x4096xf16, strided<[4096, 1], offset: ?>>
        %20 = affine.apply #map4()[%block_id_y, %thread_id_y]
        %21 = affine.apply #map5()[%block_id_y]
        %22 = arith.minsi %20, %21 : index
        %23 = affine.apply #map6()[%thread_id_x, %block_id_y, %block_id_x, %thread_id_y]
        %24 = arith.cmpi slt, %23, %22 : index
        %25 = vector.broadcast %24 : i1 to vector<8xi1>
        %26 = arith.muli %23, %c4096 overflow<nsw> : index
        %27 = arith.addi %26, %8 overflow<nsw> : index
        %base_buffer_4, %offset_5, %sizes_6:2, %strides_7:2 = memref.extract_strided_metadata %19 : memref<14336x4096xf16, strided<[4096, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_8 = memref.reinterpret_cast %19 to offset: [%offset_5], sizes: [%c1073741822], strides: [1] : memref<14336x4096xf16, strided<[4096, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %37 = arith.minsi %36, %c104 : index
        %38 = affine.apply #map8()[%thread_id_x]
        %39 = arith.cmpi slt, %38, %37 : index
        %40 = vector.broadcast %39 : i1 to vector<8xi1>
        vector.maskedstore %view_3[%38, %8], %40, %18 : memref<104x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        ...
        %46 = scf.for %arg3 = %c0 to %c255 step %c1 iter_args(%arg4 = %cst_2) -> (vector<16xf32>) {
          amdgpu.lds_barrier
          ...
          %191 = vector.maskedload %view_3[%38, %8], %40, %cst : memref<104x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16> into vector<8xf16>
          %192 = affine.apply #map11()[%arg3, %thread_id_x]
          ...
          amdgpu.lds_barrier
          vector.maskedstore %view_3[%38, %8], %40, %200 : memref<104x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        ...
        %48 = vector.maskedload %view_3[%38, %8], %40, %cst : memref<104x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16> into vector<8xf16>
        ...
        %56 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<706x14336xf32, strided<[14336, 1], offset: ?>>
        %57 = affine.apply #map12()[%block_id_y, %block_id_x, %thread_id_x]
        %58 = arith.cmpi slt, %57, %4 : index
        %59 = arith.andi %24, %58 : i1
        %60 = affine.apply #map13()[%block_id_y, %block_id_x]
        %61 = affine.apply #map14()[%block_id_y, %block_id_x]
        %62 = affine.apply #map15()[%thread_id_x]
        %63 = arith.muli %60, %c14336 overflow<nsw> : index
        %64 = arith.muli %62, %c14336 overflow<nsw> : index
        %65 = arith.addi %63, %61 overflow<nsw> : index
        %66 = arith.addi %64, %43 overflow<nsw> : index
        %base_buffer_9, %offset_10, %sizes_11:2, %strides_12:2 = memref.extract_strided_metadata %56 : memref<706x14336xf32, strided<[14336, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %67 = arith.addi %65, %offset_10 overflow<nsw> : index
        %reinterpret_cast_13 = memref.reinterpret_cast %56 to offset: [%67], sizes: [%c536870910], strides: [1] : memref<706x14336xf32, strided<[14336, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %68 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_13 validBytes(%c2147483643_i32) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %71 = affine.apply #map16()[%block_id_y, %block_id_x, %thread_id_x]
        %72 = arith.cmpi slt, %71, %4 : index
        %73 = arith.andi %24, %72 : i1
        %74 = affine.apply #map17()[%thread_id_x]
        %75 = arith.muli %74, %c14336 overflow<nsw> : index
        ...
        %79 = affine.apply #map18()[%block_id_y, %block_id_x, %thread_id_x]
        %80 = arith.cmpi slt, %79, %4 : index
        %81 = arith.andi %24, %80 : i1
        %82 = affine.apply #map19()[%thread_id_x]
        %83 = arith.muli %82, %c14336 overflow<nsw> : index
        ...
        %87 = affine.apply #map20()[%block_id_y, %block_id_x, %thread_id_x]
        %88 = arith.cmpi slt, %87, %4 : index
        %89 = arith.andi %24, %88 : i1
        %90 = affine.apply #map21()[%thread_id_x]
        %91 = arith.muli %90, %c14336 overflow<nsw> : index
        ...
        %95 = affine.apply #map22()[%block_id_y, %block_id_x, %thread_id_x]
        %96 = arith.cmpi slt, %95, %4 : index
        %97 = arith.andi %24, %96 : i1
        %98 = affine.apply #map23()[%thread_id_x]
        %99 = arith.muli %98, %c14336 overflow<nsw> : index
        ...
        %103 = affine.apply #map24()[%block_id_y, %block_id_x, %thread_id_x]
        %104 = arith.cmpi slt, %103, %4 : index
        %105 = arith.andi %24, %104 : i1
        %106 = affine.apply #map25()[%thread_id_x]
        %107 = arith.muli %106, %c14336 overflow<nsw> : index
        ...
        %111 = affine.apply #map26()[%block_id_y, %block_id_x, %thread_id_x]
        %112 = arith.cmpi slt, %111, %4 : index
        %113 = arith.andi %24, %112 : i1
        %114 = affine.apply #map27()[%thread_id_x]
        %115 = arith.muli %114, %c14336 overflow<nsw> : index
        ...
        %119 = affine.apply #map28()[%block_id_y, %block_id_x, %thread_id_x]
        %120 = arith.cmpi slt, %119, %4 : index
        %121 = arith.andi %24, %120 : i1
        %122 = affine.apply #map29()[%thread_id_x]
        %123 = arith.muli %122, %c14336 overflow<nsw> : index
        ...
        %127 = affine.apply #map30()[%block_id_y, %block_id_x, %thread_id_x]
        %128 = arith.cmpi slt, %127, %4 : index
        %129 = arith.andi %24, %128 : i1
        %130 = affine.apply #map31()[%thread_id_x]
        %131 = arith.muli %130, %c14336 overflow<nsw> : index
        ...
        %135 = affine.apply #map32()[%block_id_y, %block_id_x, %thread_id_x]
        %136 = arith.cmpi slt, %135, %4 : index
        %137 = arith.andi %24, %136 : i1
        %138 = affine.apply #map33()[%thread_id_x]
        %139 = arith.muli %138, %c14336 overflow<nsw> : index
        ...
        %143 = affine.apply #map34()[%block_id_y, %block_id_x, %thread_id_x]
        %144 = arith.cmpi slt, %143, %4 : index
        %145 = arith.andi %24, %144 : i1
        %146 = affine.apply #map35()[%thread_id_x]
        %147 = arith.muli %146, %c14336 overflow<nsw> : index
        ...
        %151 = affine.apply #map36()[%block_id_y, %block_id_x, %thread_id_x]
        %152 = arith.cmpi slt, %151, %4 : index
        %153 = arith.andi %24, %152 : i1
        %154 = affine.apply #map37()[%thread_id_x]
        %155 = arith.muli %154, %c14336 overflow<nsw> : index
        ...
        %159 = affine.apply #map38()[%block_id_y, %block_id_x, %thread_id_x]
        %160 = arith.cmpi slt, %159, %4 : index
        %161 = arith.andi %24, %160 : i1
        %162 = affine.apply #map39()[%thread_id_x]
        %163 = arith.muli %162, %c14336 overflow<nsw> : index
        ...
        %167 = affine.apply #map40()[%block_id_y, %block_id_x, %thread_id_x]
        %168 = arith.cmpi slt, %167, %4 : index
        %169 = arith.andi %24, %168 : i1
        %170 = affine.apply #map41()[%thread_id_x]
        %171 = arith.muli %170, %c14336 overflow<nsw> : index
        ...
        %175 = affine.apply #map42()[%block_id_y, %block_id_x, %thread_id_x]
        %176 = arith.cmpi slt, %175, %4 : index
        %177 = arith.andi %24, %176 : i1
        %178 = affine.apply #map43()[%thread_id_x]
        %179 = arith.muli %178, %c14336 overflow<nsw> : index
        ...
        %183 = affine.apply #map44()[%block_id_y, %block_id_x, %thread_id_x]
        %184 = arith.cmpi slt, %183, %4 : index
        %185 = arith.andi %24, %184 : i1
        %186 = affine.apply #map45()[%thread_id_x]
        %187 = arith.muli %186, %c14336 overflow<nsw> : index
