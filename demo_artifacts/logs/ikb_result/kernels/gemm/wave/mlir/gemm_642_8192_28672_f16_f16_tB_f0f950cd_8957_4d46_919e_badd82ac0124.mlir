#map = affine_map<()[s0, s1] -> (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * -3 + 3)>
#map1 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 2 + s1 * 128 - ((s1 * 128 + s0 floordiv 2) floordiv 248) * 248 + ((s2 * 576 + s3 * 192 - ((s2 * 3 + s3) floordiv 8) * 1535) floordiv 1536) * 744 + (((s2 * 576 + s3 * 192 - ((s2 * 3 + s3) floordiv 8) * 1535) mod 1536) mod s4) * 248)>
#map2 = affine_map<()[s0] -> (s0 * 8 - (s0 floordiv 2) * 16)>
#map3 = affine_map<()[s0, s1] -> (s0 * 16 + s1 * 8 + 8)>
#map4 = affine_map<()[s0] -> (s0 * 16 + 16)>
#map5 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 32 + s4 * 8 + (((s1 * 576 + s2 * 192 - ((s1 * 3 + s2) floordiv 8) * 1535) mod 1536) floordiv s3) * 16)>
...
#map17 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4)>
#map18 = affine_map<()[s0, s1, s2] -> (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248)>
#map19 = affine_map<()[s0, s1, s2] -> ((((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) floordiv s2) * 16)>
#map20 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4)>
#map21 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 1)>
#map22 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map23 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 2)>
#map24 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map25 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 3)>
#map26 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map27 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 8)>
#map28 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map29 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 9)>
#map30 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map31 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 10)>
#map32 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map33 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 11)>
#map34 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map35 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 16)>
#map36 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map37 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 17)>
#map38 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map39 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 18)>
#map40 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map41 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 19)>
#map42 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map43 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 24)>
#map44 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map45 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 25)>
#map46 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map47 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 26)>
#map48 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map49 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 27)>
#map50 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 27)>
#map51 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 32)>
#map52 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 32)>
#map53 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 33)>
#map54 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 33)>
#map55 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 34)>
#map56 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 34)>
#map57 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 35)>
#map58 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 35)>
#map59 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 40)>
#map60 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 40)>
#map61 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 41)>
#map62 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 41)>
#map63 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 42)>
#map64 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 42)>
#map65 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 43)>
#map66 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 43)>
#map67 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 48)>
#map68 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 48)>
#map69 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 49)>
#map70 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 49)>
#map71 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 50)>
#map72 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 50)>
#map73 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 51)>
#map74 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 51)>
#map75 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 56)>
#map76 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 56)>
#map77 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 57)>
#map78 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 57)>
#map79 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 58)>
#map80 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 58)>
#map81 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 59)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %51:2 = scf.for %arg3 = %c0 to %c1791 step %c1 iter_args(%arg4 = %cst_2, %arg5 = %cst_2) -> (vector<16xf32>, vector<16xf32>) {
          amdgpu.lds_barrier
        ...
        %72 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<642x8192xf32, strided<[8192, 1], offset: ?>>
        ...
        %83 = arith.muli %80, %c8192 overflow<nsw> : index
        %84 = arith.muli %82, %c8192 overflow<nsw> : index
        %85 = arith.addi %83, %81 overflow<nsw> : index
        %86 = arith.addi %84, %42 overflow<nsw> : index
        %base_buffer_9, %offset_10, %sizes_11:2, %strides_12:2 = memref.extract_strided_metadata %72 : memref<642x8192xf32, strided<[8192, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %87 = arith.addi %85, %offset_10 overflow<nsw> : index
        %reinterpret_cast_13 = memref.reinterpret_cast %72 to offset: [%87], sizes: [%c536870910], strides: [1] : memref<642x8192xf32, strided<[8192, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %88 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_13 validBytes(%c2147483643_i32) cacheSwizzleStride(%c-8192_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %95 = arith.muli %94, %c8192 overflow<nsw> : index
        ...
        %103 = arith.muli %102, %c8192 overflow<nsw> : index
        ...
        %111 = arith.muli %110, %c8192 overflow<nsw> : index
