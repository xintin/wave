...
#map2 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 4096 + s2 * 16384 + s3 * 8 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 32752 - ((s1 * 256 + s2 * 1024 - ((s1 + s2 * 4) floordiv 8) * 2047) floordiv 512) * 8192)>
...
#map16 = affine_map<()[s0, s1, s2] -> (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 512) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4)>
...
#map20 = affine_map<()[s0, s1, s2] -> (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 512) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 1)>
#map21 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map22 = affine_map<()[s0, s1, s2] -> (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 512) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 2)>
#map23 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map24 = affine_map<()[s0, s1, s2] -> (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 512) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 3)>
#map25 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map26 = affine_map<()[s0, s1, s2] -> (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 512) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 16)>
#map27 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 16)>
#map28 = affine_map<()[s0, s1, s2] -> (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 512) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 17)>
#map29 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 17)>
#map30 = affine_map<()[s0, s1, s2] -> (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 512) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 18)>
#map31 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 18)>
#map32 = affine_map<()[s0, s1, s2] -> (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 512) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 19)>
#map33 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 19)>
#map34 = affine_map<()[s0, s1, s2] -> (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 512) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 32)>
#map35 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 32)>
#map36 = affine_map<()[s0, s1, s2] -> (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 512) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 33)>
#map37 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 33)>
#map38 = affine_map<()[s0, s1, s2] -> (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 512) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 34)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 43 + ((s0 mod 64) floordiv 16) * 4 + 34)>
#map40 = affine_map<()[s0, s1, s2] -> (((s0 * 256 + s1 * 1024 - ((s0 + s1 * 4) floordiv 8) * 2047) floordiv 512) * 172 + (s2 floordiv 64) * 43 + ((s2 mod 64) floordiv 16) * 4 + 35)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %21 = arith.muli %16, %c28672 overflow<nsw> : index
        ...
        %49:3 = scf.for %arg3 = %c0 to %c1791 step %c1 iter_args(%arg4 = %cst_4, %arg5 = %cst_4, %arg6 = %cst_4) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          amdgpu.lds_barrier
        ...
        %67 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<642x8192xf32, strided<[8192, 1], offset: ?>>
        ...
        %78 = arith.muli %75, %c8192 overflow<nsw> : index
        %79 = arith.muli %77, %c8192 overflow<nsw> : index
        %80 = arith.addi %78, %76 overflow<nsw> : index
        %81 = arith.addi %79, %36 overflow<nsw> : index
        %base_buffer_11, %offset_12, %sizes_13:2, %strides_14:2 = memref.extract_strided_metadata %67 : memref<642x8192xf32, strided<[8192, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %82 = arith.addi %80, %offset_12 overflow<nsw> : index
        %reinterpret_cast_15 = memref.reinterpret_cast %67 to offset: [%82], sizes: [%c536870910], strides: [1] : memref<642x8192xf32, strided<[8192, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %83 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_15 validBytes(%c2147483643_i32) cacheSwizzleStride(%c-8192_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
