...
module attributes {transform.with_named_sequence} {
  stream.executable private @gemm {
    stream.executable.export public @gemm workgroups() -> (index, index, index) {
      ...
      stream.return %c6, %c56, %c1 : index, index, index
    }
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %7 = amdgpu.fat_raw_buffer_cast %reinterpret_cast validBytes(%c2147483645_i64) cacheSwizzleStride(%c4096_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %base_buffer_3, %offset_4, %sizes_5:2, %strides_6:2 = memref.extract_strided_metadata %27 : memref<14336x4096xf16, strided<[4096, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_7 = memref.reinterpret_cast %27 to offset: [%offset_4], sizes: [%c1073741822], strides: [1] : memref<14336x4096xf16, strided<[4096, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        %31 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_7 validBytes(%c2147483645_i64) cacheSwizzleStride(%c4096_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %42 = arith.muli %41, %c4096 overflow<nsw> : index
        ...
        %69:16 = scf.for %arg3 = %c0 to %c63 step %c1 iter_args(%arg4 = %cst_1, %arg5 = %cst_1, %arg6 = %cst_1, %arg7 = %cst_1, %arg8 = %cst_1, %arg9 = %cst_1, %arg10 = %cst_1, %arg11 = %cst_1, %arg12 = %cst_1, %arg13 = %cst_1, %arg14 = %cst_1, %arg15 = %cst_1, %arg16 = %cst_1, %arg17 = %cst_1, %arg18 = %cst_1, %arg19 = %cst_1) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
        ...
        %189 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<706x14336xf32, strided<[14336, 1], offset: ?>>
        %190 = affine.apply #map29()[%block_id_x, %thread_id_x]
        %191 = arith.cmpi slt, %190, %c706 : index
        %192 = affine.apply #map30()[%block_id_x]
        %193 = affine.apply #map31()[%block_id_y]
        %194 = affine.apply #map32()[%thread_id_x]
        %195 = arith.muli %192, %c14336 overflow<nsw> : index
        %196 = arith.muli %194, %c14336 overflow<nsw> : index
        %197 = arith.addi %195, %193 overflow<nsw> : index
        %198 = arith.addi %196, %70 overflow<nsw> : index
        %base_buffer_8, %offset_9, %sizes_10:2, %strides_11:2 = memref.extract_strided_metadata %189 : memref<706x14336xf32, strided<[14336, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %199 = arith.addi %197, %offset_9 overflow<nsw> : index
        %reinterpret_cast_12 = memref.reinterpret_cast %189 to offset: [%199], sizes: [%c536870910], strides: [1] : memref<706x14336xf32, strided<[14336, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        ...
        %204 = arith.cmpi slt, %203, %c706 : index
        ...
        %211 = arith.cmpi slt, %210, %c706 : index
        ...
        %218 = arith.cmpi slt, %217, %c706 : index
        ...
        %316 = arith.cmpi slt, %315, %c706 : index
        ...
        %323 = arith.cmpi slt, %322, %c706 : index
        ...
        %330 = arith.cmpi slt, %329, %c706 : index
