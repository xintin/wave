#map = affine_map<()[s0, s1] -> (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * -63 + 64)>
#map1 = affine_map<()[s0, s1, s2, s3] -> ((s0 floordiv 16) mod 16 + ((s1 * 512 + s2 * 8 - (s1 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s1 * 512 + s2 * 8 - (s1 floordiv 8) * 4095) mod 4032) mod s3) * 16)>
#map2 = affine_map<()[s0] -> (s0 mod 16)>
#map3 = affine_map<()[s0, s1, s2, s3] -> ((s0 floordiv 16) mod 16 + (((s1 * 512 + s2 * 8 - (s1 floordiv 8) * 4095) mod 4032) floordiv s3) * 16)>
...
#map14 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 32 + s4 * 8 + (((s1 * 512 + s2 * 8 - (s1 floordiv 8) * 4095) mod 4032) floordiv s3) * 16)>
#map15 = affine_map<()[s0, s1] -> (s0 * 16 + (s1 floordiv 64) * 4 + 4)>
#map16 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4)>
#map17 = affine_map<()[s0, s1, s2] -> (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16)>
#map18 = affine_map<()[s0, s1, s2] -> ((((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) floordiv s2) * 16)>
#map19 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4)>
#map20 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 1)>
#map21 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map22 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 2)>
#map23 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map24 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 3)>
#map25 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map26 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 8)>
#map27 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map28 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 9)>
#map29 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map30 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 10)>
#map31 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map32 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 11)>
#map33 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map34 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 16)>
#map35 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map36 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 17)>
#map37 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map38 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 18)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map40 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 19)>
#map41 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map42 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 24)>
#map43 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map44 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 25)>
#map45 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map46 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 26)>
#map47 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map48 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 4032) * 1008 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 4032) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 27)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %11 = affine.apply #map3()[%thread_id_x, %block_id_x, %block_id_y, %3]
        ...
        %14 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_6 validBytes(%c2147483645_i32) cacheSwizzleStride(%c1024_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %33 = scf.for %arg3 = %c0 to %c63 step %c1 iter_args(%arg4 = %cst_0) -> (vector<16xf32>) {
          amdgpu.lds_barrier
        ...
        %49 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<1024x1024xf32, strided<[1024, 1], offset: ?>>
        %50 = affine.apply #map12()[%block_id_y, %thread_id_y]
        %51 = affine.apply #map13()[%block_id_y]
        %52 = arith.minsi %50, %51 : index
        %53 = affine.apply #map14()[%thread_id_x, %block_id_x, %block_id_y, %3, %thread_id_y]
        ...
        %58 = affine.apply #map16()[%block_id_x, %block_id_y, %3, %thread_id_x]
        %59 = arith.cmpi slt, %58, %57 : index
        %60 = arith.andi %54, %59 : i1
        %61 = affine.apply #map17()[%block_id_x, %block_id_y, %3]
        %62 = affine.apply #map18()[%block_id_x, %block_id_y, %3]
        %63 = affine.apply #map19()[%thread_id_x]
        %64 = arith.muli %61, %c1024 overflow<nsw> : index
        %65 = arith.muli %63, %c1024 overflow<nsw> : index
        %66 = arith.addi %64, %62 overflow<nsw> : index
        %67 = arith.addi %65, %34 overflow<nsw> : index
        %base_buffer_7, %offset_8, %sizes_9:2, %strides_10:2 = memref.extract_strided_metadata %49 : memref<1024x1024xf32, strided<[1024, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %68 = arith.addi %66, %offset_8 overflow<nsw> : index
        %reinterpret_cast_11 = memref.reinterpret_cast %49 to offset: [%68], sizes: [%c536870910], strides: [1] : memref<1024x1024xf32, strided<[1024, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %69 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_11 validBytes(%c2147483643_i32) cacheSwizzleStride(%c1024_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %72 = affine.apply #map20()[%block_id_x, %block_id_y, %3, %thread_id_x]
        %73 = arith.cmpi slt, %72, %57 : index
        %74 = arith.andi %54, %73 : i1
        %75 = affine.apply #map21()[%thread_id_x]
        %76 = arith.muli %75, %c1024 overflow<nsw> : index
        ...
        %80 = affine.apply #map22()[%block_id_x, %block_id_y, %3, %thread_id_x]
        %81 = arith.cmpi slt, %80, %57 : index
        %82 = arith.andi %54, %81 : i1
        %83 = affine.apply #map23()[%thread_id_x]
        %84 = arith.muli %83, %c1024 overflow<nsw> : index
        ...
        %88 = affine.apply #map24()[%block_id_x, %block_id_y, %3, %thread_id_x]
        %89 = arith.cmpi slt, %88, %57 : index
        %90 = arith.andi %54, %89 : i1
        %91 = affine.apply #map25()[%thread_id_x]
        %92 = arith.muli %91, %c1024 overflow<nsw> : index
        ...
        %96 = affine.apply #map26()[%block_id_x, %block_id_y, %3, %thread_id_x]
        %97 = arith.cmpi slt, %96, %57 : index
        %98 = arith.andi %54, %97 : i1
        %99 = affine.apply #map27()[%thread_id_x]
        %100 = arith.muli %99, %c1024 overflow<nsw> : index
        ...
        %104 = affine.apply #map28()[%block_id_x, %block_id_y, %3, %thread_id_x]
        %105 = arith.cmpi slt, %104, %57 : index
        %106 = arith.andi %54, %105 : i1
        %107 = affine.apply #map29()[%thread_id_x]
        %108 = arith.muli %107, %c1024 overflow<nsw> : index
        ...
        %112 = affine.apply #map30()[%block_id_x, %block_id_y, %3, %thread_id_x]
        %113 = arith.cmpi slt, %112, %57 : index
        %114 = arith.andi %54, %113 : i1
        %115 = affine.apply #map31()[%thread_id_x]
        %116 = arith.muli %115, %c1024 overflow<nsw> : index
        ...
        %120 = affine.apply #map32()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %128 = affine.apply #map34()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %136 = affine.apply #map36()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %144 = affine.apply #map38()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %152 = affine.apply #map40()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %160 = affine.apply #map42()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %168 = affine.apply #map44()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %176 = affine.apply #map46()[%block_id_x, %block_id_y, %3, %thread_id_x]
        ...
        %184 = affine.apply #map48()[%block_id_x, %block_id_y, %3, %thread_id_x]
