#map = affine_map<()[s0, s1, s2] -> ((s0 floordiv 16) mod 16 + ((s1 * 73958580 + s2 * 57690 - ((s1 * 1282 + s2) floordiv 8) * 461519) floordiv 360) * 16)>
#map1 = affine_map<()[s0] -> (s0 mod 16)>
#map2 = affine_map<()[s0, s1, s2] -> (s1 * 1183337280 + s2 * 923040 + (s0 floordiv 16) mod 16 - ((s1 * 1282 + s2) floordiv 8) * 7384304 - ((s1 * 73958580 + s2 * 57690 - ((s1 * 1282 + s2) floordiv 8) * 461519) floordiv 360) * 5760)>
...
#map13 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 1183337280 + s2 * 923040 + s3 * 8 - (s0 floordiv 32) * 32 - ((s1 * 1282 + s2) floordiv 8) * 7384304 - ((s1 * 73958580 + s2 * 57690 - ((s1 * 1282 + s2) floordiv 8) * 461519) floordiv 360) * 5760)>
#map14 = affine_map<()[s0, s1] -> (s0 * 16 + (s1 floordiv 64) * 4 + 4)>
#map15 = affine_map<()[s0, s1, s2] -> (((s0 * 73958580 + s1 * 57690 - ((s0 * 1282 + s1) floordiv 8) * 461519) floordiv 360) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4)>
#map16 = affine_map<()[s0, s1] -> (((s0 * 73958580 + s1 * 57690 - ((s0 * 1282 + s1) floordiv 8) * 461519) floordiv 360) * 16)>
#map17 = affine_map<()[s0, s1] -> (s0 * 1183337280 + s1 * 923040 - ((s0 * 1282 + s1) floordiv 8) * 7384304 - ((s0 * 73958580 + s1 * 57690 - ((s0 * 1282 + s1) floordiv 8) * 461519) floordiv 360) * 5760)>
#map18 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4)>
#map19 = affine_map<()[s0, s1, s2] -> (((s0 * 73958580 + s1 * 57690 - ((s0 * 1282 + s1) floordiv 8) * 461519) floordiv 360) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 1)>
#map20 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map21 = affine_map<()[s0, s1, s2] -> (((s0 * 73958580 + s1 * 57690 - ((s0 * 1282 + s1) floordiv 8) * 461519) floordiv 360) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 2)>
#map22 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map23 = affine_map<()[s0, s1, s2] -> (((s0 * 73958580 + s1 * 57690 - ((s0 * 1282 + s1) floordiv 8) * 461519) floordiv 360) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 3)>
#map24 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map25 = affine_map<()[s0, s1, s2] -> (((s0 * 73958580 + s1 * 57690 - ((s0 * 1282 + s1) floordiv 8) * 461519) floordiv 360) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 8)>
#map26 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map27 = affine_map<()[s0, s1, s2] -> (((s0 * 73958580 + s1 * 57690 - ((s0 * 1282 + s1) floordiv 8) * 461519) floordiv 360) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 9)>
#map28 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map29 = affine_map<()[s0, s1, s2] -> (((s0 * 73958580 + s1 * 57690 - ((s0 * 1282 + s1) floordiv 8) * 461519) floordiv 360) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 10)>
#map30 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map31 = affine_map<()[s0, s1, s2] -> (((s0 * 73958580 + s1 * 57690 - ((s0 * 1282 + s1) floordiv 8) * 461519) floordiv 360) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 11)>
#map32 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map33 = affine_map<()[s0, s1, s2] -> (((s0 * 73958580 + s1 * 57690 - ((s0 * 1282 + s1) floordiv 8) * 461519) floordiv 360) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 16)>
#map34 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map35 = affine_map<()[s0, s1, s2] -> (((s0 * 73958580 + s1 * 57690 - ((s0 * 1282 + s1) floordiv 8) * 461519) floordiv 360) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 17)>
#map36 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map37 = affine_map<()[s0, s1, s2] -> (((s0 * 73958580 + s1 * 57690 - ((s0 * 1282 + s1) floordiv 8) * 461519) floordiv 360) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 18)>
#map38 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map39 = affine_map<()[s0, s1, s2] -> (((s0 * 73958580 + s1 * 57690 - ((s0 * 1282 + s1) floordiv 8) * 461519) floordiv 360) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 19)>
#map40 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map41 = affine_map<()[s0, s1, s2] -> (((s0 * 73958580 + s1 * 57690 - ((s0 * 1282 + s1) floordiv 8) * 461519) floordiv 360) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 24)>
#map42 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map43 = affine_map<()[s0, s1, s2] -> (((s0 * 73958580 + s1 * 57690 - ((s0 * 1282 + s1) floordiv 8) * 461519) floordiv 360) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 25)>
#map44 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map45 = affine_map<()[s0, s1, s2] -> (((s0 * 73958580 + s1 * 57690 - ((s0 * 1282 + s1) floordiv 8) * 461519) floordiv 360) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 26)>
#map46 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map47 = affine_map<()[s0, s1, s2] -> (((s0 * 73958580 + s1 * 57690 - ((s0 * 1282 + s1) floordiv 8) * 461519) floordiv 360) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 27)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %8 = affine.apply #map2()[%thread_id_x, %block_id_y, %block_id_x]
        %9 = arith.muli %8, %c2880 overflow<nsw> : index
        %10 = arith.addi %9, %2 overflow<nsw> : index
        %base_buffer_2, %offset_3, %sizes_4:2, %strides_5:2 = memref.extract_strided_metadata %7 : memref<5760x2880xf16, strided<[2880, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_6 = memref.reinterpret_cast %7 to offset: [%offset_3], sizes: [%c1073741822], strides: [1] : memref<5760x2880xf16, strided<[2880, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        %11 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_6 validBytes(%c2147483645_i32) cacheSwizzleStride(%c2880_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %30 = scf.for %arg3 = %c0 to %c179 step %c1 iter_args(%arg4 = %cst_0) -> (vector<16xf32>) {
          amdgpu.lds_barrier
        ...
        %46 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<20512x5760xf32, strided<[5760, 1], offset: ?>>
        %47 = affine.apply #map11()[%block_id_y, %thread_id_y]
        %48 = affine.apply #map12()[%block_id_y]
        %49 = arith.minsi %47, %48 : index
        %50 = affine.apply #map13()[%thread_id_x, %block_id_y, %block_id_x, %thread_id_y]
        ...
        %55 = affine.apply #map15()[%block_id_y, %block_id_x, %thread_id_x]
        %56 = arith.cmpi slt, %55, %54 : index
        %57 = arith.andi %51, %56 : i1
        %58 = affine.apply #map16()[%block_id_y, %block_id_x]
        %59 = affine.apply #map17()[%block_id_y, %block_id_x]
        %60 = affine.apply #map18()[%thread_id_x]
        %61 = arith.muli %58, %c5760 overflow<nsw> : index
        %62 = arith.muli %60, %c5760 overflow<nsw> : index
        %63 = arith.addi %61, %59 overflow<nsw> : index
        %64 = arith.addi %62, %31 overflow<nsw> : index
        %base_buffer_7, %offset_8, %sizes_9:2, %strides_10:2 = memref.extract_strided_metadata %46 : memref<20512x5760xf32, strided<[5760, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %65 = arith.addi %63, %offset_8 overflow<nsw> : index
        %reinterpret_cast_11 = memref.reinterpret_cast %46 to offset: [%65], sizes: [%c536870910], strides: [1] : memref<20512x5760xf32, strided<[5760, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %66 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_11 validBytes(%c2147483643_i32) cacheSwizzleStride(%c5760_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %69 = affine.apply #map19()[%block_id_y, %block_id_x, %thread_id_x]
        %70 = arith.cmpi slt, %69, %54 : index
        %71 = arith.andi %51, %70 : i1
        %72 = affine.apply #map20()[%thread_id_x]
        %73 = arith.muli %72, %c5760 overflow<nsw> : index
        ...
        %77 = affine.apply #map21()[%block_id_y, %block_id_x, %thread_id_x]
        %78 = arith.cmpi slt, %77, %54 : index
        %79 = arith.andi %51, %78 : i1
        %80 = affine.apply #map22()[%thread_id_x]
        %81 = arith.muli %80, %c5760 overflow<nsw> : index
        ...
        %85 = affine.apply #map23()[%block_id_y, %block_id_x, %thread_id_x]
        %86 = arith.cmpi slt, %85, %54 : index
        %87 = arith.andi %51, %86 : i1
        %88 = affine.apply #map24()[%thread_id_x]
        %89 = arith.muli %88, %c5760 overflow<nsw> : index
        ...
        %93 = affine.apply #map25()[%block_id_y, %block_id_x, %thread_id_x]
        %94 = arith.cmpi slt, %93, %54 : index
        %95 = arith.andi %51, %94 : i1
        %96 = affine.apply #map26()[%thread_id_x]
        %97 = arith.muli %96, %c5760 overflow<nsw> : index
        ...
        %101 = affine.apply #map27()[%block_id_y, %block_id_x, %thread_id_x]
        %102 = arith.cmpi slt, %101, %54 : index
        %103 = arith.andi %51, %102 : i1
        %104 = affine.apply #map28()[%thread_id_x]
        %105 = arith.muli %104, %c5760 overflow<nsw> : index
        ...
        %109 = affine.apply #map29()[%block_id_y, %block_id_x, %thread_id_x]
        %110 = arith.cmpi slt, %109, %54 : index
        %111 = arith.andi %51, %110 : i1
        %112 = affine.apply #map30()[%thread_id_x]
        %113 = arith.muli %112, %c5760 overflow<nsw> : index
        ...
        %117 = affine.apply #map31()[%block_id_y, %block_id_x, %thread_id_x]
        %118 = arith.cmpi slt, %117, %54 : index
        %119 = arith.andi %51, %118 : i1
        %120 = affine.apply #map32()[%thread_id_x]
        %121 = arith.muli %120, %c5760 overflow<nsw> : index
        ...
        %125 = affine.apply #map33()[%block_id_y, %block_id_x, %thread_id_x]
        %126 = arith.cmpi slt, %125, %54 : index
        %127 = arith.andi %51, %126 : i1
        %128 = affine.apply #map34()[%thread_id_x]
        %129 = arith.muli %128, %c5760 overflow<nsw> : index
        ...
        %133 = affine.apply #map35()[%block_id_y, %block_id_x, %thread_id_x]
        %134 = arith.cmpi slt, %133, %54 : index
        %135 = arith.andi %51, %134 : i1
        %136 = affine.apply #map36()[%thread_id_x]
        %137 = arith.muli %136, %c5760 overflow<nsw> : index
        ...
        %141 = affine.apply #map37()[%block_id_y, %block_id_x, %thread_id_x]
        %142 = arith.cmpi slt, %141, %54 : index
        %143 = arith.andi %51, %142 : i1
        %144 = affine.apply #map38()[%thread_id_x]
        %145 = arith.muli %144, %c5760 overflow<nsw> : index
        ...
        %149 = affine.apply #map39()[%block_id_y, %block_id_x, %thread_id_x]
        %150 = arith.cmpi slt, %149, %54 : index
        %151 = arith.andi %51, %150 : i1
        %152 = affine.apply #map40()[%thread_id_x]
        %153 = arith.muli %152, %c5760 overflow<nsw> : index
        ...
        %157 = affine.apply #map41()[%block_id_y, %block_id_x, %thread_id_x]
        %158 = arith.cmpi slt, %157, %54 : index
        %159 = arith.andi %51, %158 : i1
        %160 = affine.apply #map42()[%thread_id_x]
        %161 = arith.muli %160, %c5760 overflow<nsw> : index
        ...
        %165 = affine.apply #map43()[%block_id_y, %block_id_x, %thread_id_x]
        %166 = arith.cmpi slt, %165, %54 : index
        %167 = arith.andi %51, %166 : i1
        %168 = affine.apply #map44()[%thread_id_x]
        %169 = arith.muli %168, %c5760 overflow<nsw> : index
        ...
        %173 = affine.apply #map45()[%block_id_y, %block_id_x, %thread_id_x]
        %174 = arith.cmpi slt, %173, %54 : index
        %175 = arith.andi %51, %174 : i1
        %176 = affine.apply #map46()[%thread_id_x]
        %177 = arith.muli %176, %c5760 overflow<nsw> : index
        ...
        %181 = affine.apply #map47()[%block_id_y, %block_id_x, %thread_id_x]
        %182 = arith.cmpi slt, %181, %54 : index
        %183 = arith.andi %51, %182 : i1
        %184 = affine.apply #map48()[%thread_id_x]
        %185 = arith.muli %184, %c5760 overflow<nsw> : index
