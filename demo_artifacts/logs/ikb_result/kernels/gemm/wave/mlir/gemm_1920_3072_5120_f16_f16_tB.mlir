...
#map1 = affine_map<()[s0, s1, s2] -> (((s0 * 330 + s1 * 22 + s2 - ((s0 * 15 + s1) floordiv 8) * 175) floordiv 96) * -8 + 15)>
#map2 = affine_map<()[s0, s1, s2, s3, s4, s5, s6] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8) floordiv 128) * 128 + ((s2 * 330 + s3 * 22 + s4 - ((s2 * 15 + s3) floordiv 8) * 175) floordiv 96) * 1024 + (((s2 * 330 + s3 * 22 + s5 - ((s2 * 15 + s3) floordiv 8) * 175) mod 96) mod s6) * 128)>
#map3 = affine_map<()[s0] -> (s0 * 8 - (s0 floordiv 8) * 64)>
#map4 = affine_map<()[s0, s1, s2, s3, s4, s5, s6] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 128) * 128 + ((s2 * 330 + s3 * 22 + s4 - ((s2 * 15 + s3) floordiv 8) * 175) floordiv 96) * 1024 + (((s2 * 330 + s3 * 22 + s5 - ((s2 * 15 + s3) floordiv 8) * 175) mod 96) mod s6) * 128 + 64)>
#map5 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8) floordiv 256) * 256 + (((s2 * 330 + s3 * 22 + s4 - ((s2 * 15 + s3) floordiv 8) * 175) mod 96) floordiv s5) * 256)>
#map6 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 256) * 256 + (((s2 * 330 + s3 * 22 + s4 - ((s2 * 15 + s3) floordiv 8) * 175) mod 96) floordiv s5) * 256 + 64)>
#map7 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 128) floordiv 256) * 256 + (((s2 * 330 + s3 * 22 + s4 - ((s2 * 15 + s3) floordiv 8) * 175) mod 96) floordiv s5) * 256 + 128)>
#map8 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 192) floordiv 256) * 256 + (((s2 * 330 + s3 * 22 + s4 - ((s2 * 15 + s3) floordiv 8) * 175) mod 96) floordiv s5) * 256 + 192)>
...
#map31 = affine_map<()[s0, s1, s2, s3, s4] -> (((s0 * 330 + s1 * 22 + s2 - ((s0 * 15 + s1) floordiv 8) * 175) floordiv 96) * 1024 + (((s0 * 330 + s1 * 22 + s3 - ((s0 * 15 + s1) floordiv 8) * 175) mod 96) mod s4) * 128)>
#map32 = affine_map<()[s0, s1, s2, s3] -> ((((s0 * 330 + s1 * 22 + s2 - ((s0 * 15 + s1) floordiv 8) * 175) mod 96) floordiv s3) * 256)>
...
module attributes {transform.with_named_sequence} {
  stream.executable private @gemm {
    stream.executable.export public @gemm workgroups() -> (index, index, index) {
      ...
      stream.return %c15, %c12, %c1 : index, index, index
    }
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %58:16 = scf.for %arg3 = %c0 to %c79 step %c1 iter_args(%arg4 = %cst, %arg5 = %cst, %arg6 = %cst, %arg7 = %cst, %arg8 = %cst, %arg9 = %cst, %arg10 = %cst, %arg11 = %cst, %arg12 = %cst, %arg13 = %cst, %arg14 = %cst, %arg15 = %cst, %arg16 = %cst, %arg17 = %cst, %arg18 = %cst, %arg19 = %cst) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          ...
          %375 = arith.addi %23, %348 overflow<nsw> : index
          ...
          vector.store %376, %view[%37, %7] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
        ...
        %178 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<1920x3072xf32, strided<[3072, 1], offset: ?>>
        ...
        %base_buffer_6, %offset_7, %sizes_8:2, %strides_9:2 = memref.extract_strided_metadata %178 : memref<1920x3072xf32, strided<[3072, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %186 = arith.addi %184, %offset_7 overflow<nsw> : index
        %reinterpret_cast_10 = memref.reinterpret_cast %178 to offset: [%186], sizes: [%c536870910], strides: [1] : memref<1920x3072xf32, strided<[3072, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
  ...
  func.func @isolated_benchmark(%arg0: tensor<1920x5120xf16>, %arg1: tensor<3072x5120xf16>, %arg2: tensor<1920x3072xf32>) -> tensor<1920x3072xf32> {
    %0 = flow.dispatch @gemm::@gemm(%arg0, %arg1, %arg2) : (tensor<1920x5120xf16>, tensor<3072x5120xf16>, tensor<1920x3072xf32>) -> %arg2
    return %0 : tensor<1920x3072xf32>
  }
}
