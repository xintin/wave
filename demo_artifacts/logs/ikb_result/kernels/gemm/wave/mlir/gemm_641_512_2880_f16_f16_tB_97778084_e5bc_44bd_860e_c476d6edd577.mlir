...
#map5 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 2 + s1 * 128 - ((s1 * 128 + s0 floordiv 2) floordiv 264) * 264 + (((s2 * 410 + s3 * 10 + s4 - ((s2 * 41 + s3) floordiv 8) * 79) mod 42) floordiv s5) * 264)>
#map6 = affine_map<()[s0] -> (s0 * 8 - (s0 floordiv 2) * 16)>
#map7 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 2 + s1 * 128 - ((s1 * 128 + s0 floordiv 2 + 256) floordiv 264) * 264 + (((s2 * 410 + s3 * 10 + s4 - ((s2 * 41 + s3) floordiv 8) * 79) mod 42) floordiv s5) * 264 + 256)>
...
#map26 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 132 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 42) floordiv s4) * 264)>
#map27 = affine_map<()[s0, s1, s2, s3, s4, s5] -> ((s5 floordiv 64) * 4 + ((s0 * 410 + s1 * 10 + s2 - ((s0 * 41 + s1) floordiv 8) * 79) floordiv 42) * 336 + (((s0 * 410 + s1 * 10 + s3 - ((s0 * 41 + s1) floordiv 8) * 79) mod 42) mod s4) * 16 + ((s5 mod 64) floordiv 16) * 4)>
...
#map31 = affine_map<()[s0, s1, s2, s3, s4, s5] -> ((s5 floordiv 64) * 4 + ((s0 * 410 + s1 * 10 + s2 - ((s0 * 41 + s1) floordiv 8) * 79) floordiv 42) * 336 + (((s0 * 410 + s1 * 10 + s3 - ((s0 * 41 + s1) floordiv 8) * 79) mod 42) mod s4) * 16 + ((s5 mod 64) floordiv 16) * 4 + 1)>
#map32 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map33 = affine_map<()[s0, s1, s2, s3, s4, s5] -> ((s5 floordiv 64) * 4 + ((s0 * 410 + s1 * 10 + s2 - ((s0 * 41 + s1) floordiv 8) * 79) floordiv 42) * 336 + (((s0 * 410 + s1 * 10 + s3 - ((s0 * 41 + s1) floordiv 8) * 79) mod 42) mod s4) * 16 + ((s5 mod 64) floordiv 16) * 4 + 2)>
#map34 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map35 = affine_map<()[s0, s1, s2, s3, s4, s5] -> ((s5 floordiv 64) * 4 + ((s0 * 410 + s1 * 10 + s2 - ((s0 * 41 + s1) floordiv 8) * 79) floordiv 42) * 336 + (((s0 * 410 + s1 * 10 + s3 - ((s0 * 41 + s1) floordiv 8) * 79) mod 42) mod s4) * 16 + ((s5 mod 64) floordiv 16) * 4 + 3)>
#map36 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map37 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 132 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 42) floordiv s4) * 264 + 16)>
#map38 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 132 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 42) floordiv s4) * 264 + 32)>
#map39 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 132 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 42) floordiv s4) * 264 + 48)>
#map40 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 132 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 42) floordiv s4) * 264 + 64)>
#map41 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 132 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 42) floordiv s4) * 264 + 80)>
#map42 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 132 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 42) floordiv s4) * 264 + 96)>
#map43 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 132 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 42) floordiv s4) * 264 + 112)>
#map44 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 mod 16 + s5 * 132 + (((s1 * 410 + s2 * 10 + s3 - ((s1 * 41 + s2) floordiv 8) * 79) mod 42) floordiv s4) * 264 + 128)>
