...
#map3 = affine_map<()[s0, s1, s2, s3] -> (s0 mod 32 + (s0 floordiv 64) * 4 + ((s1 * 81000 + s2 * 1800 - ((s1 * 45 + s2) floordiv 8) * 14399) floordiv 7360) * 368 + (((s1 * 81000 + s2 * 1800 - ((s1 * 45 + s2) floordiv 8) * 14399) mod 7360) mod s3) * 16)>
#map4 = affine_map<()[s0] -> (((s0 mod 64) floordiv 32) * 8)>
#map5 = affine_map<()[s0, s1] -> (s0 * 16 + s1 * 8 + 8)>
#map6 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 32 + s4 * 8 + (((s1 * 81000 + s2 * 1800 - ((s1 * 45 + s2) floordiv 8) * 14399) mod 7360) floordiv s3) * 16)>
...
#map12 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 7360) * 368 + (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) mod 7360) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4)>
#map13 = affine_map<()[s0, s1, s2] -> (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 7360) * 368 + (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) mod 7360) mod s2) * 16)>
#map14 = affine_map<()[s0, s1, s2] -> ((((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) mod 7360) floordiv s2) * 16)>
#map15 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4)>
#map16 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 7360) * 368 + (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) mod 7360) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 1)>
#map17 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map18 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 7360) * 368 + (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) mod 7360) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 2)>
#map19 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map20 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 7360) * 368 + (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) mod 7360) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 3)>
#map21 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map22 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 7360) * 368 + (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) mod 7360) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 8)>
#map23 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map24 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 7360) * 368 + (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) mod 7360) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 9)>
#map25 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map26 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 7360) * 368 + (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) mod 7360) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 10)>
#map27 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map28 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 7360) * 368 + (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) mod 7360) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 11)>
#map29 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map30 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 7360) * 368 + (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) mod 7360) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 16)>
#map31 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map32 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 7360) * 368 + (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) mod 7360) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 17)>
#map33 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map34 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 7360) * 368 + (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) mod 7360) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 18)>
#map35 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map36 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 7360) * 368 + (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) mod 7360) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 19)>
#map37 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map38 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 7360) * 368 + (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) mod 7360) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 24)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map40 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 7360) * 368 + (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) mod 7360) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 25)>
#map41 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map42 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 7360) * 368 + (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) mod 7360) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 26)>
#map43 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map44 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) floordiv 7360) * 368 + (((s0 * 81000 + s1 * 1800 - ((s0 * 45 + s1) floordiv 8) * 14399) mod 7360) mod s2) * 16 + ((s3 mod 64) floordiv 32) * 4 + 27)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %12 = arith.muli %8, %c13824 overflow<nsw> : index
        ...
        %22 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<5120x13824xf16, strided<[13824, 1], offset: ?>>
        ...
        %29 = arith.muli %26, %c13824 overflow<nsw> : index
        %30 = arith.addi %29, %11 overflow<nsw> : index
        %base_buffer_4, %offset_5, %sizes_6:2, %strides_7:2 = memref.extract_strided_metadata %22 : memref<5120x13824xf16, strided<[13824, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_8 = memref.reinterpret_cast %22 to offset: [%offset_5], sizes: [%c1073741822], strides: [1] : memref<5120x13824xf16, strided<[13824, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %49 = scf.for %arg3 = %c0 to %c863 step %c1 iter_args(%arg4 = %cst_2) -> (vector<16xf32>) {
          amdgpu.lds_barrier
