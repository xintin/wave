...
#map3 = affine_map<()[s0, s1, s2, s3] -> ((s0 floordiv 16) mod 16 + (((s1 * 576 + s2 * 192 - ((s1 * 3 + s2) floordiv 8) * 1535) mod 1536) floordiv s3) * 16)>
...
#map18 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 32 + s4 * 8 + (((s1 * 576 + s2 * 192 - ((s1 * 3 + s2) floordiv 8) * 1535) mod 1536) floordiv s3) * 16)>
#map19 = affine_map<()[s0, s1] -> (s0 * 248 + (s1 floordiv 64) * 62 + 62)>
#map20 = affine_map<()[s0] -> (s0 * 248 + 248)>
#map21 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4)>
#map22 = affine_map<()[s0, s1, s2] -> (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248)>
#map23 = affine_map<()[s0, s1, s2] -> ((((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) floordiv s2) * 16)>
#map24 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4)>
#map25 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 1)>
#map26 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map27 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 2)>
#map28 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map29 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 3)>
#map30 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map31 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 8)>
#map32 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map33 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 9)>
#map34 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map35 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 10)>
#map36 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map37 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 11)>
#map38 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map39 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 16)>
#map40 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map41 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 17)>
#map42 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map43 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 18)>
#map44 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map45 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 19)>
#map46 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map47 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 24)>
#map48 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map49 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 25)>
#map50 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map51 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 26)>
#map52 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map53 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 27)>
#map54 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 27)>
#map55 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 32)>
#map56 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 32)>
#map57 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 33)>
#map58 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 33)>
#map59 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 34)>
#map60 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 34)>
#map61 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 35)>
#map62 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 35)>
#map63 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 40)>
#map64 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 40)>
#map65 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 41)>
#map66 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 41)>
#map67 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 42)>
#map68 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 42)>
#map69 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 43)>
#map70 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 43)>
#map71 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 48)>
#map72 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 48)>
#map73 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 49)>
#map74 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 49)>
#map75 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 50)>
#map76 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 50)>
#map77 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 51)>
#map78 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 51)>
#map79 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 56)>
#map80 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 56)>
#map81 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 57)>
#map82 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 57)>
#map83 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 58)>
#map84 = affine_map<()[s0] -> ((s0 floordiv 64) * 62 + ((s0 mod 64) floordiv 32) * 4 + 58)>
#map85 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 62 + ((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) floordiv 1536) * 744 + (((s0 * 576 + s1 * 192 - ((s0 * 3 + s1) floordiv 8) * 1535) mod 1536) mod s2) * 248 + ((s3 mod 64) floordiv 32) * 4 + 59)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %68 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<642x8192xf32, strided<[8192, 1], offset: ?>>
        ...
        %84 = arith.muli %81, %c8192 overflow<nsw> : index
        %85 = arith.muli %83, %c8192 overflow<nsw> : index
        %86 = arith.addi %84, %82 overflow<nsw> : index
        %87 = arith.addi %85, %46 overflow<nsw> : index
        %base_buffer_9, %offset_10, %sizes_11:2, %strides_12:2 = memref.extract_strided_metadata %68 : memref<642x8192xf32, strided<[8192, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %88 = arith.addi %86, %offset_10 overflow<nsw> : index
        %reinterpret_cast_13 = memref.reinterpret_cast %68 to offset: [%88], sizes: [%c536870910], strides: [1] : memref<642x8192xf32, strided<[8192, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %89 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_13 validBytes(%c2147483643_i32) cacheSwizzleStride(%c-8192_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %96 = arith.muli %95, %c8192 overflow<nsw> : index
        ...
        %104 = arith.muli %103, %c8192 overflow<nsw> : index
        ...
        %112 = arith.muli %111, %c8192 overflow<nsw> : index
        ...
        %120 = arith.muli %119, %c8192 overflow<nsw> : index
        ...
        %128 = arith.muli %127, %c8192 overflow<nsw> : index
        ...
        %136 = arith.muli %135, %c8192 overflow<nsw> : index
        ...
        %144 = arith.muli %143, %c8192 overflow<nsw> : index
        ...
        %152 = arith.muli %151, %c8192 overflow<nsw> : index
        ...
        %160 = arith.muli %159, %c8192 overflow<nsw> : index
        ...
        %168 = arith.muli %167, %c8192 overflow<nsw> : index
        ...
        %176 = arith.muli %175, %c8192 overflow<nsw> : index
        ...
        %184 = arith.muli %183, %c8192 overflow<nsw> : index
        ...
        %192 = arith.muli %191, %c8192 overflow<nsw> : index
        ...
        %200 = arith.muli %199, %c8192 overflow<nsw> : index
        ...
        %208 = arith.muli %207, %c8192 overflow<nsw> : index
        ...
        %216 = arith.muli %215, %c8192 overflow<nsw> : index
        ...
        %224 = arith.muli %223, %c8192 overflow<nsw> : index
