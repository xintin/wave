...
#map3 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 16128 + s2 * 5376 + s3 * 8 - (s0 floordiv 16) * 16 - ((s1 * 3 + s2) floordiv 8) * 42992 - ((s1 * 1008 + s2 * 336 - ((s1 * 3 + s2) floordiv 8) * 2687) floordiv 896) * 14336)>
...
#map19 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4)>
...
#map23 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4 + 1)>
#map24 = affine_map<()[s0] -> ((s0 floordiv 64) * 68 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map25 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4 + 2)>
#map26 = affine_map<()[s0] -> ((s0 floordiv 64) * 68 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map27 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4 + 3)>
#map28 = affine_map<()[s0] -> ((s0 floordiv 64) * 68 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map29 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4 + 16)>
#map30 = affine_map<()[s0] -> ((s0 floordiv 64) * 68 + ((s0 mod 64) floordiv 16) * 4 + 16)>
#map31 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4 + 17)>
#map32 = affine_map<()[s0] -> ((s0 floordiv 64) * 68 + ((s0 mod 64) floordiv 16) * 4 + 17)>
#map33 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4 + 18)>
#map34 = affine_map<()[s0] -> ((s0 floordiv 64) * 68 + ((s0 mod 64) floordiv 16) * 4 + 18)>
#map35 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4 + 19)>
#map36 = affine_map<()[s0] -> ((s0 floordiv 64) * 68 + ((s0 mod 64) floordiv 16) * 4 + 19)>
#map37 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4 + 32)>
#map38 = affine_map<()[s0] -> ((s0 floordiv 64) * 68 + ((s0 mod 64) floordiv 16) * 4 + 32)>
#map39 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4 + 33)>
#map40 = affine_map<()[s0] -> ((s0 floordiv 64) * 68 + ((s0 mod 64) floordiv 16) * 4 + 33)>
#map41 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4 + 34)>
#map42 = affine_map<()[s0] -> ((s0 floordiv 64) * 68 + ((s0 mod 64) floordiv 16) * 4 + 34)>
#map43 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4 + 35)>
#map44 = affine_map<()[s0] -> ((s0 floordiv 64) * 68 + ((s0 mod 64) floordiv 16) * 4 + 35)>
#map45 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4 + 48)>
#map46 = affine_map<()[s0] -> ((s0 floordiv 64) * 68 + ((s0 mod 64) floordiv 16) * 4 + 48)>
#map47 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4 + 49)>
#map48 = affine_map<()[s0] -> ((s0 floordiv 64) * 68 + ((s0 mod 64) floordiv 16) * 4 + 49)>
#map49 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4 + 50)>
#map50 = affine_map<()[s0] -> ((s0 floordiv 64) * 68 + ((s0 mod 64) floordiv 16) * 4 + 50)>
#map51 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4 + 51)>
#map52 = affine_map<()[s0] -> ((s0 floordiv 64) * 68 + ((s0 mod 64) floordiv 16) * 4 + 51)>
#map53 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4 + 64)>
#map54 = affine_map<()[s0] -> ((s0 floordiv 64) * 68 + ((s0 mod 64) floordiv 16) * 4 + 64)>
#map55 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4 + 65)>
#map56 = affine_map<()[s0] -> ((s0 floordiv 64) * 68 + ((s0 mod 64) floordiv 16) * 4 + 65)>
#map57 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4 + 66)>
#map58 = affine_map<()[s0] -> ((s0 floordiv 64) * 68 + ((s0 mod 64) floordiv 16) * 4 + 66)>
#map59 = affine_map<()[s0, s1, s2] -> (((s0 * 1008 + s1 * 336 - ((s0 * 3 + s1) floordiv 8) * 2687) floordiv 896) * 272 + (s2 floordiv 64) * 68 + ((s2 mod 64) floordiv 16) * 4 + 67)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %70:5 = scf.for %arg3 = %c0 to %c255 step %c1 iter_args(%arg4 = %cst_4, %arg5 = %cst_4, %arg6 = %cst_4, %arg7 = %cst_4, %arg8 = %cst_4) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          amdgpu.lds_barrier
        ...
        %base_buffer_11, %offset_12, %sizes_13:2, %strides_14:2 = memref.extract_strided_metadata %98 : memref<706x14336xf32, strided<[14336, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %111 = arith.addi %109, %offset_12 overflow<nsw> : index
        %reinterpret_cast_15 = memref.reinterpret_cast %98 to offset: [%111], sizes: [%c536870910], strides: [1] : memref<706x14336xf32, strided<[14336, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %112 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_15 validBytes(%c2147483643_i32) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
