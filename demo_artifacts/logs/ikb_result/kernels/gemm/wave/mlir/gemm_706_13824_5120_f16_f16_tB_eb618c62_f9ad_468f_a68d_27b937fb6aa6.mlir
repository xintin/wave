...
#map2 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 84672 + s2 * 12096 + s3 * 8 - (s0 floordiv 16) * 16 - ((s1 * 7 + s2) floordiv 8) * 96752 - ((s1 * 5292 + s2 * 756 - ((s1 * 7 + s2) floordiv 8) * 6047) floordiv 864) * 13824)>
...
#map15 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 16) * 4)>
#map16 = affine_map<()[s0, s1] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104)>
#map17 = affine_map<()[s0, s1] -> (s0 * 84672 + s1 * 12096 - ((s0 * 7 + s1) floordiv 8) * 96752 - ((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 13824)>
#map18 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 16) * 4)>
#map19 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 16) * 4 + 1)>
#map20 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map21 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 16) * 4 + 2)>
#map22 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map23 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 16) * 4 + 3)>
#map24 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map25 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 16) * 4 + 16)>
#map26 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 16) * 4 + 16)>
#map27 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 16) * 4 + 17)>
#map28 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 16) * 4 + 17)>
#map29 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 16) * 4 + 18)>
#map30 = affine_map<()[s0] -> ((s0 floordiv 64) * 26 + ((s0 mod 64) floordiv 16) * 4 + 18)>
#map31 = affine_map<()[s0, s1, s2] -> (((s0 * 5292 + s1 * 756 - ((s0 * 7 + s1) floordiv 8) * 6047) floordiv 864) * 104 + (s2 floordiv 64) * 26 + ((s2 mod 64) floordiv 16) * 4 + 19)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %46:2 = scf.for %arg3 = %c0 to %c319 step %c1 iter_args(%arg4 = %cst_2, %arg5 = %cst_2) -> (vector<4xf32>, vector<4xf32>) {
          amdgpu.lds_barrier
        ...
        %71 = arith.muli %69, %c13824 overflow<nsw> : index
        ...
        %reinterpret_cast_13 = memref.reinterpret_cast %59 to offset: [%74], sizes: [%c536870910], strides: [1] : memref<706x13824xf32, strided<[13824, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        ...
        %82 = arith.muli %81, %c13824 overflow<nsw> : index
