#map = affine_map<()[s0, s1, s2] -> ((s0 floordiv 16) mod 16 + ((s1 * 64800 + s2 * 1440 - ((s1 * 45 + s2) floordiv 8) * 11519) floordiv 256) * 16)>
#map1 = affine_map<()[s0] -> (s0 mod 16)>
#map2 = affine_map<()[s0, s1, s2] -> (s1 * 1036800 + s2 * 23040 + (s0 floordiv 16) mod 16 - ((s1 * 45 + s2) floordiv 8) * 184304 - ((s1 * 64800 + s2 * 1440 - ((s1 * 45 + s2) floordiv 8) * 11519) floordiv 256) * 4096)>
...
#map13 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 1036800 + s2 * 23040 + s3 * 8 - (s0 floordiv 32) * 32 - ((s1 * 45 + s2) floordiv 8) * 184304 - ((s1 * 64800 + s2 * 1440 - ((s1 * 45 + s2) floordiv 8) * 11519) floordiv 256) * 4096)>
#map14 = affine_map<()[s0, s1] -> (s0 * 16 + (s1 floordiv 64) * 4 + 4)>
#map15 = affine_map<()[s0, s1, s2] -> (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4)>
#map16 = affine_map<()[s0, s1] -> (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 256) * 16)>
#map17 = affine_map<()[s0, s1] -> (s0 * 1036800 + s1 * 23040 - ((s0 * 45 + s1) floordiv 8) * 184304 - ((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 256) * 4096)>
#map18 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4)>
#map19 = affine_map<()[s0, s1, s2] -> (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 1)>
#map20 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map21 = affine_map<()[s0, s1, s2] -> (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 2)>
#map22 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map23 = affine_map<()[s0, s1, s2] -> (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 3)>
#map24 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map25 = affine_map<()[s0, s1, s2] -> (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 8)>
#map26 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map27 = affine_map<()[s0, s1, s2] -> (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 9)>
#map28 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map29 = affine_map<()[s0, s1, s2] -> (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 10)>
#map30 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map31 = affine_map<()[s0, s1, s2] -> (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 11)>
#map32 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map33 = affine_map<()[s0, s1, s2] -> (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 16)>
#map34 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map35 = affine_map<()[s0, s1, s2] -> (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 17)>
#map36 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map37 = affine_map<()[s0, s1, s2] -> (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 18)>
#map38 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map39 = affine_map<()[s0, s1, s2] -> (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 19)>
#map40 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map41 = affine_map<()[s0, s1, s2] -> (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 24)>
#map42 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map43 = affine_map<()[s0, s1, s2] -> (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 25)>
#map44 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map45 = affine_map<()[s0, s1, s2] -> (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 26)>
#map46 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map47 = affine_map<()[s0, s1, s2] -> (((s0 * 64800 + s1 * 1440 - ((s0 * 45 + s1) floordiv 8) * 11519) floordiv 256) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 32) * 4 + 27)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %9 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<4096x4096xf16, strided<[4096, 1], offset: ?>>
        ...
        %base_buffer_2, %offset_3, %sizes_4:2, %strides_5:2 = memref.extract_strided_metadata %9 : memref<4096x4096xf16, strided<[4096, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_6 = memref.reinterpret_cast %9 to offset: [%offset_3], sizes: [%c1073741822], strides: [1] : memref<4096x4096xf16, strided<[4096, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %48 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<706x4096xf32, strided<[4096, 1], offset: ?>>
        ...
        %base_buffer_7, %offset_8, %sizes_9:2, %strides_10:2 = memref.extract_strided_metadata %48 : memref<706x4096xf32, strided<[4096, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %68 = arith.addi %66, %offset_8 overflow<nsw> : index
        %reinterpret_cast_11 = memref.reinterpret_cast %48 to offset: [%68], sizes: [%c536870910], strides: [1] : memref<706x4096xf32, strided<[4096, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
