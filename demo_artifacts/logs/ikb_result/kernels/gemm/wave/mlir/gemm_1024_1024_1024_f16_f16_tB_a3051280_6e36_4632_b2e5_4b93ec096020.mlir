...
#map1 = affine_map<()[s0, s1, s2, s3] -> (s0 mod 16 + (s0 floordiv 64) * 4 + ((s1 * 512 + s2 * 8 - (s1 floordiv 8) * 4095) floordiv 2048) * 512 + (((s1 * 512 + s2 * 8 - (s1 floordiv 8) * 4095) mod 2048) mod s3) * 16)>
#map2 = affine_map<()[s0, s1] -> (s0 * 16 + (s1 floordiv 64) * 4 + 4)>
#map3 = affine_map<()[s0] -> (((s0 mod 64) floordiv 16) * 4)>
#map4 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 8 + (((s1 * 512 + s2 * 8 - (s1 floordiv 8) * 4095) mod 2048) floordiv s3) * 16)>
...
#map11 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 2048) * 512 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 2048) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4)>
#map12 = affine_map<()[s0, s1, s2] -> (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 2048) * 512 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 2048) mod s2) * 16)>
#map13 = affine_map<()[s0, s1, s2] -> ((((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 2048) floordiv s2) * 16)>
#map14 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4)>
#map15 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 2048) * 512 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 2048) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4 + 1)>
#map16 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map17 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 2048) * 512 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 2048) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4 + 2)>
#map18 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map19 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 4 + ((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) floordiv 2048) * 512 + (((s0 * 512 + s1 * 8 - (s0 floordiv 8) * 4095) mod 2048) mod s2) * 16 + ((s3 mod 64) floordiv 16) * 4 + 3)>
