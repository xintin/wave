...
#map1 = affine_map<()[s0, s1, s2] -> (((s0 * 6 + s1 + s2 - ((s0 * 6 + s1) floordiv 8) * 7) floordiv 16) * -8 + 6)>
#map2 = affine_map<()[s0, s1, s2, s3, s4, s5, s6] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8) floordiv 128) * 128 + ((s2 * 6 + s3 + s4 - ((s2 * 6 + s3) floordiv 8) * 7) floordiv 16) * 1024 + (((s2 * 6 + s3 + s5 - ((s2 * 6 + s3) floordiv 8) * 7) mod 16) mod s6) * 128)>
#map3 = affine_map<()[s0] -> (s0 * 8 - (s0 floordiv 8) * 64)>
#map4 = affine_map<()[s0, s1, s2, s3, s4, s5, s6] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 128) * 128 + ((s2 * 6 + s3 + s4 - ((s2 * 6 + s3) floordiv 8) * 7) floordiv 16) * 1024 + (((s2 * 6 + s3 + s5 - ((s2 * 6 + s3) floordiv 8) * 7) mod 16) mod s6) * 128 + 64)>
#map5 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8) floordiv 256) * 256 + (((s2 * 6 + s3 + s4 - ((s2 * 6 + s3) floordiv 8) * 7) mod 16) floordiv s5) * 256)>
#map6 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 256) * 256 + (((s2 * 6 + s3 + s4 - ((s2 * 6 + s3) floordiv 8) * 7) mod 16) floordiv s5) * 256 + 64)>
#map7 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 128) floordiv 256) * 256 + (((s2 * 6 + s3 + s4 - ((s2 * 6 + s3) floordiv 8) * 7) mod 16) floordiv s5) * 256 + 128)>
#map8 = affine_map<()[s0, s1, s2, s3, s4, s5] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 192) floordiv 256) * 256 + (((s2 * 6 + s3 + s4 - ((s2 * 6 + s3) floordiv 8) * 7) mod 16) floordiv s5) * 256 + 192)>
...
#map31 = affine_map<()[s0, s1, s2, s3, s4, s5] -> ((s5 floordiv 64) * 32 + ((s0 * 6 + s1 + s2 - ((s0 * 6 + s1) floordiv 8) * 7) floordiv 16) * 1024 + (((s0 * 6 + s1 + s3 - ((s0 * 6 + s1) floordiv 8) * 7) mod 16) mod s4) * 128 + ((s5 mod 64) floordiv 16) * 4)>
#map32 = affine_map<()[s0, s1, s2, s3, s4] -> (((s0 * 6 + s1 + s2 - ((s0 * 6 + s1) floordiv 8) * 7) floordiv 16) * 1024 + (((s0 * 6 + s1 + s3 - ((s0 * 6 + s1) floordiv 8) * 7) mod 16) mod s4) * 128)>
#map33 = affine_map<()[s0, s1, s2, s3] -> ((((s0 * 6 + s1 + s2 - ((s0 * 6 + s1) floordiv 8) * 7) mod 16) floordiv s3) * 256)>
#map34 = affine_map<()[s0] -> ((s0 floordiv 64) * 32 + ((s0 mod 64) floordiv 16) * 4)>
#map35 = affine_map<()[s0, s1, s2, s3, s4, s5] -> ((s5 floordiv 64) * 32 + ((s0 * 6 + s1 + s2 - ((s0 * 6 + s1) floordiv 8) * 7) floordiv 16) * 1024 + (((s0 * 6 + s1 + s3 - ((s0 * 6 + s1) floordiv 8) * 7) mod 16) mod s4) * 128 + ((s5 mod 64) floordiv 16) * 4 + 1)>
#map36 = affine_map<()[s0] -> ((s0 floordiv 64) * 32 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map37 = affine_map<()[s0, s1, s2, s3, s4, s5] -> ((s5 floordiv 64) * 32 + ((s0 * 6 + s1 + s2 - ((s0 * 6 + s1) floordiv 8) * 7) floordiv 16) * 1024 + (((s0 * 6 + s1 + s3 - ((s0 * 6 + s1) floordiv 8) * 7) mod 16) mod s4) * 128 + ((s5 mod 64) floordiv 16) * 4 + 2)>
#map38 = affine_map<()[s0] -> ((s0 floordiv 64) * 32 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map39 = affine_map<()[s0, s1, s2, s3, s4, s5] -> ((s5 floordiv 64) * 32 + ((s0 * 6 + s1 + s2 - ((s0 * 6 + s1) floordiv 8) * 7) floordiv 16) * 1024 + (((s0 * 6 + s1 + s3 - ((s0 * 6 + s1) floordiv 8) * 7) mod 16) mod s4) * 128 + ((s5 mod 64) floordiv 16) * 4 + 3)>
#map40 = affine_map<()[s0] -> ((s0 floordiv 64) * 32 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map41 = affine_map<()[s0, s1, s2, s3, s4, s5] -> ((s5 floordiv 64) * 32 + ((s0 * 6 + s1 + s2 - ((s0 * 6 + s1) floordiv 8) * 7) floordiv 16) * 1024 + (((s0 * 6 + s1 + s3 - ((s0 * 6 + s1) floordiv 8) * 7) mod 16) mod s4) * 128 + ((s5 mod 64) floordiv 16) * 4 + 16)>
#map42 = affine_map<()[s0] -> ((s0 floordiv 64) * 32 + ((s0 mod 64) floordiv 16) * 4 + 16)>
#map43 = affine_map<()[s0, s1, s2, s3, s4, s5] -> ((s5 floordiv 64) * 32 + ((s0 * 6 + s1 + s2 - ((s0 * 6 + s1) floordiv 8) * 7) floordiv 16) * 1024 + (((s0 * 6 + s1 + s3 - ((s0 * 6 + s1) floordiv 8) * 7) mod 16) mod s4) * 128 + ((s5 mod 64) floordiv 16) * 4 + 17)>
#map44 = affine_map<()[s0] -> ((s0 floordiv 64) * 32 + ((s0 mod 64) floordiv 16) * 4 + 17)>
#map45 = affine_map<()[s0, s1, s2, s3, s4, s5] -> ((s5 floordiv 64) * 32 + ((s0 * 6 + s1 + s2 - ((s0 * 6 + s1) floordiv 8) * 7) floordiv 16) * 1024 + (((s0 * 6 + s1 + s3 - ((s0 * 6 + s1) floordiv 8) * 7) mod 16) mod s4) * 128 + ((s5 mod 64) floordiv 16) * 4 + 18)>
#map46 = affine_map<()[s0] -> ((s0 floordiv 64) * 32 + ((s0 mod 64) floordiv 16) * 4 + 18)>
#map47 = affine_map<()[s0, s1, s2, s3, s4, s5] -> ((s5 floordiv 64) * 32 + ((s0 * 6 + s1 + s2 - ((s0 * 6 + s1) floordiv 8) * 7) floordiv 16) * 1024 + (((s0 * 6 + s1 + s3 - ((s0 * 6 + s1) floordiv 8) * 7) mod 16) mod s4) * 128 + ((s5 mod 64) floordiv 16) * 4 + 19)>
...
module attributes {transform.with_named_sequence} {
  stream.executable private @gemm {
    stream.executable.export public @gemm workgroups() -> (index, index, index) {
      ...
      stream.return %c6, %c2, %c1 : index, index, index
    }
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %20 = arith.cmpi slt, %19, %c641 : index
        %21 = vector.broadcast %20 : i1 to vector<8xi1>
        %22 = arith.muli %19, %c2880 overflow<nsw> : index
        ...
        %31 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<512x2880xf16, strided<[2880, 1], offset: ?>>
        %32 = affine.apply #map5()[%thread_id_x, %thread_id_y, %block_id_y, %block_id_x, %2, %4]
        %33 = arith.muli %32, %c2880 overflow<nsw> : index
        %34 = arith.addi %33, %8 overflow<nsw> : index
        %base_buffer_3, %offset_4, %sizes_5:2, %strides_6:2 = memref.extract_strided_metadata %31 : memref<512x2880xf16, strided<[2880, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_7 = memref.reinterpret_cast %31 to offset: [%offset_4], sizes: [%c1073741822], strides: [1] : memref<512x2880xf16, strided<[2880, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        %35 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_7 validBytes(%c2147483645_i32) cacheSwizzleStride(%c2880_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %38 = arith.muli %37, %c2880 overflow<nsw> : index
        ...
        %42 = arith.muli %41, %c2880 overflow<nsw> : index
        ...
        %46 = arith.muli %45, %c2880 overflow<nsw> : index
        ...
        %73:16 = scf.for %arg3 = %c0 to %c44 step %c1 iter_args(%arg4 = %cst_1, %arg5 = %cst_1, %arg6 = %cst_1, %arg7 = %cst_1, %arg8 = %cst_1, %arg9 = %cst_1, %arg10 = %cst_1, %arg11 = %cst_1, %arg12 = %cst_1, %arg13 = %cst_1, %arg14 = %cst_1, %arg15 = %cst_1, %arg16 = %cst_1, %arg17 = %cst_1, %arg18 = %cst_1, %arg19 = %cst_1) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          ...
          %444 = arith.addi %9, %443 overflow<nsw> : index
          ...
          %449 = arith.select %7, %448, %cst_0 : vector<8xi1>, vector<8xindex>
          ...
          %452 = arith.addi %22, %443 overflow<nsw> : index
          ...
          %457 = arith.select %21, %456, %cst_0 : vector<8xi1>, vector<8xindex>
          ...
          amdgpu.lds_barrier
          llvm.call_intrinsic "llvm.amdgcn.sched.barrier"(%c0_i32) : (i32) -> ()
          vector.store %451, %view_2[%49, %8] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %459, %view_2[%50, %8] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %481, %view[%53, %8] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %483, %view[%51, %8] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %487, %view[%54, %8] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %485, %view[%52, %8] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          rocdl.s.barrier
          llvm.call_intrinsic "llvm.amdgcn.sched.barrier"(%c0_i32) : (i32) -> ()
          rocdl.s.setprio 1
        ...
        %193 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<641x512xf32, strided<[512, 1], offset: ?>>
        %194 = affine.apply #map31()[%block_id_y, %block_id_x, %2, %2, %4, %thread_id_x]
        %195 = arith.cmpi slt, %194, %c641 : index
        ...
        %199 = arith.muli %196, %c512 overflow<nsw> : index
        %200 = arith.muli %198, %c512 overflow<nsw> : index
        %201 = arith.addi %199, %197 overflow<nsw> : index
        %202 = arith.addi %200, %74 overflow<nsw> : index
        %base_buffer_8, %offset_9, %sizes_10:2, %strides_11:2 = memref.extract_strided_metadata %193 : memref<641x512xf32, strided<[512, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %203 = arith.addi %201, %offset_9 overflow<nsw> : index
        %reinterpret_cast_12 = memref.reinterpret_cast %193 to offset: [%203], sizes: [%c536870910], strides: [1] : memref<641x512xf32, strided<[512, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %204 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_12 validBytes(%c2147483643_i32) cacheSwizzleStride(%c512_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %208 = arith.cmpi slt, %207, %c641 : index
        ...
        %222 = arith.cmpi slt, %221, %c641 : index
        ...
        %334 = arith.cmpi slt, %333, %c641 : index
