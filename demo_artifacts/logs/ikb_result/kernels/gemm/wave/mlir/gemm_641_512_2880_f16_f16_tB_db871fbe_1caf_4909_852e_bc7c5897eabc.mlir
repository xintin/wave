...
#map62 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 32 + s4 * 8 + (((s1 * 196 + s2 * 28 - ((s1 * 7 + s2) floordiv 8) * 223) mod 96) floordiv s3) * 16)>
#map63 = affine_map<()[s0, s1] -> (s0 * 96 + (s1 floordiv 64) * 24 + 24)>
#map64 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4)>
#map65 = affine_map<()[s0, s1, s2] -> (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96)>
#map66 = affine_map<()[s0, s1, s2] -> ((((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) floordiv s2) * 16)>
#map67 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4)>
#map68 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 1)>
#map69 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 1)>
#map70 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 2)>
#map71 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 2)>
#map72 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 3)>
#map73 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 3)>
#map74 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 8)>
#map75 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 8)>
#map76 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 9)>
#map77 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 9)>
#map78 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 10)>
#map79 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 10)>
#map80 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 11)>
#map81 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 11)>
#map82 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 16)>
#map83 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 16)>
#map84 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 17)>
#map85 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 17)>
#map86 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 18)>
#map87 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 18)>
#map88 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 19)>
#map89 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 19)>
#map90 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 24)>
#map91 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 24)>
#map92 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 25)>
#map93 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 25)>
#map94 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 26)>
#map95 = affine_map<()[s0] -> ((s0 floordiv 64) * 24 + ((s0 mod 64) floordiv 32) * 4 + 26)>
#map96 = affine_map<()[s0, s1, s2, s3] -> ((s3 floordiv 64) * 24 + ((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) floordiv 96) * 288 + (((s0 * 196 + s1 * 28 - ((s0 * 7 + s1) floordiv 8) * 223) mod 96) mod s2) * 96 + ((s3 mod 64) floordiv 32) * 4 + 27)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %base_buffer_38, %offset_39, %sizes_40:2, %strides_41:2 = memref.extract_strided_metadata %165 : memref<512x2880xf16, strided<[2880, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_42 = memref.reinterpret_cast %165 to offset: [%offset_39], sizes: [%c1073741822], strides: [1] : memref<512x2880xf16, strided<[2880, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %569 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<641x512xf32, strided<[512, 1], offset: ?>>
        ...
        %583 = arith.muli %580, %c512 overflow<nsw> : index
        %584 = arith.muli %582, %c512 overflow<nsw> : index
        %585 = arith.addi %583, %581 overflow<nsw> : index
        %586 = arith.addi %584, %365 overflow<nsw> : index
        %base_buffer_43, %offset_44, %sizes_45:2, %strides_46:2 = memref.extract_strided_metadata %569 : memref<641x512xf32, strided<[512, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %587 = arith.addi %585, %offset_44 overflow<nsw> : index
        %reinterpret_cast_47 = memref.reinterpret_cast %569 to offset: [%587], sizes: [%c536870910], strides: [1] : memref<641x512xf32, strided<[512, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %588 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_47 validBytes(%c2147483643_i32) cacheSwizzleStride(%c512_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
