...
#map1 = affine_map<()[s0, s1, s2] -> (s0 mod 16 + ((s1 * 16200 + s2 * 360 - ((s1 * 45 + s2) floordiv 8) * 2879) floordiv 64) * 16 + (s0 floordiv 64) * 4)>
#map2 = affine_map<()[s0] -> (((s0 mod 64) floordiv 16) * 4)>
#map3 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 259200 + s2 * 5760 + s3 * 8 - (s0 floordiv 16) * 16 - ((s1 * 45 + s2) floordiv 8) * 46064 - ((s1 * 16200 + s2 * 360 - ((s1 * 45 + s2) floordiv 8) * 2879) floordiv 64) * 1024)>
...
#map10 = affine_map<()[s0, s1, s2] -> (((s0 * 16200 + s1 * 360 - ((s0 * 45 + s1) floordiv 8) * 2879) floordiv 64) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4)>
#map11 = affine_map<()[s0, s1] -> (((s0 * 16200 + s1 * 360 - ((s0 * 45 + s1) floordiv 8) * 2879) floordiv 64) * 16)>
#map12 = affine_map<()[s0, s1] -> (s0 * 259200 + s1 * 5760 - ((s0 * 45 + s1) floordiv 8) * 46064 - ((s0 * 16200 + s1 * 360 - ((s0 * 45 + s1) floordiv 8) * 2879) floordiv 64) * 1024)>
#map13 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4)>
#map14 = affine_map<()[s0, s1, s2] -> (((s0 * 16200 + s1 * 360 - ((s0 * 45 + s1) floordiv 8) * 2879) floordiv 64) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4 + 1)>
#map15 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map16 = affine_map<()[s0, s1, s2] -> (((s0 * 16200 + s1 * 360 - ((s0 * 45 + s1) floordiv 8) * 2879) floordiv 64) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4 + 2)>
#map17 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map18 = affine_map<()[s0, s1, s2] -> (((s0 * 16200 + s1 * 360 - ((s0 * 45 + s1) floordiv 8) * 2879) floordiv 64) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4 + 3)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %17 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<1024x4096xf16, strided<[4096, 1], offset: ?>>
        ...
        %base_buffer_4, %offset_5, %sizes_6:2, %strides_7:2 = memref.extract_strided_metadata %17 : memref<1024x4096xf16, strided<[4096, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_8 = memref.reinterpret_cast %17 to offset: [%offset_5], sizes: [%c1073741822], strides: [1] : memref<1024x4096xf16, strided<[4096, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %46 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<706x1024xf32, strided<[1024, 1], offset: ?>>
        ...
        %base_buffer_9, %offset_10, %sizes_11:2, %strides_12:2 = memref.extract_strided_metadata %46 : memref<706x1024xf32, strided<[1024, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %57 = arith.addi %55, %offset_10 overflow<nsw> : index
        %reinterpret_cast_13 = memref.reinterpret_cast %46 to offset: [%57], sizes: [%c536870910], strides: [1] : memref<706x1024xf32, strided<[1024, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
