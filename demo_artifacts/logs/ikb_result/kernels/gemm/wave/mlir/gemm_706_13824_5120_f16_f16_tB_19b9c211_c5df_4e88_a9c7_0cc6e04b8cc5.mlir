...
#map2 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 6912 + s2 * 27648 + s3 * 8 - (s0 floordiv 16) * 16 - ((s1 + s2 * 4) floordiv 8) * 55280 - ((s1 * 432 + s2 * 1728 - ((s1 + s2 * 4) floordiv 8) * 3455) floordiv 864) * 13824)>
...
#map9 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 47)>
#map10 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 47 + 16)>
#map11 = affine_map<()[s0] -> (s0 mod 16 + (s0 floordiv 64) * 47 + 32)>
...
#map16 = affine_map<()[s0, s1, s2] -> (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 864) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4)>
...
#map19 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4)>
#map20 = affine_map<()[s0, s1, s2] -> (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 864) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 1)>
#map21 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map22 = affine_map<()[s0, s1, s2] -> (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 864) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 2)>
#map23 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map24 = affine_map<()[s0, s1, s2] -> (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 864) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 3)>
#map25 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map26 = affine_map<()[s0, s1, s2] -> (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 864) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 16)>
#map27 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 16)>
#map28 = affine_map<()[s0, s1, s2] -> (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 864) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 17)>
#map29 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 17)>
#map30 = affine_map<()[s0, s1, s2] -> (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 864) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 18)>
#map31 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 18)>
#map32 = affine_map<()[s0, s1, s2] -> (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 864) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 19)>
#map33 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 19)>
#map34 = affine_map<()[s0, s1, s2] -> (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 864) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 32)>
#map35 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 32)>
#map36 = affine_map<()[s0, s1, s2] -> (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 864) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 33)>
#map37 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 33)>
#map38 = affine_map<()[s0, s1, s2] -> (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 864) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 34)>
#map39 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 34)>
#map40 = affine_map<()[s0, s1, s2] -> (((s0 * 432 + s1 * 1728 - ((s0 + s1 * 4) floordiv 8) * 3455) floordiv 864) * 188 + (s2 floordiv 64) * 47 + ((s2 mod 64) floordiv 16) * 4 + 35)>
#map41 = affine_map<()[s0] -> ((s0 floordiv 64) * 47 + ((s0 mod 64) floordiv 16) * 4 + 35)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %21 = arith.muli %16, %c5120 overflow<nsw> : index
        ...
        %23 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_10 validBytes(%c2147483645_i32) cacheSwizzleStride(%c5120_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %32 = arith.minsi %31, %c188 : index
        %33 = affine.apply #map6()[%thread_id_x, %thread_id_y]
        %34 = arith.cmpi slt, %33, %32 : index
        %35 = vector.broadcast %34 : i1 to vector<6xi1>
        vector.maskedstore %view_5[%33, %4], %35, %14 : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<6xi1>, vector<6xf16>
        ...
        %49:3 = scf.for %arg3 = %c0 to %c319 step %c1 iter_args(%arg4 = %cst_4, %arg5 = %cst_4, %arg6 = %cst_4) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          amdgpu.lds_barrier
          ...
          %174 = vector.maskedload %view_5[%40, %20], %42, %cst : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %175 = vector.maskedload %view_5[%43, %20], %45, %cst : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %176 = vector.maskedload %view_5[%46, %20], %48, %cst : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          ...
          amdgpu.lds_barrier
          vector.maskedstore %view_5[%33, %4], %35, %185 : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<6xi1>, vector<6xf16>
        ...
        %54 = vector.maskedload %view_5[%51, %20], %53, %cst : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %55 = affine.apply #map10()[%thread_id_x]
        %56 = arith.cmpi slt, %55, %32 : index
        %57 = vector.broadcast %56 : i1 to vector<4xi1>
        %58 = vector.maskedload %view_5[%55, %20], %57, %cst : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %59 = affine.apply #map11()[%thread_id_x]
        %60 = arith.cmpi slt, %59, %32 : index
        %61 = vector.broadcast %60 : i1 to vector<4xi1>
        %62 = vector.maskedload %view_5[%59, %20], %61, %cst : memref<188x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        ...
        %67 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<706x13824xf32, strided<[13824, 1], offset: ?>>
        %68 = affine.apply #map14()[%block_id_x, %thread_id_x]
        %69 = affine.apply #map15()[%block_id_x]
        %70 = arith.minsi %68, %69 : index
        %71 = arith.minsi %70, %c706 : index
        ...
        %78 = arith.muli %75, %c13824 overflow<nsw> : index
        %79 = arith.muli %77, %c13824 overflow<nsw> : index
        %80 = arith.addi %78, %76 overflow<nsw> : index
        %81 = arith.addi %79, %36 overflow<nsw> : index
        %base_buffer_11, %offset_12, %sizes_13:2, %strides_14:2 = memref.extract_strided_metadata %67 : memref<706x13824xf32, strided<[13824, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %82 = arith.addi %80, %offset_12 overflow<nsw> : index
        %reinterpret_cast_15 = memref.reinterpret_cast %67 to offset: [%82], sizes: [%c536870910], strides: [1] : memref<706x13824xf32, strided<[13824, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %83 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_15 validBytes(%c2147483643_i32) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %90 = arith.muli %89, %c13824 overflow<nsw> : index
        ...
        %98 = arith.muli %97, %c13824 overflow<nsw> : index
        ...
        %106 = arith.muli %105, %c13824 overflow<nsw> : index
        ...
        %114 = arith.muli %113, %c13824 overflow<nsw> : index
        ...
        %122 = arith.muli %121, %c13824 overflow<nsw> : index
        ...
        %130 = arith.muli %129, %c13824 overflow<nsw> : index
        ...
        %138 = arith.muli %137, %c13824 overflow<nsw> : index
        ...
        %146 = arith.muli %145, %c13824 overflow<nsw> : index
