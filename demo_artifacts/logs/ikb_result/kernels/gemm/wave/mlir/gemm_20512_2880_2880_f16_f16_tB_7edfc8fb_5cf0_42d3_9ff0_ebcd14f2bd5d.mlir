...
#map3 = affine_map<()[s0, s1, s2, s3] -> (s1 * 128 + s2 * 601529784 + s3 * 469212 + s0 floordiv 2 - ((s1 * 128 + s0 floordiv 2) floordiv 732) * 732 - ((s2 * 1282 + s3) floordiv 8) * 3752964 - ((s2 * 821762 + s3 * 641 - ((s2 * 1282 + s3) floordiv 8) * 5127) floordiv 4) * 2928)>
#map4 = affine_map<()[s0] -> (s0 * 8 - (s0 floordiv 2) * 16)>
#map5 = affine_map<()[s0, s1, s2, s3] -> (s1 * 128 + s2 * 601529784 + s3 * 469212 + s0 floordiv 2 - ((s1 * 128 + s0 floordiv 2 + 256) floordiv 732) * 732 - ((s2 * 1282 + s3) floordiv 8) * 3752964 - ((s2 * 821762 + s3 * 641 - ((s2 * 1282 + s3) floordiv 8) * 5127) floordiv 4) * 2928 + 256)>
#map6 = affine_map<()[s0, s1, s2, s3] -> (s1 * 128 + s2 * 601529784 + s3 * 469212 + s0 floordiv 2 - ((s1 * 128 + s0 floordiv 2 + 512) floordiv 732) * 732 - ((s2 * 1282 + s3) floordiv 8) * 3752964 - ((s2 * 821762 + s3 * 641 - ((s2 * 1282 + s3) floordiv 8) * 5127) floordiv 4) * 2928 + 512)>
...
#map38 = affine_map<()[s0, s1] -> (s0 * 732 + s1 * 366 + 366)>
#map39 = affine_map<()[s0] -> (s0 * 732 + 732)>
#map40 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928)>
#map41 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4)>
#map42 = affine_map<()[s0, s1] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16)>
#map43 = affine_map<()[s0, s1] -> (s0 * 601529784 + s1 * 469212 - ((s0 * 1282 + s1) floordiv 8) * 3752964 - ((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 2928)>
#map44 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4)>
#map45 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4 + 1)>
#map46 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 1)>
#map47 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4 + 2)>
#map48 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 2)>
#map49 = affine_map<()[s0, s1, s2] -> (((s0 * 821762 + s1 * 641 - ((s0 * 1282 + s1) floordiv 8) * 5127) floordiv 4) * 16 + (s2 floordiv 64) * 4 + ((s2 mod 64) floordiv 16) * 4 + 3)>
#map50 = affine_map<()[s0] -> ((s0 floordiv 64) * 4 + ((s0 mod 64) floordiv 16) * 4 + 3)>
#map51 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 16)>
#map52 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 32)>
#map53 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 48)>
#map54 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 64)>
#map55 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 80)>
#map56 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 96)>
#map57 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 112)>
#map58 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 128)>
#map59 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 144)>
#map60 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 160)>
#map61 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 176)>
#map62 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 192)>
#map63 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 208)>
#map64 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 224)>
#map65 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 240)>
#map66 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 256)>
#map67 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 272)>
#map68 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 288)>
#map69 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 304)>
#map70 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 320)>
#map71 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 336)>
#map72 = affine_map<()[s0, s1, s2, s3] -> (s0 + s1 * 601529784 + s2 * 469212 + s3 * 366 - (s0 floordiv 16) * 16 - ((s1 * 1282 + s2) floordiv 8) * 3752964 - ((s1 * 821762 + s2 * 641 - ((s1 * 1282 + s2) floordiv 8) * 5127) floordiv 4) * 2928 + 352)>
  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        vector.maskedstore %view[%61, %20], %63, %30 : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        %64 = affine.apply #map11()[%thread_id_x, %thread_id_y]
        %65 = arith.cmpi slt, %64, %60 : index
        %66 = vector.broadcast %65 : i1 to vector<8xi1>
        vector.maskedstore %view[%64, %20], %66, %42 : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        %67 = affine.apply #map12()[%thread_id_x, %thread_id_y]
        %68 = arith.cmpi slt, %67, %60 : index
        %69 = vector.broadcast %68 : i1 to vector<8xi1>
        vector.maskedstore %view[%67, %20], %69, %54 : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        ...
        %139:23 = scf.for %arg3 = %c0 to %c179 step %c1 iter_args(%arg4 = %cst_4, %arg5 = %cst_4, %arg6 = %cst_4, %arg7 = %cst_4, %arg8 = %cst_4, %arg9 = %cst_4, %arg10 = %cst_4, %arg11 = %cst_4, %arg12 = %cst_4, %arg13 = %cst_4, %arg14 = %cst_4, %arg15 = %cst_4, %arg16 = %cst_4, %arg17 = %cst_4, %arg18 = %cst_4, %arg19 = %cst_4, %arg20 = %cst_4, %arg21 = %cst_4, %arg22 = %cst_4, %arg23 = %cst_4, %arg24 = %cst_4, %arg25 = %cst_4, %arg26 = %cst_4) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          amdgpu.lds_barrier
          %697 = vector.maskedload %view[%70, %5], %72, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %698 = vector.maskedload %view[%73, %5], %75, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %699 = vector.maskedload %view[%76, %5], %78, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %700 = vector.maskedload %view[%79, %5], %81, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %701 = vector.maskedload %view[%82, %5], %84, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %702 = vector.maskedload %view[%85, %5], %87, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %703 = vector.maskedload %view[%88, %5], %90, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %704 = vector.maskedload %view[%91, %5], %93, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %705 = vector.maskedload %view[%94, %5], %96, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %706 = vector.maskedload %view[%97, %5], %99, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %707 = vector.maskedload %view[%100, %5], %102, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %708 = vector.maskedload %view[%103, %5], %105, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %709 = vector.maskedload %view[%106, %5], %108, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %710 = vector.maskedload %view[%109, %5], %111, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %711 = vector.maskedload %view[%112, %5], %114, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %712 = vector.maskedload %view[%115, %5], %117, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %713 = vector.maskedload %view[%118, %5], %120, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %714 = vector.maskedload %view[%121, %5], %123, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %715 = vector.maskedload %view[%124, %5], %126, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %716 = vector.maskedload %view[%127, %5], %129, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %717 = vector.maskedload %view[%130, %5], %132, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %718 = vector.maskedload %view[%133, %5], %135, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          %719 = vector.maskedload %view[%136, %5], %138, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
          ...
          vector.maskedstore %view[%61, %20], %63, %738 : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
          vector.maskedstore %view[%64, %20], %66, %746 : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
          vector.maskedstore %view[%67, %20], %69, %754 : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<8xi1>, vector<8xf16>
        ...
        %143 = vector.maskedload %view[%140, %5], %142, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %144 = affine.apply #map14()[%thread_id_x, %thread_id_y]
        %145 = arith.cmpi slt, %144, %60 : index
        %146 = vector.broadcast %145 : i1 to vector<4xi1>
        %147 = vector.maskedload %view[%144, %5], %146, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %148 = affine.apply #map15()[%thread_id_x, %thread_id_y]
        %149 = arith.cmpi slt, %148, %60 : index
        %150 = vector.broadcast %149 : i1 to vector<4xi1>
        %151 = vector.maskedload %view[%148, %5], %150, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %152 = affine.apply #map16()[%thread_id_x, %thread_id_y]
        %153 = arith.cmpi slt, %152, %60 : index
        %154 = vector.broadcast %153 : i1 to vector<4xi1>
        %155 = vector.maskedload %view[%152, %5], %154, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %156 = affine.apply #map17()[%thread_id_x, %thread_id_y]
        %157 = arith.cmpi slt, %156, %60 : index
        %158 = vector.broadcast %157 : i1 to vector<4xi1>
        %159 = vector.maskedload %view[%156, %5], %158, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %160 = affine.apply #map18()[%thread_id_x, %thread_id_y]
        %161 = arith.cmpi slt, %160, %60 : index
        %162 = vector.broadcast %161 : i1 to vector<4xi1>
        %163 = vector.maskedload %view[%160, %5], %162, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %164 = affine.apply #map19()[%thread_id_x, %thread_id_y]
        %165 = arith.cmpi slt, %164, %60 : index
        %166 = vector.broadcast %165 : i1 to vector<4xi1>
        %167 = vector.maskedload %view[%164, %5], %166, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %168 = affine.apply #map20()[%thread_id_x, %thread_id_y]
        %169 = arith.cmpi slt, %168, %60 : index
        %170 = vector.broadcast %169 : i1 to vector<4xi1>
        %171 = vector.maskedload %view[%168, %5], %170, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %172 = affine.apply #map21()[%thread_id_x, %thread_id_y]
        %173 = arith.cmpi slt, %172, %60 : index
        %174 = vector.broadcast %173 : i1 to vector<4xi1>
        %175 = vector.maskedload %view[%172, %5], %174, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %176 = affine.apply #map22()[%thread_id_x, %thread_id_y]
        %177 = arith.cmpi slt, %176, %60 : index
        %178 = vector.broadcast %177 : i1 to vector<4xi1>
        %179 = vector.maskedload %view[%176, %5], %178, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %180 = affine.apply #map23()[%thread_id_x, %thread_id_y]
        %181 = arith.cmpi slt, %180, %60 : index
        %182 = vector.broadcast %181 : i1 to vector<4xi1>
        %183 = vector.maskedload %view[%180, %5], %182, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %184 = affine.apply #map24()[%thread_id_x, %thread_id_y]
        %185 = arith.cmpi slt, %184, %60 : index
        %186 = vector.broadcast %185 : i1 to vector<4xi1>
        %187 = vector.maskedload %view[%184, %5], %186, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %188 = affine.apply #map25()[%thread_id_x, %thread_id_y]
        %189 = arith.cmpi slt, %188, %60 : index
        %190 = vector.broadcast %189 : i1 to vector<4xi1>
        %191 = vector.maskedload %view[%188, %5], %190, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %192 = affine.apply #map26()[%thread_id_x, %thread_id_y]
        %193 = arith.cmpi slt, %192, %60 : index
        %194 = vector.broadcast %193 : i1 to vector<4xi1>
        %195 = vector.maskedload %view[%192, %5], %194, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %196 = affine.apply #map27()[%thread_id_x, %thread_id_y]
        %197 = arith.cmpi slt, %196, %60 : index
        %198 = vector.broadcast %197 : i1 to vector<4xi1>
        %199 = vector.maskedload %view[%196, %5], %198, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %200 = affine.apply #map28()[%thread_id_x, %thread_id_y]
        %201 = arith.cmpi slt, %200, %60 : index
        %202 = vector.broadcast %201 : i1 to vector<4xi1>
        %203 = vector.maskedload %view[%200, %5], %202, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %204 = affine.apply #map29()[%thread_id_x, %thread_id_y]
        %205 = arith.cmpi slt, %204, %60 : index
        %206 = vector.broadcast %205 : i1 to vector<4xi1>
        %207 = vector.maskedload %view[%204, %5], %206, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %208 = affine.apply #map30()[%thread_id_x, %thread_id_y]
        %209 = arith.cmpi slt, %208, %60 : index
        %210 = vector.broadcast %209 : i1 to vector<4xi1>
        %211 = vector.maskedload %view[%208, %5], %210, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %212 = affine.apply #map31()[%thread_id_x, %thread_id_y]
        %213 = arith.cmpi slt, %212, %60 : index
        %214 = vector.broadcast %213 : i1 to vector<4xi1>
        %215 = vector.maskedload %view[%212, %5], %214, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %216 = affine.apply #map32()[%thread_id_x, %thread_id_y]
        %217 = arith.cmpi slt, %216, %60 : index
        %218 = vector.broadcast %217 : i1 to vector<4xi1>
        %219 = vector.maskedload %view[%216, %5], %218, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %220 = affine.apply #map33()[%thread_id_x, %thread_id_y]
        %221 = arith.cmpi slt, %220, %60 : index
        %222 = vector.broadcast %221 : i1 to vector<4xi1>
        %223 = vector.maskedload %view[%220, %5], %222, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %224 = affine.apply #map34()[%thread_id_x, %thread_id_y]
        %225 = arith.cmpi slt, %224, %60 : index
        %226 = vector.broadcast %225 : i1 to vector<4xi1>
        %227 = vector.maskedload %view[%224, %5], %226, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        %228 = affine.apply #map35()[%thread_id_x, %thread_id_y]
        %229 = arith.cmpi slt, %228, %60 : index
        %230 = vector.broadcast %229 : i1 to vector<4xi1>
        %231 = vector.maskedload %view[%228, %5], %230, %cst : memref<732x20xf16, #gpu.address_space<workgroup>>, vector<4xi1>, vector<4xf16> into vector<4xf16>
        ...
        %257 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<20512x2880xf32, strided<[2880, 1], offset: ?>>
        %258 = affine.apply #map38()[%block_id_y, %thread_id_y]
        %259 = affine.apply #map39()[%block_id_y]
        %260 = arith.minsi %258, %259 : index
        %261 = arith.minsi %260, %c2880 : index
        ...
        %270 = arith.muli %267, %c2880 overflow<nsw> : index
        %271 = arith.muli %269, %c2880 overflow<nsw> : index
        %272 = arith.addi %270, %268 overflow<nsw> : index
        %273 = arith.addi %271, %140 overflow<nsw> : index
        %base_buffer_11, %offset_12, %sizes_13:2, %strides_14:2 = memref.extract_strided_metadata %257 : memref<20512x2880xf32, strided<[2880, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %274 = arith.addi %272, %offset_12 overflow<nsw> : index
        %reinterpret_cast_15 = memref.reinterpret_cast %257 to offset: [%274], sizes: [%c536870910], strides: [1] : memref<20512x2880xf32, strided<[2880, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %275 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_15 validBytes(%c2147483643_i32) cacheSwizzleStride(%c2880_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
