...
module attributes {transform.with_named_sequence} {
  stream.executable private @gemm {
    stream.executable.export public @gemm workgroups() -> (index, index, index) {
      ...
      stream.return %c161, %c23, %c1 : index, index, index
    }
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %block_id_y = gpu.block_id  y upper_bound 23
        ...
        %27 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<5760x2880xf16, strided<[2880, 1], offset: ?>>
        %28 = affine.apply #map3()[%thread_id_x, %thread_id_y, %block_id_y]
        %29 = arith.cmpi slt, %28, %c5760 : index
        %30 = vector.broadcast %29 : i1 to vector<8xi1>
        %31 = arith.muli %28, %c2880 overflow<nsw> : index
        %32 = arith.addi %31, %4 overflow<nsw> : index
        %base_buffer_3, %offset_4, %sizes_5:2, %strides_6:2 = memref.extract_strided_metadata %27 : memref<5760x2880xf16, strided<[2880, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_7 = memref.reinterpret_cast %27 to offset: [%offset_4], sizes: [%c1073741822], strides: [1] : memref<5760x2880xf16, strided<[2880, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %42 = arith.cmpi slt, %41, %c5760 : index
        ...
        %54 = arith.cmpi slt, %53, %c5760 : index
        ...
        %66 = arith.cmpi slt, %65, %c5760 : index
        ...
        %221 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<20512x5760xf32, strided<[5760, 1], offset: ?>>
        %222 = affine.apply #map29()[%thread_id_x, %block_id_y, %thread_id_y]
        %223 = arith.cmpi slt, %222, %c5760 : index
        ...
        %230 = arith.muli %227, %c5760 overflow<nsw> : index
        %231 = arith.muli %229, %c5760 overflow<nsw> : index
        %232 = arith.addi %230, %228 overflow<nsw> : index
        %233 = arith.addi %231, %102 overflow<nsw> : index
        %base_buffer_8, %offset_9, %sizes_10:2, %strides_11:2 = memref.extract_strided_metadata %221 : memref<20512x5760xf32, strided<[5760, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %234 = arith.addi %232, %offset_9 overflow<nsw> : index
        %reinterpret_cast_12 = memref.reinterpret_cast %221 to offset: [%234], sizes: [%c536870910], strides: [1] : memref<20512x5760xf32, strided<[5760, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %235 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_12 validBytes(%c2147483643_i64) cacheSwizzleStride(%c5760_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %242 = arith.muli %241, %c5760 overflow<nsw> : index
        ...
        %250 = arith.muli %249, %c5760 overflow<nsw> : index
        ...
        %258 = arith.muli %257, %c5760 overflow<nsw> : index
        ...
        %263 = arith.cmpi slt, %262, %c5760 : index
        ...
        %281 = arith.cmpi slt, %280, %c5760 : index
        ...
        %299 = arith.cmpi slt, %298, %c5760 : index
        ...
        %317 = arith.cmpi slt, %316, %c5760 : index
        ...
        %335 = arith.cmpi slt, %334, %c5760 : index
        ...
        %353 = arith.cmpi slt, %352, %c5760 : index
        ...
        %371 = arith.cmpi slt, %370, %c5760 : index
        ...
        %392 = arith.muli %391, %c5760 overflow<nsw> : index
        ...
        %400 = arith.muli %399, %c5760 overflow<nsw> : index
        ...
        %408 = arith.muli %407, %c5760 overflow<nsw> : index
        ...
        %416 = arith.muli %415, %c5760 overflow<nsw> : index
