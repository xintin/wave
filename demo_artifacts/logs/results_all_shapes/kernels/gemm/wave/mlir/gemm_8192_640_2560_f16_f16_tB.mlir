...
module attributes {transform.with_named_sequence} {
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %0 = stream.binding.subspan %arg0[%c0] : !stream.binding -> memref<8192x2560xf16, strided<[2560, 1], offset: ?>>
        ...
        %base_buffer, %offset, %sizes:2, %strides:2 = memref.extract_strided_metadata %0 : memref<8192x2560xf16, strided<[2560, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast = memref.reinterpret_cast %0 to offset: [%offset], sizes: [%c1073741822], strides: [1] : memref<8192x2560xf16, strided<[2560, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %88:16 = scf.for %arg3 = %c0 to %c39 step %c1 iter_args(%arg4 = %cst_1, %arg5 = %cst_1, %arg6 = %cst_1, %arg7 = %cst_1, %arg8 = %cst_1, %arg9 = %cst_1, %arg10 = %cst_1, %arg11 = %cst_1, %arg12 = %cst_1, %arg13 = %cst_1, %arg14 = %cst_1, %arg15 = %cst_1, %arg16 = %cst_1, %arg17 = %cst_1, %arg18 = %cst_1, %arg19 = %cst_1) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          ...
          llvm.call_intrinsic "llvm.amdgcn.sched.barrier"(%c0_i32) : (i32) -> ()
          %483 = arith.addi %31, %458 overflow<nsw> : index
          ...
          %488 = arith.select %30, %487, %cst_0 : vector<8xi1>, vector<8xindex>
          ...
          %491 = arith.addi %43, %458 overflow<nsw> : index
          ...
          %496 = arith.select %42, %495, %cst_0 : vector<8xi1>, vector<8xindex>
          ...
          %507 = arith.addi %55, %458 overflow<nsw> : index
          ...
          %512 = arith.select %54, %511, %cst_0 : vector<8xi1>, vector<8xindex>
          ...
          vector.store %514, %view[%69, %5] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %490, %view[%67, %5] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %498, %view[%68, %5] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
  ...
  func.func @isolated_benchmark(%arg0: tensor<8192x2560xf16>, %arg1: tensor<640x2560xf16>, %arg2: tensor<8192x640xf32>) -> tensor<8192x640xf32> {
    %0 = flow.dispatch @gemm::@gemm(%arg0, %arg1, %arg2) : (tensor<8192x2560xf16>, tensor<640x2560xf16>, tensor<8192x640xf32>) -> %arg2
