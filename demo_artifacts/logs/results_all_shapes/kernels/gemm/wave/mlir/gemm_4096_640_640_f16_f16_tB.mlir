...
module attributes {transform.with_named_sequence} {
  ...
  func.func @isolated_benchmark(%arg0: tensor<4096x640xf16>, %arg1: tensor<640x640xf16>, %arg2: tensor<4096x640xf32>) -> tensor<4096x640xf32> {
    %0 = flow.dispatch @gemm::@gemm(%arg0, %arg1, %arg2) : (tensor<4096x640xf16>, tensor<640x640xf16>, tensor<4096x640xf32>) -> %arg2
