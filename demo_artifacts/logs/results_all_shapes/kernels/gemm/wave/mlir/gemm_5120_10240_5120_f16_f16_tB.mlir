...
module attributes {transform.with_named_sequence} {
  ...
  func.func @isolated_benchmark(%arg0: tensor<5120x5120xf16>, %arg1: tensor<10240x5120xf16>, %arg2: tensor<5120x10240xf32>) -> tensor<5120x10240xf32> {
    %0 = flow.dispatch @gemm::@gemm(%arg0, %arg1, %arg2) : (tensor<5120x5120xf16>, tensor<10240x5120xf16>, tensor<5120x10240xf32>) -> %arg2
