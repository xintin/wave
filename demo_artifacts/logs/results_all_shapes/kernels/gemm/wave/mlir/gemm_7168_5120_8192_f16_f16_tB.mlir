#map = affine_map<()[s0, s1] -> (((s0 * 7 + s1 * 140 - (s1 floordiv 8) * 1119) floordiv 160) * -8 + 56)>
#map1 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8) floordiv 128) * 128 + ((s2 * 7 + s3 * 140 - (s3 floordiv 8) * 1119) floordiv 160) * 1024 + (((s2 * 7 + s3 * 140 - (s3 floordiv 8) * 1119) mod 160) mod s4) * 128)>
#map2 = affine_map<()[s0] -> (s0 * 8 - (s0 floordiv 8) * 64)>
#map3 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 128) * 128 + ((s2 * 7 + s3 * 140 - (s3 floordiv 8) * 1119) floordiv 160) * 1024 + (((s2 * 7 + s3 * 140 - (s3 floordiv 8) * 1119) mod 160) mod s4) * 128 + 64)>
#map4 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8) floordiv 256) * 256 + (((s2 * 140 + s3 * 7 - (s2 floordiv 8) * 1119) mod 160) floordiv s4) * 256)>
#map5 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 256) * 256 + (((s2 * 140 + s3 * 7 - (s2 floordiv 8) * 1119) mod 160) floordiv s4) * 256 + 64)>
#map6 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 128) floordiv 256) * 256 + (((s2 * 140 + s3 * 7 - (s2 floordiv 8) * 1119) mod 160) floordiv s4) * 256 + 128)>
#map7 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 192) floordiv 256) * 256 + (((s2 * 140 + s3 * 7 - (s2 floordiv 8) * 1119) mod 160) floordiv s4) * 256 + 192)>
...
#map30 = affine_map<()[s0, s1, s2] -> (((s0 * 7 + s1 * 140 - (s1 floordiv 8) * 1119) floordiv 160) * 1024 + (((s0 * 7 + s1 * 140 - (s1 floordiv 8) * 1119) mod 160) mod s2) * 128)>
#map31 = affine_map<()[s0, s1, s2] -> ((((s0 * 140 + s1 * 7 - (s0 floordiv 8) * 1119) mod 160) floordiv s2) * 256)>
...
module attributes {transform.with_named_sequence} {
  stream.executable private @gemm {
    stream.executable.export public @gemm workgroups() -> (index, index, index) {
      ...
      stream.return %c56, %c20, %c1 : index, index, index
    }
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %176 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<7168x5120xf32, strided<[5120, 1], offset: ?>>
        ...
        %base_buffer_6, %offset_7, %sizes_8:2, %strides_9:2 = memref.extract_strided_metadata %176 : memref<7168x5120xf32, strided<[5120, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %184 = arith.addi %182, %offset_7 overflow<nsw> : index
        %reinterpret_cast_10 = memref.reinterpret_cast %176 to offset: [%184], sizes: [%c536870910], strides: [1] : memref<7168x5120xf32, strided<[5120, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
  ...
  func.func @isolated_benchmark(%arg0: tensor<7168x8192xf16>, %arg1: tensor<5120x8192xf16>, %arg2: tensor<7168x5120xf32>) -> tensor<7168x5120xf32> {
    %0 = flow.dispatch @gemm::@gemm(%arg0, %arg1, %arg2) : (tensor<7168x8192xf16>, tensor<5120x8192xf16>, tensor<7168x5120xf32>) -> %arg2
    return %0 : tensor<7168x5120xf32>
  }
}
