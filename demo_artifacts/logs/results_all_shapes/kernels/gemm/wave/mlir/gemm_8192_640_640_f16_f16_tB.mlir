#map = affine_map<()[s0, s1] -> (s0 * -8 + (s0 floordiv 8) * 64 - ((s1 * 8 + s0 floordiv 8) floordiv 24) * 8 + 64)>
#map1 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 + s2 * 1024 - (s2 floordiv 8) * 8192 - ((s1 * 32 + s0 floordiv 8) floordiv 128) * 128 + ((s3 * 8 + s2 floordiv 8) floordiv 24) * 1024 + (((s3 * 8 + s2 floordiv 8) mod 24) mod s4) * 128)>
#map2 = affine_map<()[s0] -> (s0 * 8 - (s0 floordiv 8) * 64)>
#map3 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 + s2 * 1024 - (s2 floordiv 8) * 8192 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 128) * 128 + ((s3 * 8 + s2 floordiv 8) floordiv 24) * 1024 + (((s3 * 8 + s2 floordiv 8) mod 24) mod s4) * 128 + 64)>
#map4 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8) floordiv 256) * 256 + (((s3 * 8 + s2 floordiv 8) mod 24) floordiv s4) * 256)>
#map5 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 256) * 256 + (((s3 * 8 + s2 floordiv 8) mod 24) floordiv s4) * 256 + 64)>
#map6 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 128) floordiv 256) * 256 + (((s3 * 8 + s2 floordiv 8) mod 24) floordiv s4) * 256 + 128)>
#map7 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 192) floordiv 256) * 256 + (((s3 * 8 + s2 floordiv 8) mod 24) floordiv s4) * 256 + 192)>
...
#map30 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 128 + (((s2 * 8 + s1 floordiv 8) mod 24) floordiv s3) * 256)>
#map31 = affine_map<()[s0, s1, s2] -> (s0 * 1024 - (s0 floordiv 8) * 8192 + ((s1 * 8 + s0 floordiv 8) floordiv 24) * 1024 + (((s1 * 8 + s0 floordiv 8) mod 24) mod s2) * 128)>
#map32 = affine_map<()[s0, s1, s2] -> ((((s1 * 8 + s0 floordiv 8) mod 24) floordiv s2) * 256)>
...
#map37 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 128 + (((s2 * 8 + s1 floordiv 8) mod 24) floordiv s3) * 256 + 16)>
#map38 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 128 + (((s2 * 8 + s1 floordiv 8) mod 24) floordiv s3) * 256 + 32)>
#map39 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 128 + (((s2 * 8 + s1 floordiv 8) mod 24) floordiv s3) * 256 + 48)>
#map40 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 128 + (((s2 * 8 + s1 floordiv 8) mod 24) floordiv s3) * 256 + 64)>
#map41 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 128 + (((s2 * 8 + s1 floordiv 8) mod 24) floordiv s3) * 256 + 80)>
#map42 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 128 + (((s2 * 8 + s1 floordiv 8) mod 24) floordiv s3) * 256 + 96)>
#map43 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 mod 16 + s4 * 128 + (((s2 * 8 + s1 floordiv 8) mod 24) floordiv s3) * 256 + 112)>
...
module attributes {transform.with_named_sequence} {
  stream.executable private @gemm {
    stream.executable.export public @gemm workgroups() -> (index, index, index) {
      ...
      stream.return %c64, %c3, %c1 : index, index, index
    }
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %14 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<640x640xf16, strided<[640, 1], offset: ?>>
        %15 = affine.apply #map4()[%thread_id_x, %thread_id_y, %block_id_x, %block_id_y, %3]
        %16 = arith.cmpi slt, %15, %c640 : index
        %17 = vector.broadcast %16 : i1 to vector<8xi1>
        %18 = arith.muli %15, %c640 overflow<nsw> : index
        %19 = arith.addi %18, %5 overflow<nsw> : index
        %base_buffer_3, %offset_4, %sizes_5:2, %strides_6:2 = memref.extract_strided_metadata %14 : memref<640x640xf16, strided<[640, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_7 = memref.reinterpret_cast %14 to offset: [%offset_4], sizes: [%c1073741822], strides: [1] : memref<640x640xf16, strided<[640, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        %20 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_7 validBytes(%c2147483645_i32) cacheSwizzleStride(%c640_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %31 = arith.muli %28, %c640 overflow<nsw> : index
        ...
        %43 = arith.muli %40, %c640 overflow<nsw> : index
        ...
        %55 = arith.muli %52, %c640 overflow<nsw> : index
        ...
        %88:16 = scf.for %arg3 = %c0 to %c9 step %c1 iter_args(%arg4 = %cst_1, %arg5 = %cst_1, %arg6 = %cst_1, %arg7 = %cst_1, %arg8 = %cst_1, %arg9 = %cst_1, %arg10 = %cst_1, %arg11 = %cst_1, %arg12 = %cst_1, %arg13 = %cst_1, %arg14 = %cst_1, %arg15 = %cst_1, %arg16 = %cst_1, %arg17 = %cst_1, %arg18 = %cst_1, %arg19 = %cst_1) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          ...
          %499 = arith.addi %18, %458 overflow<nsw> : index
          ...
          %504 = arith.select %17, %503, %cst_0 : vector<8xi1>, vector<8xindex>
          ...
          %507 = arith.addi %31, %458 overflow<nsw> : index
          ...
          %512 = arith.select %30, %511, %cst_0 : vector<8xi1>, vector<8xindex>
          ...
          amdgpu.lds_barrier
          llvm.call_intrinsic "llvm.amdgcn.sched.barrier"(%c0_i32) : (i32) -> ()
          vector.store %460, %view_2[%64, %5] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %462, %view_2[%65, %5] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %498, %view[%69, %5] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %514, %view[%67, %5] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %490, %view[%68, %5] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %506, %view[%66, %5] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          rocdl.s.barrier
          llvm.call_intrinsic "llvm.amdgcn.sched.barrier"(%c0_i32) : (i32) -> ()
          rocdl.s.setprio 1
        ...
        %208 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<8192x640xf32, strided<[640, 1], offset: ?>>
        ...
        %base_buffer_8, %offset_9, %sizes_10:2, %strides_11:2 = memref.extract_strided_metadata %208 : memref<8192x640xf32, strided<[640, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %218 = arith.addi %216, %offset_9 overflow<nsw> : index
        %reinterpret_cast_12 = memref.reinterpret_cast %208 to offset: [%218], sizes: [%c536870910], strides: [1] : memref<8192x640xf32, strided<[640, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
  ...
  func.func @isolated_benchmark(%arg0: tensor<8192x640xf16>, %arg1: tensor<640x640xf16>, %arg2: tensor<8192x640xf32>) -> tensor<8192x640xf32> {
    %0 = flow.dispatch @gemm::@gemm(%arg0, %arg1, %arg2) : (tensor<8192x640xf16>, tensor<640x640xf16>, tensor<8192x640xf32>) -> %arg2
    return %0 : tensor<8192x640xf32>
  }
}
