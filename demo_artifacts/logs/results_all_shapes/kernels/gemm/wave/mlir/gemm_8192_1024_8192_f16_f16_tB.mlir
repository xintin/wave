...
module attributes {transform.with_named_sequence} {
  ...
  func.func @isolated_benchmark(%arg0: tensor<8192x8192xf16>, %arg1: tensor<1024x8192xf16>, %arg2: tensor<8192x1024xf32>) -> tensor<8192x1024xf32> {
    %0 = flow.dispatch @gemm::@gemm(%arg0, %arg1, %arg2) : (tensor<8192x8192xf16>, tensor<1024x8192xf16>, tensor<8192x1024xf32>) -> %arg2
