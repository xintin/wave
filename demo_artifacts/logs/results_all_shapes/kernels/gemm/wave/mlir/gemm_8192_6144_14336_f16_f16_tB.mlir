...
module attributes {transform.with_named_sequence} {
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        ...
        %0 = stream.binding.subspan %arg0[%c0] : !stream.binding -> memref<8192x14336xf16, strided<[14336, 1], offset: ?>>
        ...
        %6 = arith.muli %4, %c14336 overflow<nsw> : index
        %7 = arith.addi %6, %5 overflow<nsw> : index
        %base_buffer, %offset, %sizes:2, %strides:2 = memref.extract_strided_metadata %0 : memref<8192x14336xf16, strided<[14336, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast = memref.reinterpret_cast %0 to offset: [%offset], sizes: [%c1073741822], strides: [1] : memref<8192x14336xf16, strided<[14336, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %11 = arith.muli %10, %c14336 overflow<nsw> : index
        %12 = arith.addi %11, %5 overflow<nsw> : index
        %13 = vector.load %8[%12] : memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>, vector<8xf16>
        %14 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<6144x14336xf16, strided<[14336, 1], offset: ?>>
        %15 = affine.apply #map4()[%thread_id_x, %thread_id_y, %block_id_x, %block_id_y, %3]
        %16 = arith.muli %15, %c14336 overflow<nsw> : index
        %17 = arith.addi %16, %5 overflow<nsw> : index
        %base_buffer_1, %offset_2, %sizes_3:2, %strides_4:2 = memref.extract_strided_metadata %14 : memref<6144x14336xf16, strided<[14336, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_5 = memref.reinterpret_cast %14 to offset: [%offset_2], sizes: [%c1073741822], strides: [1] : memref<6144x14336xf16, strided<[14336, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        ...
        %21 = arith.muli %20, %c14336 overflow<nsw> : index
        ...
        %25 = arith.muli %24, %c14336 overflow<nsw> : index
        ...
        %29 = arith.muli %28, %c14336 overflow<nsw> : index
        ...
        %56:16 = scf.for %arg3 = %c0 to %c223 step %c1 iter_args(%arg4 = %cst, %arg5 = %cst, %arg6 = %cst, %arg7 = %cst, %arg8 = %cst, %arg9 = %cst, %arg10 = %cst, %arg11 = %cst, %arg12 = %cst, %arg13 = %cst, %arg14 = %cst, %arg15 = %cst, %arg16 = %cst, %arg17 = %cst, %arg18 = %cst, %arg19 = %cst) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
  ...
  func.func @isolated_benchmark(%arg0: tensor<8192x14336xf16>, %arg1: tensor<6144x14336xf16>, %arg2: tensor<8192x6144xf32>) -> tensor<8192x6144xf32> {
    %0 = flow.dispatch @gemm::@gemm(%arg0, %arg1, %arg2) : (tensor<8192x14336xf16>, tensor<6144x14336xf16>, tensor<8192x6144xf32>) -> %arg2
