#map = affine_map<()[s0, s1] -> (((s0 * 40824 + s1 * 378 - ((s0 * 108 + s1) floordiv 8) * 3023) floordiv 224) * -8 + 108)>
#map1 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8) floordiv 128) * 128 + ((s2 * 40824 + s3 * 378 - ((s2 * 108 + s3) floordiv 8) * 3023) floordiv 224) * 1024 + (((s2 * 40824 + s3 * 378 - ((s2 * 108 + s3) floordiv 8) * 3023) mod 224) mod s4) * 128)>
#map2 = affine_map<()[s0] -> (s0 * 8 - (s0 floordiv 8) * 64)>
#map3 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 128) * 128 + ((s2 * 40824 + s3 * 378 - ((s2 * 108 + s3) floordiv 8) * 3023) floordiv 224) * 1024 + (((s2 * 40824 + s3 * 378 - ((s2 * 108 + s3) floordiv 8) * 3023) mod 224) mod s4) * 128 + 64)>
#map4 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8) floordiv 256) * 256 + (((s2 * 40824 + s3 * 378 - ((s2 * 108 + s3) floordiv 8) * 3023) mod 224) floordiv s4) * 256)>
#map5 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 64) floordiv 256) * 256 + (((s2 * 40824 + s3 * 378 - ((s2 * 108 + s3) floordiv 8) * 3023) mod 224) floordiv s4) * 256 + 64)>
#map6 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 128) floordiv 256) * 256 + (((s2 * 40824 + s3 * 378 - ((s2 * 108 + s3) floordiv 8) * 3023) mod 224) floordiv s4) * 256 + 128)>
#map7 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 floordiv 8 + s1 * 32 - ((s1 * 32 + s0 floordiv 8 + 192) floordiv 256) * 256 + (((s2 * 40824 + s3 * 378 - ((s2 * 108 + s3) floordiv 8) * 3023) mod 224) floordiv s4) * 256 + 192)>
...
#map30 = affine_map<()[s0, s1, s2] -> (((s0 * 40824 + s1 * 378 - ((s0 * 108 + s1) floordiv 8) * 3023) floordiv 224) * 1024 + (((s0 * 40824 + s1 * 378 - ((s0 * 108 + s1) floordiv 8) * 3023) mod 224) mod s2) * 128)>
#map31 = affine_map<()[s0, s1, s2] -> ((((s0 * 40824 + s1 * 378 - ((s0 * 108 + s1) floordiv 8) * 3023) mod 224) floordiv s2) * 256)>
...
module attributes {transform.with_named_sequence} {
  stream.executable private @gemm {
    stream.executable.export public @gemm workgroups() -> (index, index, index) {
      ...
      stream.return %c108, %c28, %c1 : index, index, index
    }
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding) attributes {translation_info = #translation} {
        %c7168_i14 = arith.constant 7168 : i14
        ...
        %block_id_x = gpu.block_id  x upper_bound 108
        %block_id_y = gpu.block_id  y upper_bound 28
        ...
        %0 = stream.binding.subspan %arg0[%c0] : !stream.binding -> memref<13824x5120xf16, strided<[5120, 1], offset: ?>>
        ...
        %6 = arith.muli %4, %c5120 overflow<nsw> : index
        %7 = arith.addi %6, %5 overflow<nsw> : index
        %base_buffer, %offset, %sizes:2, %strides:2 = memref.extract_strided_metadata %0 : memref<13824x5120xf16, strided<[5120, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast = memref.reinterpret_cast %0 to offset: [%offset], sizes: [%c1073741822], strides: [1] : memref<13824x5120xf16, strided<[5120, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        %8 = amdgpu.fat_raw_buffer_cast %reinterpret_cast validBytes(%c2147483645_i32) cacheSwizzleStride(%c5120_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %11 = arith.muli %10, %c5120 overflow<nsw> : index
        %12 = arith.addi %11, %5 overflow<nsw> : index
        %13 = vector.load %8[%12] : memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>, vector<8xf16>
        %14 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<7168x5120xf16, strided<[5120, 1], offset: ?>>
        %15 = affine.apply #map4()[%thread_id_x, %thread_id_y, %block_id_y, %block_id_x, %3]
        %16 = arith.muli %15, %c5120 overflow<nsw> : index
        %17 = arith.addi %16, %5 overflow<nsw> : index
        %base_buffer_1, %offset_2, %sizes_3:2, %strides_4:2 = memref.extract_strided_metadata %14 : memref<7168x5120xf16, strided<[5120, 1], offset: ?>> -> memref<f16>, index, index, index, index, index
        %reinterpret_cast_5 = memref.reinterpret_cast %14 to offset: [%offset_2], sizes: [%c1073741822], strides: [1] : memref<7168x5120xf16, strided<[5120, 1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        %18 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_5 validBytes(%c2147483645_i32) cacheSwizzleStride(%c5120_i14) resetOffset : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>
        %19 = vector.load %18[%17] : memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>, vector<8xf16>
        %20 = affine.apply #map5()[%thread_id_x, %thread_id_y, %block_id_y, %block_id_x, %3]
        %21 = arith.muli %20, %c5120 overflow<nsw> : index
        %22 = arith.addi %21, %5 overflow<nsw> : index
        %23 = vector.load %18[%22] : memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>, vector<8xf16>
        %24 = affine.apply #map6()[%thread_id_x, %thread_id_y, %block_id_y, %block_id_x, %3]
        %25 = arith.muli %24, %c5120 overflow<nsw> : index
        %26 = arith.addi %25, %5 overflow<nsw> : index
        %27 = vector.load %18[%26] : memref<?xf16, #amdgpu.address_space<fat_raw_buffer>>, vector<8xf16>
        %28 = affine.apply #map7()[%thread_id_x, %thread_id_y, %block_id_y, %block_id_x, %3]
        %29 = arith.muli %28, %c5120 overflow<nsw> : index
        ...
        %56:16 = scf.for %arg3 = %c0 to %c79 step %c1 iter_args(%arg4 = %cst, %arg5 = %cst, %arg6 = %cst, %arg7 = %cst, %arg8 = %cst, %arg9 = %cst, %arg10 = %cst, %arg11 = %cst, %arg12 = %cst, %arg13 = %cst, %arg14 = %cst, %arg15 = %cst, %arg16 = %cst, %arg17 = %cst, %arg18 = %cst, %arg19 = %cst) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>) {
          ...
          amdgpu.lds_barrier
          llvm.call_intrinsic "llvm.amdgcn.sched.barrier"(%c0_i32) : (i32) -> ()
          vector.store %348, %view_0[%32, %5] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %350, %view_0[%33, %5] : memref<128x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %376, %view[%37, %5] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %372, %view[%35, %5] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %374, %view[%36, %5] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          vector.store %378, %view[%34, %5] : memref<256x68xf16, #gpu.address_space<workgroup>>, vector<8xf16>
          rocdl.s.barrier
          llvm.call_intrinsic "llvm.amdgcn.sched.barrier"(%c0_i32) : (i32) -> ()
          rocdl.s.setprio 1
        ...
        %176 = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<13824x7168xf32, strided<[7168, 1], offset: ?>>
        %177 = affine.apply #map30()[%block_id_y, %block_id_x, %3]
        %178 = affine.apply #map31()[%block_id_y, %block_id_x, %3]
        %179 = affine.apply #map32()[%thread_id_x]
        %180 = arith.muli %177, %c7168 overflow<nsw> : index
        %181 = arith.muli %179, %c7168 overflow<nsw> : index
        %182 = arith.addi %180, %178 overflow<nsw> : index
        %183 = arith.addi %181, %57 overflow<nsw> : index
        %base_buffer_6, %offset_7, %sizes_8:2, %strides_9:2 = memref.extract_strided_metadata %176 : memref<13824x7168xf32, strided<[7168, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
        %184 = arith.addi %182, %offset_7 overflow<nsw> : index
        %reinterpret_cast_10 = memref.reinterpret_cast %176 to offset: [%184], sizes: [%c536870910], strides: [1] : memref<13824x7168xf32, strided<[7168, 1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
        %185 = amdgpu.fat_raw_buffer_cast %reinterpret_cast_10 validBytes(%c2147483643_i32) cacheSwizzleStride(%c7168_i14) resetOffset : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %188 = arith.muli %187, %c7168 overflow<nsw> : index
        ...
        %192 = arith.muli %191, %c7168 overflow<nsw> : index
        ...
        %196 = arith.muli %195, %c7168 overflow<nsw> : index
        ...
        %256 = arith.muli %255, %c7168 overflow<nsw> : index
        ...
        %260 = arith.muli %259, %c7168 overflow<nsw> : index
        ...
        %264 = arith.muli %263, %c7168 overflow<nsw> : index
        ...
        %268 = arith.muli %267, %c7168 overflow<nsw> : index
  ...
  func.func @isolated_benchmark(%arg0: tensor<13824x5120xf16>, %arg1: tensor<7168x5120xf16>, %arg2: tensor<13824x7168xf32>) -> tensor<13824x7168xf32> {
    %0 = flow.dispatch @gemm::@gemm(%arg0, %arg1, %arg2) : (tensor<13824x5120xf16>, tensor<7168x5120xf16>, tensor<13824x7168xf32>) -> %arg2
    return %0 : tensor<13824x7168xf32>
  }
}
